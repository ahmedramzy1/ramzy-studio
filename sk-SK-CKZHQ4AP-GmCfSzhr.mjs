...
//#region ../../node_modules/.pnpm/@excalidraw+excalidraw@0.18.0-3a5ef40_@types+react-dom@19.2.3_@types+react@19.2.17__@ty_b5c0bb913e6bf58bb5b24f479fd5a57a/node_modules/@excalidraw/excalidraw/dist/prod/locales/sk-SK-CKZHQ4AP.js
var e = {
	paste: "Vložiť",
	...
	arrowtype_elbowed: "Zalomená šípka",
	...
	showFonts: "Zobraziť výber písma",
	...
	link: {
		edit: "Upraviť odkaz",
		editEmbed: "Editovať zapustený odkaz",
		create: "Pridať odkaz",
		label: "Odkaz",
		labelEmbed: "Zapustiť odkaz",
		empty: "Nie je nastavený žiaden odkaz",
		hint: "Zadajte alebo vložte váš odkaz",
		goToElement: "Prejsť k cielenému prvku"
	},
	lineEditor: {
		edit: "Upraviť čiaru",
	...
	installPWA: "Inštalovať Excalidraw lokálne (PWA)",
	autoResize: "Zapnúť automatickú zmenu veľkosti textu",
	imageCropping: "Orezanie obrázka",
	unCroppedDimension: "Pôvodné rozmery",
	...
	desc: "Kliknite na tvar na plátne alebo vložte odkaz.",
	notFound: "Odkázaný objekt nebol nájdený na plátne."
}, n = {
	...
	desc_intro: "Pozvite ľudí a spolupracujte s nimi na vašich kresbách.",
	desc_privacy: "Nemajte obavy, relácia je end-to-end šifrovaná a úplne privátna. Ani náš server nedokáže vidieť čo kreslíte.",
	...
	deepBoxSelect: "Výber v skupine alebo zamedzenie potiahnutia",
	createFlowchart: "Vytvorte vývojový diagram z generického prvku",
	navigateFlowchart: "Navigácia v diagrame",
	...
	howto: "Postupujte podľa našich návodov",
	or: "alebo",
	...
	cropStart: "Orezať obrázok",
	cropFinish: "Dokončiť orezávanie obrázka"
}, v = { title: "Vyčistiť plátno" }, y = {
	...
	selected: "Vybrané",
	storage: "Úložisko",
	fullTitle: "Vlastnosti plátna a tvaru",
	title: "Vlastnosti",
	generalStats: "Všeobecné",
	...
	copyToClipboardAsSvg: "Kopírovanie {{exportSelection}} do schránky ako SVG prebehlo úspešne\n({{exportColorScheme}})",
	...
	elementLinkCopied: "Odkaz bol skopírovaný do schránky"
}, E = {
	...
	upsellBtnLabel: ""
}, N = { placeholder: "Rýchle vyhľadávanie" }, P = {
	badge: { old: "staré" },
	sceneFonts: "V tejto scéne",
	availableFonts: "Dostupné písma",
	empty: "Nenašli sa žiadne písma"
}, F = {
