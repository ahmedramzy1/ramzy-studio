import { Bn as e, Vn as t, W as n, Wn as r, ar as i, bn as a, cr as o, on as s, r as c, sr as l, t as u, vn as d, wn as f, xn as p, yn as m } from "./chunk-J7OUQ5F2-BUGcDHyW.mjs";
import { t as h } from "./chunk-XXDRQBXY-DYEdPnIN.mjs";
import { t as g } from "./chunk-KBJHAD2P-iCC8cYwM.mjs";
...
var _ = (function() {
			...
			for (var S, C, w, T, E, D = {}, O, k, ee, A;;) {
				...
				switch (T[0]) {
					...
					case 2:
						...
						k && (n = n.slice(0, -1 * k * 2), i = i.slice(0, -1 * k), a = a.slice(0, -1 * k)), n.push(this.productions_[T[1]][0]), i.push(D.$), a.push(D._$), ee = s[n[n.length - 2]][n[n.length - 1]], n.push(ee);
						break;
					case 3: return !0;
				}
			}
	...
	return o(ue, "Parser"), ue.prototype = le, le.Parser = ue, new ue();
})();
_.parser = _;
var v = _, y = class {
	constructor() {
		this.relations = [], this.latestRequirement = this.getInitialRequirement(), this.requirements = /* @__PURE__ */ new Map(), this.latestElement = this.getInitialElement(), this.elements = /* @__PURE__ */ new Map(), this.classes = /* @__PURE__ */ new Map(), this.direction = "TB", this.RequirementType = {
			...
			REFINES: "refines",
			TRACES: "traces"
		}, this.setAccTitle = t, this.getAccTitle = m, this.setAccDescription = e, this.getAccDescription = d, this.setDiagramTitle = r, this.getDiagramTitle = f, this.getConfig = /* @__PURE__ */ o(() => p().requirement, "getConfig"), this.clear(), this.setDirection = this.setDirection.bind(this), this.addRequirement = this.addRequirement.bind(this), this.setNewReqId = this.setNewReqId.bind(this), this.setNewReqRisk = this.setNewReqRisk.bind(this), this.setNewReqText = this.setNewReqText.bind(this), this.setNewReqVerifyMethod = this.setNewReqVerifyMethod.bind(this), this.addElement = this.addElement.bind(this), this.setNewElementType = this.setNewElementType.bind(this), this.setNewElementDocRef = this.setNewElementDocRef.bind(this), this.addRelationship = this.addRelationship.bind(this), this.setCssStyle = this.setCssStyle.bind(this), this.setClass = this.setClass.bind(this), this.defineClass = this.defineClass.bind(this), this.setAccTitle = this.setAccTitle.bind(this), this.setAccDescription = this.setAccDescription.bind(this);
	}
	static {
	...
	addElement(e) {
		return this.elements.has(e) || (this.elements.set(e, {
			...
			cssStyles: [],
			classes: ["default"]
		}), i.info("Added new element: ", e)), this.resetLatestElement(), this.elements.get(e);
	}
	getElements() {
	...
	let { themeVariables: t, look: n } = a(), { bkgColorArray: r, borderColorArray: i } = t;
	if (!i?.length) return "";
	let o = "";
    ...
    `;
	return o;
}, "genColor"), x = /* @__PURE__ */ o((e) => {
	let { look: t, themeVariables: n } = a(), { requirementEdgeLabelBackground: r } = n;
	return `
  ${b(e)}
  marker {
...
l(S, { draw: () => C });
var C = /* @__PURE__ */ o(async function(e, t, r, a) {
	i.info("REF0:"), i.info("Drawing requirement diagram (unified)", t);
	let { securityLevel: o, state: s, layout: l, look: d } = p(), f = a.db.getData(), m = h(t, o);
	f.type = a.type, f.layoutAlgorithm = u(l), f.nodeSpacing = s?.nodeSpacing ?? 50, f.rankSpacing = s?.rankSpacing ?? 50, f.markers = d === "neo" ? ["requirement_contains_neo", "requirement_arrow_neo"] : ["requirement_contains", "requirement_arrow"], f.diagramId = t, await c(f, m), n.insertTitle(m, "requirementDiagramTitleText", s?.titleTopMargin ?? 25, a.db.getDiagramTitle()), g(m, 8, "requirementDiagram", s?.useMaxWidth ?? !0);
}, "draw"), w = {
	parser: v,
	get db() {
		return new y();
