import { $n as e, Kn as t, Qn as n, V as r, ar as i, bn as a, cr as o, on as s, sn as c, sr as l, tn as u, tr as d, wt as f, xn as p } from "./chunk-J7OUQ5F2-BUGcDHyW.mjs";
import { t as m } from "./arc-Bn7R1lTc.mjs";
//#region ../../node_modules/.pnpm/mermaid@11.16.1/node_modules/mermaid/dist/chunks/mermaid.core/timeline-definition-Z64GVDOM.mjs
var h = (function() {
	var e = /* @__PURE__ */ o(function(e, t, n, r) {
		...
		23,
		24
	], n = [1, 12], r = [1, 13], i = [1, 14], a = [1, 15], s = [1, 16], c = [1, 19], l = [1, 20], u = {
		trace: /* @__PURE__ */ o(function() {}, "trace"),
		yy: {},
		symbols_: {
			error: 2,
			start: 3,
		...
		performAction: /* @__PURE__ */ o(function(e, t, n, r, i, a, o) {
			var s = a.length - 1;
			switch (i) {
				case 1: return a[s - 1];
				case 3:
		...
		defaultActions: {},
		parseError: /* @__PURE__ */ o(function(e, t) {
		...
		parse: /* @__PURE__ */ o(function(e) {
			var t = this, n = [0], r = [], i = [null], a = [], s = this.table, c = "", l = 0, u = 0, d = 0, f = 2, p = 1, m = a.slice.call(arguments, 1), h = Object.create(this.lexer), g = { yy: {} };
			...
			for (var S, C, w, T, E, D = {}, O, k, A, j;;) {
				...
				switch (T[0]) {
					...
					case 2:
						...
						k && (n = n.slice(0, -1 * k * 2), i = i.slice(0, -1 * k), a = a.slice(0, -1 * k)), n.push(this.productions_[T[1]][0]), i.push(D.$), a.push(D._$), A = s[n[n.length - 2]][n[n.length - 1]], n.push(A);
						break;
					case 3: return !0;
				}
			}
	...
	u.lexer = /* @__PURE__ */ (function() {
		return {
			...
			setInput: /* @__PURE__ */ o(function(e, t) {
			...
			test_match: /* @__PURE__ */ o(function(e, t) {
				var n, r, i;
			...
			topState: /* @__PURE__ */ o(function(e) {
				return e = this.conditionStack.length - 1 - Math.abs(e || 0), e >= 0 ? this.conditionStack[e] : "INITIAL";
			}, "topState"),
			pushState: /* @__PURE__ */ o(function(e) {
				this.begin(e);
			}, "pushState"),
			...
			performAction: /* @__PURE__ */ o(function(e, t, n, r) {
				switch (n) {
					case 0: break;
					case 1: break;
					case 2: return 13;
	...
	return o(d, "Parser"), d.prototype = u, u.Parser = d, new d();
})();
h.parser = h;
var g = h, _ = {};
l(_, {
...
var v = "", y = 0, b = "LR", x = [], S = [], C = [], w = /* @__PURE__ */ o(() => c, "getCommonDb"), T = /* @__PURE__ */ o(function() {
	x.length = 0, S.length = 0, v = "", C.length = 0, b = "LR", s();
}, "clear"), E = /* @__PURE__ */ o(function(e) {
	b = e;
}, "setDirection"), D = /* @__PURE__ */ o(function() {
	return b;
}, "getDirection"), O = /* @__PURE__ */ o(function(e) {
	v = e, x.push(e);
}, "addSection"), k = /* @__PURE__ */ o(function() {
	return x;
}, "getSections"), A = /* @__PURE__ */ o(function() {
	let e = P(), t = 0;
	for (; !e && t < 100;) e = P(), t++;
	return S.push(...C), S;
}, "getTasks"), j = /* @__PURE__ */ o(function(e, t, n) {
	let r = {
		id: y++,
		section: v,
		type: v,
	...
	C.push(r);
}, "addTask"), M = /* @__PURE__ */ o(function(e) {
	C.find((e) => e.id === y - 1).events.push(e);
}, "addEvent"), N = /* @__PURE__ */ o(function(e) {
	let t = {
		section: v,
		type: v,
		description: e,
	...
	S.push(t);
}, "addTaskOrg"), P = /* @__PURE__ */ o(function() {
	let e = /* @__PURE__ */ o(function(e) {
...
}, "drawRect"), te = /* @__PURE__ */ o(function(e, t) {
	...
	function i(e) {
		let n = m().startAngle(Math.PI / 2).endAngle(Math.PI / 2 * 3).innerRadius(15 / 2).outerRadius(15 / 2.2);
		e.append("path").attr("class", "mouth").attr("d", n).attr("transform", "translate(" + t.cx + "," + (t.cy + 2) + ")");
	}
	o(i, "smile");
	function a(e) {
		let n = m().startAngle(3 * Math.PI / 2).endAngle(Math.PI / 2 * 5).innerRadius(15 / 2).outerRadius(15 / 2.2);
	...
	return o(s, "ambivalent"), t.score > 3 ? i(r) : t.score < 3 ? a(r) : s(r), n;
}, "drawFace"), ne = /* @__PURE__ */ o(function(e, t) {
...
}, "drawCircle"), L = /* @__PURE__ */ o(function(e, t) {
...
}, "drawText"), re = /* @__PURE__ */ o(function(e, t) {
...
}, "drawLabel"), R = /* @__PURE__ */ o(function(e, t, n) {
...
}, "drawSection"), z = -1, ie = /* @__PURE__ */ o(function(e, t, n, r) {
...
}, "drawTask"), ae = /* @__PURE__ */ o(function(e, t) {
	I(e, {
		x: t.startx,
		y: t.starty,
...
}, "drawBackgroundRect"), oe = /* @__PURE__ */ o(function() {
	return {
		x: 0,
		y: 0,
		fill: void 0,
...
}, "getTextObj"), B = /* @__PURE__ */ o(function() {
	return {
		x: 0,
		y: 0,
		width: 100,
	...
	return o(r, "_setTextAttrs"), function(r) {
		return r.textPlacement === "fo" ? n : r.textPlacement === "old" ? e : t;
	};
})(), se = /* @__PURE__ */ o(function(e, t) {
...
function H(e, t) {
	e.each(function() {
		var e = u(this), n = e.text().split(/(\s+|<br>)/).reverse(), r, i = [], a = 1.1, o = e.attr("y"), s = parseFloat(e.attr("dy")), c = e.text(null).append("tspan").attr("x", 0).attr("y", o).attr("dy", s + "em");
...
o(H, "wrap");
var ce = /* @__PURE__ */ o(function(e, t, n, r, i, a = !1) {
	let { theme: o, look: s } = r, c = o?.includes("redux"), l = n % (r?.themeVariables?.THEME_COLOR_LIMIT ?? 12) - 1, d = e.append("g");
	t.section = l, d.attr("class", (t.class ? t.class + " " : "") + "timeline-node " + ("section-" + l));
	let f = d.append("g"), p = d.append("g"), m = p.append("text").text(t.descr).attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle").call(H, t.width).node().getBBox(), h = r.fontSize?.replace ? r.fontSize.replace("px", "") : r.fontSize;
	if (t.height = m.height + h * 1.1 * .5 + t.padding, t.height = Math.max(t.height, t.maxHeight), t.width += 2 * t.padding, p.attr("transform", "translate(" + t.width / 2 + ", " + t.padding / 2 + ")"), c && p.attr("transform", `translate(${t.width / 2}, ${a ? t.padding / 2 + 3 : t.padding})`), ue(f, t, l, i, r), s === "neo" && (d.attr("data-look", "neo"), c)) {
		let t = o.includes("dark"), n = u(e.node()?.ownerSVGElement ?? e.node()), r = n.attr("id") ?? "", i = r ? `${r}-drop-shadow` : "drop-shadow";
		if (n.select(`#${i}`).empty()) {
			let e = n.select("defs");
	...
	return t;
}, "drawNode"), le = /* @__PURE__ */ o(function(e, t, n) {
...
}, "getVirtualNodeHeight"), ue = /* @__PURE__ */ o(function(e, t, n, r, i) {
...
}, de = /* @__PURE__ */ o(function(e, n, r, a) {
	let o = p(), { look: s, theme: c, themeVariables: l } = o, { useGradient: d, gradientStart: f, gradientStop: m } = l, h = o.timeline?.leftMargin ?? 50;
	i.debug("timeline", a.db);
	let g = o.securityLevel, _;
	g === "sandbox" && (_ = u("#i" + n));
	let v = u(g === "sandbox" ? _.nodes()[0].contentDocument.body : "body").select("#" + n);
	v.append("g");
	let y = a.db.getTasks(), b = a.db.getCommonDb().getDiagramTitle();
	i.debug("task", y), U.initGraphics(v, n);
	...
	x.forEach(function(e) {
		...
		i.debug("sectionHeight before draw", n), S = Math.max(S, n + 20);
	});
	let A = 0, j = 0;
	i.debug("tasks.length", y.length);
	for (let [e, t] of y.entries()) {
		...
		i.debug("taskHeight before draw", r), C = Math.max(C, r + 20), A = Math.max(A, t.events.length);
		let a = 0;
		for (let e of t.events) {
			...
			a += U.getVirtualNodeHeight(v, n, o);
		}
		t.events.length > 0 && (a += (t.events.length - 1) * 10), j = Math.max(j, a);
	}
	i.debug("maxSectionHeight before draw", S), i.debug("maxTaskHeight before draw", C), x && x.length > 0 ? x.forEach((e) => {
		...
		i.debug("sectionNode", r);
		let a = v.append("g"), s = U.drawNode(a, r, O, o, n);
		i.debug("sectionNode output", s), a.attr("transform", `translate(${E}, ${T})`), D += S + 50, t.length > 0 && W(v, t, O, E, D, C, o, A, j, S, !1, n), E += 200 * Math.max(t.length, 1), D = T, O++;
	}) : (k = !1, W(v, y, O, E, D, C, o, A, j, S, !0, n));
	let M = v.node().getBBox();
	if (i.debug("bounds", M), b && v.append("text").text(b).attr("x", s === "neo" ? M.x * 2 + h : M.width / 2 - h).attr("font-size", "4ex").attr("font-weight", "bold").attr("y", 20), w = k ? S + C + 150 : C + 100, v.append("g").attr("class", "lineWrapper").append("line").attr("x1", h).attr("y1", w).attr("x2", M.width + 3 * h).attr("y2", w).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", `url(#${n}-arrowhead)`), s === "neo" && d && c !== "neutral") {
		...
		t.append("stop").attr("offset", "0%").attr("stop-color", f).attr("stop-opacity", 1), t.append("stop").attr("offset", "100%").attr("stop-color", m).attr("stop-opacity", 1);
	}
	t(void 0, v, o.timeline?.padding ?? 50, o.timeline?.useMaxWidth ?? !1);
}, "draw"), W = /* @__PURE__ */ o(function(e, t, n, r, a, o, s, c, l, u, d, f) {
	for (let c of t) {
		let t = {
			descr: c.task,
			section: n,
		...
		i.debug("taskNode", t);
		let u = e.append("g").attr("class", "taskWrapper"), p = U.drawNode(u, t, n, s, f).height;
		if (i.debug("taskHeight after draw", p), u.attr("transform", `translate(${r}, ${a})`), o = Math.max(o, p), c.events) {
			let t = e.append("g").attr("class", "lineWrapper"), i = o;
			a += 100, i += fe(e, c.events, n, r, a, s, f), a -= 100, t.append("line").attr("x1", r + 190 / 2).attr("y1", a + o).attr("x2", r + 190 / 2).attr("y2", a + o + 100 + l + 100).attr("stroke-width", 2).attr("stroke", "black").attr("marker-end", `url(#${f}-arrowhead)`).attr("stroke-dasharray", "5,5");
		}
		r += 200, d && !s.timeline?.disableMulticolor && n++;
	}
	a -= 10;
}, "drawTasks"), fe = /* @__PURE__ */ o(function(e, t, n, r, a, o, s) {
	let c = 0, l = a;
	a += 100;
	for (let l of t) {
		let t = {
		...
		i.debug("eventNode", t);
		let u = e.append("g").attr("class", "eventWrapper"), d = U.drawNode(u, t, n, o, s, !0).height;
		c += d, u.attr("transform", `translate(${r}, ${a})`), a = a + 10 + d;
	}
	return a = l, c;
}, "drawEvents"), pe = {
	setConf: /* @__PURE__ */ o(() => {}, "setConf"),
	draw: de
}, G = 200, K = 5, me = G + K * 2, q = G + 100, he = q + K * 2, J = 10, ge = 0, Y = 20, X = 20, Z = 30, Q = 50, _e = /* @__PURE__ */ o(function(e, n, a, o) {
	let s = p(), c = s.timeline?.leftMargin ?? 50;
	i.debug("timeline", o.db);
	let l = f(n);
	l.append("g");
	let u = o.db.getTasks(), d = o.db.getCommonDb().getDiagramTitle();
	i.debug("task", u), U.initGraphics(l);
	let m = o.db.getSections();
	i.debug("sections", m);
	let h = 0, g = 0, _ = 50 + c, v = 50, y = v, b = _, x = me + X, S = he + Q, C = b + x, w = 0, T = m && m.length > 0, E = T ? C : _ + x, D = Math.max(50, x + S - K * 2);
	m.forEach(function(e) {
		let t = {
			...
			padding: K,
			maxHeight: h
		}, n = U.getVirtualNodeHeight(l, t, s);
		i.debug("sectionHeight before draw", n), h = Math.max(h, n);
	});
	let O = 0;
	i.debug("tasks.length", u.length);
	for (let [e, t] of u.entries()) {
		let n = {
			...
			padding: K,
			maxHeight: g
		}, r = U.getVirtualNodeHeight(l, n, s);
		i.debug("taskHeight before draw", r), g = Math.max(g, r);
		let a = 0;
		for (let e of t.events) {
			let n = {
				descr: e,
			...
			a += U.getVirtualNodeHeight(l, n, s);
		}
		t.events.length > 0 && (a += (t.events.length - 1) * J), O = Math.max(O, a) + ge;
	}
	i.debug("maxSectionHeight before draw", h), i.debug("maxTaskHeight before draw", g);
	...
	T ? m.forEach((e) => {
		...
		i.debug("sectionNode", n);
		let r = l.append("g"), a = U.drawNode(r, n, w, s);
		i.debug("sectionNode output", a);
		let o = E - x;
		r.attr("transform", `translate(${o}, ${v})`);
		let c = v + a.height + Y;
		t.length > 0 && $(l, t, w, E, c, g, s, k, !1);
		let d = t.length, f = a.height + Y + k * Math.max(d, 1) - (d > 0 ? Z * 2 : 0);
		v += f, w++;
	}) : $(l, u, w, E, v, g, s, k, !0);
	let A = l.node()?.getBBox();
	if (!A) throw Error("bbox not found");
	if (i.debug("bounds", A), d) {
		if (l.append("text").text(d).attr("x", A.width / 2 - c).attr("font-size", "4ex").attr("font-weight", "bold").attr("y", 20), A = l.node()?.getBBox(), !A) throw Error("bbox not found");
		i.debug("bounds after title", A);
	}
	let [j] = r(s.fontSize), M = (j ?? 16) * 2, N = (j ?? 16) * .5 + 20, P = l.append("g").attr("class", "lineWrapper");
	P.append("line").attr("x1", E).attr("y1", y - M).attr("x2", E).attr("y2", A.y + A.height + N).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)"), P.lower(), t(void 0, l, s.timeline?.padding ?? 50, s.timeline?.useMaxWidth ?? !1);
}, "draw"), $ = /* @__PURE__ */ o(function(e, t, n, r, a, o, s, c, l) {
	for (let u of t) {
		let t = {
			descr: u.task,
			section: n,
		...
		i.debug("taskNode", t);
		let d = e.append("g").attr("class", "taskWrapper"), f = U.drawNode(d, t, n, s), p = f.height;
		i.debug("taskHeight after draw", p);
		let m = r - X - f.width;
		if (d.attr("transform", `translate(${m}, ${a})`), o = Math.max(o, p), u.events && u.events.length > 0) {
			let t = a, i = r + Q;
			ve(e, u.events, n, r, i, t, s);
		}
		a += c, l && !s.timeline?.disableMulticolor && n++;
	}
}, "drawTasks"), ve = /* @__PURE__ */ o(function(e, t, n, r, a, o, s) {
	let c = o;
	for (let o of t) {
		let t = {
			descr: o,
		...
		i.debug("eventNode", t);
		let l = e.append("g").attr("class", "eventWrapper"), u = U.drawNode(l, t, n, s).height;
		l.attr("transform", `translate(${a}, ${c})`);
		let d = e.append("g").attr("class", "lineWrapper"), f = c + u / 2;
		d.append("line").attr("x1", r).attr("y1", f).attr("x2", a).attr("y2", f).attr("stroke-width", 2).attr("stroke", "black").attr("marker-end", "url(#arrowhead)").attr("stroke-dasharray", "5,5"), c = c + u + J;
	}
	return c - o;
}, "drawEvents"), ye = {
	setConf: /* @__PURE__ */ o(() => {}, "setConf"),
	...
	let { theme: t } = a(), n = t?.includes("dark"), r = t?.includes("color"), i = e.svgId?.replace(/^#/, "") ?? "", o = i ? `url(#${i}-drop-shadow)` : e.dropShadow ?? "none", s = "";
	for (let t = 0; t < e.THEME_COLOR_LIMIT; t++) {
		let i = `${17 - 3 * t}`, a = r ? e.borderColorArray[t] : e.mainBkg, c = r ? e.borderColorArray[t] : e.nodeBorder;
		s += `
    .section-${t - 1} rect,
    .section-${t - 1} path,
    .section-${t - 1} circle {
	...
	return s;
}, "genReduxSections"), xe = /* @__PURE__ */ o((t) => {
	let r = "";
	for (let r = 0; r < t.THEME_COLOR_LIMIT; r++) t["lineColor" + r] = t["lineColor" + r] || t["cScaleInv" + r], d(t["lineColor" + r]) ? t["lineColor" + r] = e(t["lineColor" + r], 20) : t["lineColor" + r] = n(t["lineColor" + r], 20);
	...
	renderer: {
		setConf: /* @__PURE__ */ o(() => {}, "setConf"),
		draw: /* @__PURE__ */ o((e, t, n, r) => (r?.db?.getDirection?.() ?? "LR") === "TD" ? ye.draw(e, t, n, r) : pe.draw(e, t, n, r), "draw")
	},
	parser: g,
	styles: /* @__PURE__ */ o((e) => {
		let { theme: t } = a(), n = t?.includes("redux"), r = t === "neutral", i = e.svgId?.replace(/^#/, "") ?? "", o = "";
		if (e.useGradient && i && e.THEME_COLOR_LIMIT && !r) for (let t = 0; t < e.THEME_COLOR_LIMIT; t++) o += `
