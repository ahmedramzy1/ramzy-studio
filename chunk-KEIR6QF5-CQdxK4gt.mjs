...
var h, g, _, v, y, b, x, ee, S, te, ne, C, re, ie, ae, oe, se, ce, le, ue, de, w, T, E, D, O, fe, k, pe, me, he, ge, _e, ve, ye, be, xe, Se, Ce, we, Te, Ee, De, Oe, ke, Ae, je, Me, Ne, Pe, Fe, Ie, Le, Re, ze, Be, Ve, He, Ue, We, Ge, Ke, qe, Je, Ye, Xe, Ze, Qe, $e, et, tt, nt, rt, it, at, ot, st, ct, lt, ut, dt, ft, pt, mt, A, ht = s({ "../../node_modules/.pnpm/vscode-languageserver-types@3.17.5/node_modules/vscode-languageserver-types/lib/esm/main.js"() {
	(function(e) {
		...
		function t(e, t, ...n) {
			let r = { label: e };
			return A.defined(t) && (r.documentation = t), A.defined(n) ? r.parameters = n : r.parameters = [], r;
		}
		o(t, "create"), e.create = t;
	})(Ne ||= {}), (function(e) {
...
${n}`);
	...
	function ie(p, y, x, ee) {
		...
		o(Fe, "handleRequest");
		function Ie(e) {
			if (!De()) if (e.id === null) e.error ? S.error(`Received response message without id: Error is: 
${JSON.stringify(e.error, void 0, 4)}`) : S.error("Received response message without id. No further error information provided.");
		...
		function Le(e) {
			...
			if (n || ce) try {
				if (We(e), n) if (e.params === void 0) t !== void 0 && t.numberOfParams !== 0 && t.parameterStructures !== r.ParameterStructures.byName && S.error(`Notification ${e.method} defines ${t.numberOfParams} params but received none.`), n();
				else if (Array.isArray(e.params)) {
					let i = e.params;
...
`), k.log(`Received request '${e.method} - (${e.id})'.`, t);
		...
		function We(e) {
			if (!(O === f.Off || !k || e.method === g.type.method)) if (fe === m.Text) {
				let t;
				(O === f.Verbose || O === f.Compact) && (t = e.params ? `Params: ${ze(e.params)}
	...
	flat(t) {
		...
		return new e(() => ({ this: n.startFn() }), (e) => {
			do {
				...
				if (!t) if (vn(r)) e.iterator = r[Symbol.iterator]();
				else return {
					done: !1,
					value: r
				};
...
function Ln(e, t, n) {
	...
	for (let [i, a] of Object.entries(e)) if (!i.startsWith("$")) if (M(a)) r[i] = Ln(a, t, n);
...
function co(e, t) {
	...
	} else if (zr(e)) return po(e);
	else if (ki(e)) return fo(e);
	else if ($r(e)) {
...
o(Vo, "arrayMap");
var Ho = Vo, I = Array.isArray, Uo = Infinity, Wo = xo ? xo.prototype : void 0, Go = Wo ? Wo.toString : void 0;
function Ko(e) {
...
o(ss, "toNumber");
var cs = ss, ls = Infinity, us = 17976931348623157e292;
function ds(e) {
...
function Gv(e, t) {
	...
	n("Transform Patterns", () => {
		i = !1, a = B(r, (e) => {
			...
			} else if (Ss(t)) return i = !0, { exec: t };
...
function gy(e, t) {
	...
	else if (py(e)) return { issue: K.CUSTOM_LINE_BREAK };
	else throw Error("non exhaustive match");
}
...
}), VD = Infinity, HD = qS ? qS.prototype : void 0, UD = HD ? HD.toString : void 0;
function WD(e) {
	if (typeof e == "string") return e;
...
function Jk() {}
o(Jk, "noop");
var Yk = Jk, Xk = UE && 1 / Bw(new UE([, -0]))[1] == Infinity ? function(e) {
	return new UE(e);
} : Yk, Zk = 200;
function Qk(e, t, n) {
...
var ij = "​", aj = /* @__PURE__ */ o((e) => e.endsWith(ij) ? e : e + ij, "withRuleSuffix"), oj = class {
	...
	constructor(e) {
		...
		e.shared.profilers.LangiumProfiler?.isActive("parsing") ? this.wrapper = new pj(t, {
			...e.parser.ParserConfig,
			skipValidations: n,
			errorMessageProvider: e.parser.ParserErrorMessageProvider
		}, e.shared.profilers.LangiumProfiler.createTask("parsing", e.LanguageMetaData.languageId)) : this.wrapper = new fj(t, {
			...e.parser.ParserConfig,
			skipValidations: n,
			errorMessageProvider: e.parser.ParserErrorMessageProvider
		});
...
var DM = class {
	...
	replacer(e, t, { refText: n, sourceText: r, textRegions: i, comments: a, uriConverter: o }) {
		if (!this.ignoreProperties.has(e)) if (cn(t)) {
...
function BN(e, t) {
	let n = new Proxy({}, {
		...
		get: /* @__PURE__ */ o((r, i) => i === RN ? !0 : HN(r, i, e, t || n), "get"),
...
function UN(e, t) {
	if (t) {
		for (let [n, r] of Object.entries(t)) if (r != null) if (typeof r == "object") {
			let t = e[n];
			typeof t == "object" && t ? e[n] = UN(t, r) : e[n] = UN({}, r);
		} else e[n] = r;
	}
	return e;
}
