...
//#region ../../node_modules/.pnpm/@excalidraw+excalidraw@0.18.0-3a5ef40_@types+react-dom@19.2.3_@types+react@19.2.17__@ty_b5c0bb913e6bf58bb5b24f479fd5a57a/node_modules/@excalidraw/excalidraw/dist/prod/locales/el-GR-ZXDJ2OS4.js
var e = {
	paste: "Επικόλληση",
	...
	tooltip: { embedScene: "Τα δεδομένα σκηνής θα αποθηκευτούν στο αρχείο PNG/SVG προς εξαγωγή ώστε η σκηνή να είναι δυνατό να αποκατασταθεί από αυτό.\nΘα αυξήσει το μέγεθος του αρχείου προς εξαγωγή." },
	title: {
	...
	upsellBtnLabel: ""
}, N = { placeholder: "Γρήγορη αναζήτηση" }, P = {
	badge: { old: "παλιό" },
