...
//#region ../../node_modules/.pnpm/@excalidraw+excalidraw@0.18.0-3a5ef40_@types+react-dom@19.2.3_@types+react@19.2.17__@ty_b5c0bb913e6bf58bb5b24f479fd5a57a/node_modules/@excalidraw/excalidraw/dist/prod/locales/ro-RO-E2P6TFZI.js
var e = {
	paste: "Lipire",
	...
	loadScene: "Încărcare scenă din fișier",
	align: "Aliniere",
	...
	toggleTheme: "Comutare temă luminoasă/întunecată",
	theme: "Temă",
	...
	link: {
		edit: "Editare URL",
		editEmbed: "Editare link încorporabil",
	...
	polygon: {
		breakPolygon: "Întrerupere poligon",
		convertToPolygon: "Convertire în poligon"
	},
	elementLock: {
		lock: "Blocare",
		unlock: "Deblocare",
	...
	zoomToFitViewport: "Transfocare pentru a se potrivi în poarta de vizualizare",
	...
	desc: "Dă clic pe o formă pe pânză sau lipește un link.",
	notFound: "Obiectul linkuit nu a fost găsit pe pânză."
}, n = {
	...
	search: {
		inputPlaceholder: "Căutare în bibliotecă",
	...
	placeholder: "Găsire text pe pânză...",
	frames: "Cadre",
	texts: "Texte"
}, i = {
	...
	saveLibraryError: "Nu s-a putut salva biblioteca în spațiul de stocare. Salvează-ți biblioteca într-un fișier local pentru a te asigura că nu pierzi modificările.",
	...
	dismissSearch: "{{shortcut}} pentru a închide căutarea",
	canvasPanning: "Pentru a muta pânză, ține {{shortcut_1}} sau {{shortcut_2}} în timp ce glisezi sau folosește instrumentul în formă de mână",
	...
	lockAngle: "Poți constrânge unghiul prin ținerea apăsată a {{shortcut}}",
	resize: "Poți constrânge proporțiile, ținând apăsat {{shortcut_1}} în timp ce redimensionezi,\nține apăsat {{shortcut_2}} pentru a redimensiona de la centru",
	resizeImage: "Poți constrânge proporțiile, ținând apăsat {{shortcut_1}},\nține apăsat {{shortcut_2}} pentru a redimensiona de la centru",
	rotate: "Poți constrânge unghiurile, ținând apăsat {{shortcut}} în timp ce rotești",
	...
	deepBoxSelect: "Ține apăsat {{shortcut}} pentru a efectua selectarea de adâncime și pentru a preveni glisarea",
	...
	leaveCropEditor: "Dă clic în afara imaginii sau apasă {{shortcut_1}} sau {{shortcut_2}} pentru a finaliza decuparea"
}, d = {
	...
	selected: "Selectate",
	storage: "Stocare",
	fullTitle: "Proprietăți pentru pânză și forme",
	title: "Proprietăți",
	...
	elementLinkCopied: "Link copiat în memoria temporară"
}, E = {
	...
	app: {
		center_heading: "Desenele tale sunt salvate în spațiul de stocare al navigatorului tău.",
		center_heading_line2: "Spațiul de stocare al navigatorului poate fi șters în mod neașteptat.",
		center_heading_line3: "Salvează-ți periodic munca într-un fișier pentru a evita pierderea acesteia.",
	...
	inputPlaceholder: "Începe să îți introduci ideea de diagramă aici... ({{shortcut}} pentru linia nouă)",
	...
	errors: {
		...
		invalidDiagram: "A generat o diagramă nevalidă :(. Poți edita manual, reîncerca cu funcția de fixare automată sau încerca o altă solicitare.",
	...
	rateLimit: {
		messageLimit: "Ai atins limita IA la planul gratuit. Încearcă Excalidraw+ pentru mai multe sau revino mâine.",
		generalRateLimit: "Stai puțin, te grăbești! Așteaptă un moment înainte de a reîncerca.",
		messageLimitInputPlaceholder: "Ai atins limita de mesaje"
	},
	upsellBtnLabel: "Actualizare la Plus"
}, N = { placeholder: "Căutare rapidă" }, P = {
	badge: { old: "vechi" },
	sceneFonts: "În această scenă",
	...
	hint: {
		...
		followStatus: "În prezent urmărești acest utilizator",
		inCall: "Utilizatorul este angajat într-un apel vocal",
