import { Bn as e, Mn as t, R as n, Rn as r, Vn as i, W as a, Wn as o, Zn as s, ar as c, cn as l, cr as u, on as d, r as f, t as p, tn as m, vn as h, wn as g, xn as _, yn as v } from "./chunk-J7OUQ5F2-BUGcDHyW.mjs";
import { t as y } from "./chunk-5VM5RSS4-C77-LDhP.mjs";
import { t as b } from "./chunk-2GRJ4B5K-DKbJpHGI.mjs";
import { t as x } from "./chunk-XXDRQBXY-DYEdPnIN.mjs";
...
var C = (function() {
	var e = /* @__PURE__ */ u(function(e, t, n, r) {
		...
		return n;
	}, "o"), t = [1, 18], n = [1, 19], r = [1, 20], i = [1, 41], a = [1, 26], o = [1, 42], s = [1, 24], c = [1, 25], l = [1, 32], d = [1, 33], f = [1, 34], p = [1, 45], m = [1, 35], h = [1, 36], g = [1, 37], _ = [1, 38], v = [1, 27], y = [1, 28], b = [1, 29], x = [1, 30], S = [1, 31], C = [1, 44], w = [1, 46], T = [1, 43], E = [1, 47], D = [1, 9], O = [
		1,
		8,
		9
	...
	return u($, "Parser"), $.prototype = ce, ce.Parser = $, new $();
})();
C.parser = C;
var w = C, T = [
	"#",
	...
	getDisplayDetails() {
		let e = this.visibility + t(this.id);
		this.memberType === "method" && (e += `(${t(this.parameters.trim())})`, this.returnType && (e += " : " + t(this.returnType))), e = e.trim();
		let n = this.parseClassifier();
		return {
			displayText: e,
			cssStyle: n
		};
	...
	parseMember(e) {
		...
		if (this.memberType === "method") {
			...
			if (t) {
				let e = t[1] ? t[1].trim() : "";
				if (T.includes(e) && (this.visibility = e), this.id = t[2], this.parameters = t[3] ? t[3].trim() : "", n = t[4] ? t[4].trim() : "", this.returnType = t[5] ? t[5].trim() : "", n === "") {
					let e = this.returnType.substring(this.returnType.length - 1);
					/[$*]/.exec(e) && (n = e, this.returnType = this.returnType.substring(0, this.returnType.length - 1));
				}
			}
		} else {
			let t = e.length, r = e.substring(0, 1), i = e.substring(t - 1);
			T.includes(r) && (this.visibility = r), /[$*]/.exec(i) && (n = i), this.id = e.substring(this.visibility === "" ? 0 : 1, n === "" ? t : t - 1);
		}
		this.classifier = n, this.id = this.id.startsWith(" ") ? " " + this.id.trim() : this.id.trim();
		let r = `${this.visibility ? "\\" + this.visibility : ""}${t(this.id)}${this.memberType === "method" ? `(${t(this.parameters)})${this.returnType ? " : " + t(this.returnType) : ""}` : ""}`;
...
}, D = "classId-", O = 0, k = /* @__PURE__ */ u((e) => l.sanitizeText(e, _()), "sanitizeText"), A = class t {
	constructor() {
		this.relations = [], this.classes = /* @__PURE__ */ new Map(), this.styleClasses = /* @__PURE__ */ new Map(), this.notes = /* @__PURE__ */ new Map(), this.interfaces = [], this.namespaces = /* @__PURE__ */ new Map(), this.namespaceCounter = 0, this.namespaceStack = [], this.diagramId = "", this.functions = [], this.lineType = {
			...
			DEPENDENCY: 3,
			LOLLIPOP: 4
		}, this.setupToolTips = /* @__PURE__ */ u((e) => {
			let t = b();
	...
	addClass(e) {
		let t = l.sanitizeText(e, _()), { className: n, type: r } = this.splitClassNameAndType(t);
		if (this.classes.has(n)) return;
		let i = l.sanitizeText(n, _());
		this.classes.set(i, {
			id: i,
			type: r,
			label: i,
	...
	clear() {
		this.relations = [], this.classes = /* @__PURE__ */ new Map(), this.notes = /* @__PURE__ */ new Map(), this.interfaces = [], this.functions = [], this.functions.push(this.setupToolTips.bind(this)), this.namespaces = /* @__PURE__ */ new Map(), this.namespaceCounter = 0, this.namespaceStack = [], this.diagramId = "", this.direction = "TB", d();
	}
	getClass(e) {
	...
	addRelation(e) {
		c.debug("Adding relation: " + JSON.stringify(e));
		let t = [
		...
		e.relation.type1 === this.relationType.LOLLIPOP && !t.includes(e.relation.type2) ? (this.addClass(e.id2), this.addInterface(e.id1, e.id2), e.id1 = `interface${this.interfaces.length - 1}`) : e.relation.type2 === this.relationType.LOLLIPOP && !t.includes(e.relation.type1) ? (this.addClass(e.id1), this.addInterface(e.id2, e.id1), e.id2 = `interface${this.interfaces.length - 1}`) : (this.addClass(e.id1), this.addClass(e.id2)), e.id1 = this.splitClassNameAndType(e.id1).className, e.id2 = this.splitClassNameAndType(e.id2).className, e.relationTitle1 = l.sanitizeText(e.relationTitle1.trim(), _()), e.relationTitle2 = l.sanitizeText(e.relationTitle2.trim(), _()), this.relations.push(e);
	}
	addAnnotation(e, t) {
	...
	setLink(e, t, n) {
		...
		e.split(",").forEach((e) => {
			...
			let o = this.classes.get(i);
			o && (o.link = a.formatUrl(t, r), r.securityLevel === "sandbox" ? o.linkTarget = "_top" : typeof n == "string" ? o.linkTarget = k(n) : o.linkTarget = "_blank");
	...
	addNamespace(e, n) {
		let r = t.resolveQualifiedId(e, this.namespaceStack);
		if (this.namespaceStack.push(r), this.namespaces.has(r)) {
			let e = this.namespaces.get(r);
			return e.explicit = !0, n && (e.label = n), r;
		}
		let i = r.split("."), a = t.getAncestorIds(r);
		for (let e = 0; e < a.length; e++) {
			let t = a[e], r = e > 0 ? a[e - 1] : void 0, o = e === a.length - 1, s = o && n ? n : i[e];
			this.namespaces.has(t) ? o && (this.namespaces.get(t).explicit = !0) : this.namespaces.set(t, this.createNamespaceNode(t, s, r, o)), r && this.linkParentChild(r, t);
		}
		return r;
	}
	popNamespace() {
	...
	getData() {
		let e = [], t = [], r = _(), i = r.class?.hierarchicalNamespaces ?? !0;
		...
		for (let t of this.classes.values()) {
			let n = i ? t.parent : this.resolveExplicitAncestor(t.parent), a = {
				...t,
				type: void 0,
				isGroup: !1,
				parentId: n,
		...
		for (let n of this.notes.values()) {
			let a = i ? n.parent : this.resolveExplicitAncestor(n.parent), o = {
				id: n.id,
				label: n.text,
				isGroup: !1,
				shape: "note",
...
}, j = /* @__PURE__ */ u((e) => `g.classGroup text {
...
`, "getStyles"), M = {
	...
	draw: /* @__PURE__ */ u(async function(e, t, n, r) {
		c.info("REF0:"), c.info("Drawing class diagram (v3)", t);
		let { securityLevel: i, state: o, layout: s } = _();
		r.db.setDiagramId(t);
		let l = r.db.getData(), u = x(t, i);
		l.type = r.type, l.layoutAlgorithm = p(s), l.nodeSpacing = o?.nodeSpacing || 50, l.rankSpacing = o?.rankSpacing || 50, l.markers = [
			"aggregation",
			"extension",
			"composition",
			"dependency",
			"lollipop"
		], l.diagramId = t, await f(l, u), a.insertTitle(u, "classDiagramTitleText", o?.titleTopMargin ?? 25, r.db.getDiagramTitle()), S(u, 8, "classDiagram", o?.useMaxWidth ?? !0);
	}, "draw"),
	getDir: /* @__PURE__ */ u((e, t = "TB") => {
		if (!e.doc) return t;
		let n = t;
