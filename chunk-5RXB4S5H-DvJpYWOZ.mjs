import { Bn as e, L as t, Vn as n, W as r, Wn as i, Zn as a, ar as o, cn as s, cr as c, on as l, r as u, tn as d, vn as f, wn as p, xn as m, yn as h } from "./chunk-J7OUQ5F2-BUGcDHyW.mjs";
import { t as g } from "./chunk-2GRJ4B5K-DKbJpHGI.mjs";
import { t as _ } from "./chunk-XXDRQBXY-DYEdPnIN.mjs";
import { t as v } from "./chunk-KBJHAD2P-iCC8cYwM.mjs";
//#region ../../node_modules/.pnpm/mermaid@11.16.1/node_modules/mermaid/dist/chunks/mermaid.core/chunk-5RXB4S5H.mjs
var y = (function() {
	var e = /* @__PURE__ */ c(function(e, t, n, r) {
		for (n ||= {}, r = e.length; r--; n[e[r]] = t);
		return n;
	}, "o"), t = [1, 2], n = [1, 3], r = [1, 4], i = [2, 4], a = [1, 9], o = [1, 11], s = [1, 16], l = [1, 17], u = [1, 18], d = [1, 19], f = [1, 33], p = [1, 20], m = [1, 21], h = [1, 22], g = [1, 23], _ = [1, 24], v = [1, 26], y = [1, 27], b = [1, 28], x = [1, 29], S = [1, 30], C = [1, 31], w = [1, 32], T = [1, 35], E = [1, 36], D = [1, 37], O = [1, 38], k = [1, 34], A = [
		1,
		4,
		5,
		16,
		...
		performAction: /* @__PURE__ */ c(function(e, t, n, r, i, a, o) {
			var s = a.length - 1;
			switch (i) {
		...
		return {
			...
			performAction: /* @__PURE__ */ c(function(e, t, n, r) {
				...
				switch (c(i, "processId"), n) {
					...
					case 49: return i() ? (this.popState(), "ID") : void 0;
					case 50:
						this.popState();
						break;
					case 51: return "STATE_DESCR";
					case 52: throw Error("Error: State name must be a single word. Found: \"" + t.yytext.trim() + "\"");
					case 53: return 19;
					case 54:
						this.popState();
						break;
					...
					case 65: return i() ? (this.popState(), "ID") : void 0;
					case 66: return i() ? (this.popState(), this.pushState("NOTE_TEXT"), 24) : void 0;
					case 67: return this.popState(), t.yytext = t.yytext.substr(2).trim(), 31;
					case 68: return this.popState(), t.yytext = t.yytext.slice(0, -8).trim(), 31;
					case 69: return 6;
					case 70: return 6;
					case 71: return 16;
					case 72: return 57;
					case 73: return i() ? 24 : void 0;
					case 74: return t.yytext = t.yytext.trim(), 14;
					case 75: return 15;
					case 76: return 28;
					case 77: return 58;
					case 78: return 5;
	...
	return c(P, "Parser"), P.prototype = N, N.Parser = P, new P();
})();
y.parser = y;
var b = y, x = "TB", S = "TB", C = "dir", w = "state", T = "root", E = "relation", D = "classDef", O = "style", k = "applyClass", A = "default", j = "divider", M = "fill:none", N = "fill: #333", P = "c", ee = "markdown", F = "normal", I = "rect", L = "rectWithTitle", te = "stateStart", ne = "stateEnd", R = "divider", re = "roundedWithTitle", ie = "note", ae = "noteGroup", z = "statediagram", oe = `${z}-state`, B = "transition", se = "note", ce = `${B} note-edge`, le = `${z}-${se}`, ue = `${z}-cluster`, de = `${z}-cluster-alt`, V = "parent", H = "note", fe = "state", U = "----", pe = `${U}${H}`, W = `${U}${V}`, G = /* @__PURE__ */ c((e, t = S) => {
	...
	draw: /* @__PURE__ */ c(async function(e, t, n, i) {
		o.info("REF0:"), o.info("Drawing state diagram (v2)", t);
		let { securityLevel: a, state: s, layout: c } = m();
		i.db.extract(i.db.getRootDocV2());
		let l = i.db.getData(), d = _(t, a);
		l.type = i.type, l.layoutAlgorithm = c, l.nodeSpacing = s?.nodeSpacing || 50, l.rankSpacing = s?.rankSpacing || 50, m().look === "neo" ? l.markers = ["barbNeo"] : l.markers = ["barb"], l.diagramId = t, await u(l, d);
		try {
			(typeof i.db.getLinks == "function" ? i.db.getLinks() : /* @__PURE__ */ new Map()).forEach((e, t) => {
				let n = typeof t == "string" ? t : typeof t?.id == "string" ? t.id : "", r = l.nodes.find((e) => e.id === n);
				if (!n) {
					o.warn("⚠️ Invalid or missing stateId from key:", JSON.stringify(t));
					return;
				}
				let i = d.node()?.querySelectorAll("g.node, g.rough-node"), a;
				if (i?.forEach((e) => {
					let t = e.textContent?.trim();
					(e.id === r?.domId || t === n) && (a = e);
				}), !a) {
					o.warn("⚠️ Could not find node matching text:", n);
					return;
				}
				let s = a.parentNode;
				if (!s) {
					o.warn("⚠️ Node has no parent, cannot wrap:", n);
					return;
				}
				let c = document.createElementNS("http://www.w3.org/2000/svg", "a"), u = e.url.replace(/^"+|"+$/g, "");
				if (c.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", u), c.setAttribute("target", "_blank"), e.tooltip) {
					let t = e.tooltip.replace(/^"+|"+$/g, "");
					c.setAttribute("title", t), a.setAttribute("title", t);
				}
				s.replaceChild(c, a), c.appendChild(a), o.info("🔗 Wrapped node in <a> tag for:", n, e.url);
			});
		} catch (e) {
			o.error("❌ Error injecting clickable links:", e);
		}
		r.insertTitle(d, "statediagramTitleText", s?.titleTopMargin ?? 25, i.db.getDiagramTitle()), v(d, 8, z, s?.useMaxWidth ?? !0);
	}, "draw"),
	getDir: G
...
c(J, "stateDomId");
var he = /* @__PURE__ */ c((e, t, n, r, i, a, c, l) => {
	o.trace("items", t), t.forEach((t) => {
		switch (t.stmt) {
			case w:
				Z(e, t, n, r, i, a, c, l);
				break;
			...
			case E:
				{
					Z(e, t.state1, n, r, i, a, c, l), Z(e, t.state2, n, r, i, a, c, l);
					let o = c === "neo", u = {
						id: "edge" + q,
						start: t.state1.id,
						end: t.state2.id,
						...
						style: M,
						labelStyle: "",
						label: s.sanitizeText(t.description ?? "", m()),
						arrowheadStyle: N,
						labelpos: P,
						labelType: ee,
						thickness: F,
...
c(Y, "insertOrUpdateNode");
function X(e) {
	return e?.classes?.join(" ") ?? "";
}
c(X, "getClassesFromDbInfo");
function _e(e) {
	return e?.styles ?? [];
}
c(_e, "getStylesFromDbInfo");
var Z = /* @__PURE__ */ c((e, t, n, r, i, a, c, l) => {
	let u = t.id, d = n.get(u), f = X(d), p = _e(d), h = m();
	if (o.info("dataFetcher parsedItem", t, d, p), u !== "root") {
		let n = I;
		t.start === !0 ? n = te : t.start === !1 && (n = ne), t.type !== A && (n = t.type), K.get(u) || K.set(u, {
			id: u,
			shape: n,
			description: s.sanitizeText(u, h),
			cssClasses: `${f} ${oe}`,
			cssStyles: p
		});
		let d = K.get(u);
		t.description && (Array.isArray(d.description) ? (d.shape = L, d.description.push(t.description)) : d.description?.length && d.description.length > 0 ? (d.shape = L, d.description === u ? d.description = [t.description] : d.description = [d.description, t.description]) : (d.shape = I, d.description = t.description), d.description = s.sanitizeTextOrArray(d.description, h)), d.description?.length === 1 && d.shape === L && (d.type === "group" ? d.shape = re : d.shape = I), !d.type && t.doc && (o.info("Setting cluster for XCX", u, ge(t)), d.type = "group", d.isGroup = !0, d.dir = ge(t), d.explicitDir = t.doc.some((e) => e.stmt === "dir"), d.shape = t.type === j ? R : re, d.cssClasses = `${d.cssClasses} ${ue} ${a ? de : ""}`);
		let m = {
			labelStyle: "",
			shape: d.shape,
			label: d.description,
		...
		if (m.shape === R && (m.label = ""), e && e.id !== "root" && (o.trace("Setting node ", u, " to be child of its parent ", e.id), m.parentId = e.id), m.centerLabel = !0, t.note) {
			let e = {
				labelStyle: "",
				shape: ie,
				label: t.note.text,
			...
			q++, a.id = n, e.parentId = n, Y(r, a, l), Y(r, e, l), Y(r, m, l);
			let o = u, s = e.id;
			t.note.position === "left of" && (o = e.id, s = u), i.push({
				id: o + "-" + s,
				start: o,
				end: s,
				arrowhead: "none",
	...
	t.doc && (o.trace("Adding nodes children "), he(t, t.doc, n, r, i, !a, c, l));
}, "dataFetcher"), ve = /* @__PURE__ */ c(() => {
	K.clear(), q = 0;
}, "reset"), Q = {
	START_NODE: "[*]",
	START_TYPE: "start",
	...
	BG_FILL: "bgFill",
	STYLECLASS_SEP: ","
}, ye = /* @__PURE__ */ c(() => /* @__PURE__ */ new Map(), "newClassesList"), be = /* @__PURE__ */ c(() => ({
	relations: [],
	states: /* @__PURE__ */ new Map(),
	documents: {}
}), "newDoc"), $ = /* @__PURE__ */ c((e) => JSON.parse(JSON.stringify(e)), "clone"), xe = class {
	constructor(t) {
		this.version = t, this.nodes = [], this.edges = [], this.rootDoc = [], this.classes = ye(), this.documents = { root: be() }, this.currentDocument = this.documents.root, this.startEndCount = 0, this.dividerCnt = 0, this.links = /* @__PURE__ */ new Map(), this.funs = [], this.getAccTitle = h, this.setAccTitle = n, this.getAccDescription = f, this.setAccDescription = e, this.setDiagramTitle = i, this.getDiagramTitle = p, this.clear(), this.setRootDoc = this.setRootDoc.bind(this), this.getDividerId = this.getDividerId.bind(this), this.setDirection = this.setDirection.bind(this), this.trimColon = this.trimColon.bind(this), this.bindFunctions = this.bindFunctions.bind(this);
	}
	static {
		c(this, "StateDB");
	}
	...
	setRootDoc(e) {
		o.info("Setting root doc", e), this.rootDoc = e, this.version === 1 ? this.extract(e) : this.extract(this.getRootDocV2());
	}
	docTranslator(e, n, r) {
		if (n.stmt === E) {
		...
		if (n.stmt === w && (n.id === Q.START_NODE ? (n.id = e.id + (r ? "_start" : "_end"), n.start = r) : n.id = n.id.trim()), n.stmt !== T && n.stmt !== w || !n.doc) return;
		let i = [], a = [];
		for (let e of n.doc) if (e.type === j) {
			let t = $(e);
			t.doc = $(a), i.push(t), a = [];
		} else a.push(e);
	...
	addState(e, t = A, n = void 0, r = void 0, i = void 0, a = void 0, c = void 0, l = void 0) {
		let u = e?.trim();
		if (!this.currentDocument.states.has(u)) o.info("Adding state ", u, r), this.currentDocument.states.set(u, {
			stmt: w,
			id: u,
			descriptions: [],
			type: t,
		...
		if (r && (o.info("Setting state description", u, r), (Array.isArray(r) ? r : [r]).forEach((e) => this.addDescription(u, e.trim()))), i) {
			let e = this.currentDocument.states.get(u);
			if (!e) throw Error(`State not found: ${u}`);
			e.note = i, e.note.text = s.sanitizeText(e.note.text, m());
		}
		a && (o.info("Setting state classes", u, a), (Array.isArray(a) ? a : [a]).forEach((e) => this.setCssClass(u, e.trim()))), c && (o.info("Setting state styles", u, c), (Array.isArray(c) ? c : [c]).forEach((e) => this.setStyle(u, e.trim()))), l && (o.info("Setting state styles", u, c), (Array.isArray(l) ? l : [l]).forEach((e) => this.setTextStyle(u, e.trim())));
	}
	clear(e) {
		this.nodes = [], this.edges = [], this.funs = [this.setupToolTips.bind(this)], this.documents = { root: be() }, this.currentDocument = this.documents.root, this.startEndCount = 0, this.classes = ye(), e || (this.links = /* @__PURE__ */ new Map(), l());
	}
	getState(e) {
	...
	logDocuments() {
		o.info("Documents = ", this.documents);
	}
	getRelations() {
	...
	addRelationObjs(e, t, n = "") {
		...
		this.addState(r, i, e.doc, e.description, e.note, e.classes, e.styles, e.textStyles), this.addState(a, o, t.doc, t.description, t.note, t.classes, t.styles, t.textStyles), this.currentDocument.relations.push({
			id1: r,
			id2: a,
			relationTitle: s.sanitizeText(n, m())
		});
	}
	addRelation(e, t, n) {
		if (typeof e == "object" && typeof t == "object") this.addRelationObjs(e, t, n);
			...
			this.addState(r, i), this.addState(a, o), this.currentDocument.relations.push({
				id1: r,
				id2: a,
				relationTitle: n ? s.sanitizeText(n, m()) : void 0
			});
		}
	}
	addDescription(e, t) {
		let n = this.currentDocument.states.get(e), r = t.startsWith(":") ? t.replace(":", "").trim() : t;
		n?.descriptions?.push(s.sanitizeText(r, m()));
	}
	cleanupLabel(e) {
	...
	setupToolTips(e) {
		let t = g();
		d(e).select("svg").selectAll("g.node, g.rough-node").on("mouseover", (e) => {
			let n = d(e.currentTarget), r = n.attr("title");
			if (r === null) return;
			let i = e.currentTarget?.getBoundingClientRect();
			t.transition().duration(200).style("opacity", ".9"), t.style("left", window.scrollX + i.left + (i.right - i.left) / 2 + "px").style("top", window.scrollY + i.bottom + "px"), t.html(a.sanitize(r)), n.classed("hover", !0);
		}).on("mouseout", (e) => {
			t.transition().duration(500).style("opacity", 0), d(e.currentTarget).classed("hover", !1);
		});
	}
	setCssClass(e, t) {
		e.split(",").forEach((e) => {
