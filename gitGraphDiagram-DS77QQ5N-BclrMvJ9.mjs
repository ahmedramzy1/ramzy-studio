import { Bn as e, H as t, P as n, Vn as r, W as i, Wn as a, ar as o, bn as s, cn as c, cr as l, on as u, pn as d, qn as f, tn as p, vn as m, wn as h, xn as g, yn as _ } from "./chunk-J7OUQ5F2-BUGcDHyW.mjs";
import { n as v } from "./mermaid-parser.core-DgJi7O7s.mjs";
import { t as y } from "./chunk-JWPE2WC7-DWYJ5PBQ.mjs";
import { t as b } from "./chunk-2Q5K7J3B-BW0iFO2P.mjs";
...
var te = /* @__PURE__ */ l(function(e) {
...
}, "setDirection"), ne = /* @__PURE__ */ l(function(e) {
	o.debug("options str", e), e = e?.trim(), e ||= "{}";
	try {
		C.records.options = JSON.parse(e);
	} catch (e) {
		o.error("error while parsing gitGraph options", e.message);
	}
}, "setOptions"), re = /* @__PURE__ */ l(function() {
	return C.records.options;
}, "getOptions"), ie = /* @__PURE__ */ l(function(e) {
	let t = e.msg, n = e.id, r = e.type, i = e.tags;
	o.info("commit", t, n, r, i), o.debug("Entering commit:", t, n, r, i);
	let a = S();
	n = c.sanitizeText(n, a), t = c.sanitizeText(t, a), i = i?.map((e) => c.sanitizeText(e, a));
	let s = {
	...
	C.records.head = s, o.info("main branch", a.mainBranchName), C.records.commits.has(s.id) && o.warn(`Commit ID ${s.id} already exists`), C.records.commits.set(s.id, s), C.records.branches.set(C.records.currBranch, s.id), o.debug("in pushCommit " + s.id);
}, "commit"), ae = /* @__PURE__ */ l(function(e) {
	let t = e.name, n = e.order;
	if (t = c.sanitizeText(t, S()), C.records.branches.has(t)) throw Error(`Trying to create an existing branch. (Help: Either use a new name if you want create a new branch or try using "checkout ${t}")`);
	C.records.branches.set(t, C.records.head == null ? null : C.records.head.id), C.records.branchConfig.set(t, {
		name: t,
		order: n
	}), E(t), o.debug("in createBranch");
}, "branch"), oe = /* @__PURE__ */ l((e) => {
	let t = e.branch, n = e.id, r = e.type, i = e.tags, a = S();
	t = c.sanitizeText(t, a), n &&= c.sanitizeText(n, a);
	let s = C.records.branches.get(C.records.currBranch), l = C.records.branches.get(t), u = s ? C.records.commits.get(s) : void 0, d = l ? C.records.commits.get(l) : void 0;
	if (u && d && u.branch === t) throw Error(`Cannot merge branch '${t}' into itself.`);
	...
	C.records.head = p, C.records.commits.set(p.id, p), C.records.branches.set(C.records.currBranch, p.id), o.debug(C.records.branches), o.debug("in mergeBranch");
}, "merge"), se = /* @__PURE__ */ l(function(e) {
	let t = e.id, n = e.targetId, r = e.tags, i = e.parent;
	o.debug("Entering cherryPick:", t, n, r);
	let a = S();
	if (t = c.sanitizeText(t, a), n = c.sanitizeText(n, a), r = r?.map((e) => c.sanitizeText(e, a)), i = c.sanitizeText(i, a), !t || !C.records.commits.has(t)) {
	...
	if (i && !(Array.isArray(s.parents) && s.parents.includes(i))) throw /* @__PURE__ */ Error("Invalid operation: The specified parent commit is not an immediate parent of the cherry-picked commit.");
	let l = s.branch;
	if (s.type === x.MERGE && !i) throw /* @__PURE__ */ Error("Incorrect usage of cherry-pick: If the source commit is a merge commit, an immediate parent commit must be specified.");
	if (!n || !C.records.commits.has(n)) {
		if (l === C.records.currBranch) {
		...
		let c = {
			...
			branch: C.records.currBranch,
			type: x.CHERRY_PICK,
			tags: r ? r.filter(Boolean) : [`cherry-pick:${s.id}${s.type === x.MERGE ? `|parent:${i}` : ""}`]
		};
		C.records.head = c, C.records.commits.set(c.id, c), C.records.branches.set(C.records.currBranch, c.id), o.debug(C.records.branches), o.debug("in cherryPick");
	}
}, "cherryPick"), E = /* @__PURE__ */ l(function(e) {
	if (e = c.sanitizeText(e, S()), C.records.branches.has(e)) {
...
function O(e) {
	...
	if (o.debug(r.join(" ")), t.parents && t.parents.length == 2 && t.parents[0] && t.parents[1]) {
...
l(O, "prettyPrintCommitHistory");
var ce = /* @__PURE__ */ l(function() {
	o.debug(C.records.commits);
	let e = k()[0];
	O([e]);
}, "prettyPrint"), le = /* @__PURE__ */ l(function() {
	C.reset(), u();
}, "clear"), ue = /* @__PURE__ */ l(function() {
...
}, "getBranchesAsObjArray"), de = /* @__PURE__ */ l(function() {
	return C.records.branches;
}, "getBranches"), fe = /* @__PURE__ */ l(function() {
	return C.records.commits;
}, "getCommits"), k = /* @__PURE__ */ l(function() {
...
}, "populate"), me = /* @__PURE__ */ l((e, t) => {
	let n = {
		Commit: /* @__PURE__ */ l((e) => t.commit(he(e)), "Commit"),
		Branch: /* @__PURE__ */ l((e) => t.branch(ge(e)), "Branch"),
		Merge: /* @__PURE__ */ l((e) => t.merge(_e(e)), "Merge"),
		Checkout: /* @__PURE__ */ l((e) => t.checkout(ve(e)), "Checkout"),
		CherryPicking: /* @__PURE__ */ l((e) => t.cherryPick(ye(e)), "CherryPicking")
	}[e.$type];
	n ? n(e) : o.error(`Unknown statement type: ${e.$type}`);
}, "parseStatement"), he = /* @__PURE__ */ l((e) => ({
	id: e.id,
	msg: e.message ?? "",
	type: e.type === void 0 ? x.NORMAL : x[e.type],
	tags: e.tags ?? void 0
}), "parseCommit"), ge = /* @__PURE__ */ l((e) => ({
	name: e.name,
	order: e.order ?? 0
}), "parseBranch"), _e = /* @__PURE__ */ l((e) => ({
	branch: e.branch,
	id: e.id ?? "",
	type: e.type === void 0 ? void 0 : x[e.type],
	tags: e.tags ?? void 0
}), "parseMerge"), ve = /* @__PURE__ */ l((e) => e.branch, "parseCheckout"), ye = /* @__PURE__ */ l((e) => ({
	id: e.id,
	targetId: "",
	tags: e.tags?.length === 0 ? void 0 : e.tags,
	parent: e.parent
}), "parseCherryPicking"), be = { parse: /* @__PURE__ */ l(async (e) => {
	let t = await v("gitGraph", e);
	o.debug(t), pe(t, A);
	...
	"redux-dark-color",
	"neo-dark"
]), z = /* @__PURE__ */ l((e, t, n = !1) => n && e > 0 ? (e - 1) % (t - 1) + 1 : e % t, "calcColorIndex"), B = /* @__PURE__ */ new Map(), V = /* @__PURE__ */ new Map(), H = 30, U = /* @__PURE__ */ new Map(), W = [], G = 0, K = "LR", q = /* @__PURE__ */ l(() => {
	B.clear(), V.clear(), U.clear(), G = 0, W = [], K = "LR";
}, "clear"), J = /* @__PURE__ */ l((e) => {
...
}, "drawText"), Y = /* @__PURE__ */ l((e) => {
	let t, n, r;
	return K === "BT" ? (n = /* @__PURE__ */ l((e, t) => e <= t, "comparisonFunc"), r = Infinity) : (n = /* @__PURE__ */ l((e, t) => e >= t, "comparisonFunc"), r = 0), e.forEach((e) => {
		let i = K === "TB" || K == "BT" ? V.get(e)?.y : V.get(e)?.x;
		i !== void 0 && n(i, r) && (t = e, r = i);
	}), t;
}, "findClosestParent"), Se = /* @__PURE__ */ l((e) => {
	let t = "", n = Infinity;
	return e.forEach((e) => {
		let r = V.get(e).y;
		r <= n && (t = e, n = r);
	}), t || void 0;
}, "findClosestParentBT"), Ce = /* @__PURE__ */ l((e, t, n) => {
	let r = n, i = n, a = [];
	e.forEach((e) => {
		let n = t.get(e);
...
}, "setParallelBTPos"), we = /* @__PURE__ */ l((e) => {
	...
	return n;
}, "findClosestParentPos"), Te = /* @__PURE__ */ l((e) => we(e) + M, "calculateCommitPosition"), Ee = /* @__PURE__ */ l((e, t) => {
...
}, "setCommitPosition"), De = /* @__PURE__ */ l((e, t, n) => {
...
}, "setRootPosition"), Oe = /* @__PURE__ */ l((e, t, n, r, i, a) => {
	let { theme: o } = g(), s = I.has(o ?? ""), c = R.has(o ?? ""), l = xe.has(o ?? "");
...
}, "drawCommitBullet"), ke = /* @__PURE__ */ l((e, t, n, r, i) => {
...
}, "drawCommitLabel"), Ae = /* @__PURE__ */ l((e, t, n, r) => {
	if (t.tags.length > 0) {
		let i = 0, a = 0, o = 0, s = [];
...
}, "drawCommitTags"), je = /* @__PURE__ */ l((e) => {
...
}, "getCommitClassType"), Me = /* @__PURE__ */ l((e, t, n, r) => {
	let i = {
		x: 0,
		y: 0
	};
	...
	return 0;
}, "calculatePosition"), Ne = /* @__PURE__ */ l((e, t, n) => {
...
}, "getCommitPosition"), X = /* @__PURE__ */ l((e, t, n, r) => {
	let i = e.append("g").attr("class", "commit-bullets"), a = e.append("g").attr("class", "commit-labels"), o = K === "TB" || K === "BT" ? H : 0, s = [...t.keys()], c = r.parallelCommits ?? !1, u = /* @__PURE__ */ l((e, n) => {
		let r = t.get(e)?.seq, i = t.get(n)?.seq;
		return r !== void 0 && i !== void 0 ? r - i : 0;
	}, "sortKeys"), d = s.sort(u);
	K === "BT" && (c && Ce(d, t, o), d = d.reverse()), d.forEach((e) => {
		let s = t.get(e);
...
}, "drawCommits"), Pe = /* @__PURE__ */ l((e, t, n, r, i) => {
	let a = (K === "TB" || K === "BT" ? n.x < r.x : n.y < r.y) ? t.branch : e.branch, o = /* @__PURE__ */ l((e) => e.branch === a, "isOnBranchToGetCurve"), s = /* @__PURE__ */ l((n) => n.seq > e.seq && n.seq < t.seq, "isBetweenCommits");
	return [...i.values()].some((e) => s(e) && o(e));
}, "shouldRerouteArrow"), Z = /* @__PURE__ */ l((e, t, n = 0) => {
	let r = e + Math.abs(e - t) / 2;
	return n > 5 ? r : W.every((e) => Math.abs(e - r) >= 10) ? (W.push(r), r) : Z(e, t - Math.abs(e - t) / 5, n + 1);
}, "findLane"), Fe = /* @__PURE__ */ l((e, t, n, r) => {
	let { theme: i } = g(), a = R.has(i ?? ""), o = V.get(t.id), s = V.get(n.id);
	if (o === void 0 || s === void 0) throw Error(`Commit positions not found for commits ${t.id} and ${n.id}`);
	let c = Pe(t, n, o, s, r), l = "", u = "", d = 0, f = 0, p = B.get(n.branch)?.index;
	...
	} else l = "A 20 20, 0, 0, 0,", u = "A 20 20, 0, 0, 1,", d = 20, f = 20, K === "TB" ? (o.x < s.x && (m = n.type === x.MERGE && t.id !== n.parents[0] ? `M ${o.x} ${o.y} L ${o.x} ${s.y - d} ${l} ${o.x + f} ${s.y} L ${s.x} ${s.y}` : `M ${o.x} ${o.y} L ${s.x - d} ${o.y} ${u} ${s.x} ${o.y + f} L ${s.x} ${s.y}`), o.x > s.x && (l = "A 20 20, 0, 0, 0,", u = "A 20 20, 0, 0, 1,", d = 20, f = 20, m = n.type === x.MERGE && t.id !== n.parents[0] ? `M ${o.x} ${o.y} L ${o.x} ${s.y - d} ${u} ${o.x - f} ${s.y} L ${s.x} ${s.y}` : `M ${o.x} ${o.y} L ${s.x + d} ${o.y} ${l} ${s.x} ${o.y + f} L ${s.x} ${s.y}`), o.x === s.x && (m = `M ${o.x} ${o.y} L ${s.x} ${s.y}`)) : K === "BT" ? (o.x < s.x && (m = n.type === x.MERGE && t.id !== n.parents[0] ? `M ${o.x} ${o.y} L ${o.x} ${s.y + d} ${u} ${o.x + f} ${s.y} L ${s.x} ${s.y}` : `M ${o.x} ${o.y} L ${s.x - d} ${o.y} ${l} ${s.x} ${o.y - f} L ${s.x} ${s.y}`), o.x > s.x && (l = "A 20 20, 0, 0, 0,", u = "A 20 20, 0, 0, 1,", d = 20, f = 20, m = n.type === x.MERGE && t.id !== n.parents[0] ? `M ${o.x} ${o.y} L ${o.x} ${s.y + d} ${l} ${o.x - f} ${s.y} L ${s.x} ${s.y}` : `M ${o.x} ${o.y} L ${s.x + d} ${o.y} ${u} ${s.x} ${o.y - f} L ${s.x} ${s.y}`), o.x === s.x && (m = `M ${o.x} ${o.y} L ${s.x} ${s.y}`)) : (o.y < s.y && (m = n.type === x.MERGE && t.id !== n.parents[0] ? `M ${o.x} ${o.y} L ${s.x - d} ${o.y} ${u} ${s.x} ${o.y + f} L ${s.x} ${s.y}` : `M ${o.x} ${o.y} L ${o.x} ${s.y - d} ${l} ${o.x + f} ${s.y} L ${s.x} ${s.y}`), o.y > s.y && (m = n.type === x.MERGE && t.id !== n.parents[0] ? `M ${o.x} ${o.y} L ${s.x - d} ${o.y} ${l} ${s.x} ${o.y - f} L ${s.x} ${s.y}` : `M ${o.x} ${o.y} L ${o.x} ${s.y + d} ${u} ${o.x + f} ${s.y} L ${s.x} ${s.y}`), o.y === s.y && (m = `M ${o.x} ${o.y} L ${s.x} ${s.y}`));
	if (m === void 0) throw Error("Line definition not found");
	e.append("path").attr("d", m).attr("class", "arrow arrow" + z(p, F, a));
}, "drawArrow"), Ie = /* @__PURE__ */ l((e, t) => {
...
}, "drawArrows"), Le = /* @__PURE__ */ l((e, t, n, r) => {
	let { look: i, theme: a, themeVariables: o } = g(), { dropShadow: s, THEME_COLOR_LIMIT: c } = o, l = I.has(a ?? ""), u = R.has(a ?? ""), d = e.append("g");
	t.forEach((e, t) => {
...
}, "drawBranches"), Re = /* @__PURE__ */ l(function(e, t, n, r, i) {
	return B.set(e, {
		pos: t,
		index: n
	}), t += 50 + (i ? 40 : 0) + (K === "TB" || K === "BT" ? r.width / 2 : 0), t;
}, "setBranchPosition"), ze = { draw: /* @__PURE__ */ l(function(e, t, n, r) {
	q(), o.debug("in gitgraph renderer", e + "\n", "id:", t, n);
	let a = r.db;
	if (!a.getConfig) {
		o.error("getConfig method is not available on db");
		return;
	}
	let s = a.getConfig(), c = s.rotateCommitLabel ?? !1;
	U = a.getCommits();
	let l = a.getBranchesAsObjArray();
	K = a.getDirection();
	let u = p(`[id="${t}"]`), { look: d, theme: m, themeVariables: h } = g(), { useGradient: _, gradientStart: v, gradientStop: y, filterColor: b } = h;
	if (_) {
	...
	d === "neo" && I.has(m ?? "") && u.append("defs").append("filter").attr("id", t + "-drop-shadow").attr("height", "130%").attr("width", "130%").append("feDropShadow").attr("dx", "4").attr("dy", "4").attr("stdDeviation", 0).attr("flood-opacity", "0.06").attr("flood-color", b);
	let x = 0;
	l.forEach((e, t) => {
		...
		let o = n.getBBox();
		x = Re(e.name, x, t, o, c), a.remove(), i.remove(), r.remove();
	}), X(u, U, !1, s), s.showBranches && Le(u, l, s, t), Ie(u, U), X(u, U, !0, s), i.insertTitle(u, "gitTitleText", s.titleTopMargin ?? 0, a.getDiagramTitle()), f(void 0, u, s.diagramPadding, s.useMaxWidth);
	...
	if (e.useGradient && t) for (let r = 0; r < e.THEME_COLOR_LIMIT; r++) n += `
      .label${r}  { fill: ${e.mainBkg}; stroke: url(${t}-gradient); stroke-width: ${e.strokeWidth};}
             `;
	return n;
}, "genGitGraphGradient"), Ge = /* @__PURE__ */ l((e) => {
	let { theme: t, themeVariables: n } = s(), { borderColorArray: r } = n, i = $.has(t);
	if (Ve.has(t)) {
		let t = "";
...
}, "genColor"), Ke = /* @__PURE__ */ l((e) => `${Array.from({ length: e.THEME_COLOR_LIMIT }, (e, t) => t).map((t) => {
	let n = t % Q;
	return `
