...
var _ = {
	...
	curves: [],
	options: _
}, b = structuredClone(y), x = u.radar, S = /* @__PURE__ */ s(() => n({
	...x,
	...o().radar
}), "getConfig"), C = /* @__PURE__ */ s(() => b.axes, "getAxes"), w = /* @__PURE__ */ s(() => b.curves, "getCurves"), T = /* @__PURE__ */ s(() => b.options, "getOptions"), E = /* @__PURE__ */ s((e) => {
	b.axes = e.map((e) => ({
		name: e.name,
		label: e.label ?? e.name
	}));
}, "setAxes"), D = /* @__PURE__ */ s((e) => {
	b.curves = e.map((e) => ({
		name: e.name,
		label: e.label ?? e.name,
		entries: O(e.entries)
	}));
}, "setCurves"), O = /* @__PURE__ */ s((e) => {
	...
	setOptions: /* @__PURE__ */ s((e) => {
		...
		}, b.options.ticks > v && (a.warn(`Radar diagram ticks (${b.options.ticks}) exceeds maximum allowed (${v}). Using ${v} instead.`), b.options.ticks = v);
	}, "setOptions"),
	getConfig: S,
	clear: /* @__PURE__ */ s(() => {
		l(), b = structuredClone(y);
	}, "clear"),
	setAccTitle: r,
	getAccTitle: m,
	setDiagramTitle: i,
...
}, "populate"), j = { parse: /* @__PURE__ */ s(async (e) => {
	let t = await h("radar", e);
	a.debug(t), A(t);
}, "parse") }, M = /* @__PURE__ */ s((e, t, n, r) => {
	let i = r.db, a = i.getAxes(), o = i.getCurves(), s = i.getOptions(), c = i.getConfig(), l = i.getDiagramTitle(), u = N(p(t), c), d = s.max ?? Math.max(...o.map((e) => Math.max(...e.entries))), f = s.min, m = Math.min(c.width, c.height) / 2;
	P(u, a, m, s.ticks, s.graticule), F(u, a, m, c), I(u, a, o, f, d, s.graticule, c), z(u, o, s.showLegend, c), u.append("text").attr("class", "radarTitle").text(l).attr("x", 0).attr("y", -c.height / 2 - c.marginTop);
}, "draw"), N = /* @__PURE__ */ s((e, t) => {
	...
	return c(e, r, n, t.useMaxWidth ?? !0), e.attr("viewBox", `0 0 ${n} ${r}`).attr("overflow", "visible"), e.append("g").attr("transform", `translate(${i.x}, ${i.y})`);
}, "drawFrame"), P = /* @__PURE__ */ s((e, t, n, r, i) => {
...
}, "drawGraticule"), F = /* @__PURE__ */ s((e, t, n, r) => {
	let i = t.length;
	for (let a = 0; a < i; a++) {
...
var B = { draw: M }, V = /* @__PURE__ */ s((e, t) => {
	...
	return n;
}, "genIndexStyles"), H = /* @__PURE__ */ s((e) => {
	let r = n(t(), o().themeVariables);
	return {
		themeVariables: r,
		radarOptions: n(r.radar, e)
	};
}, "buildRadarStyleOptions"), U = {
	parser: j,
	db: k,
	renderer: B,
	styles: /* @__PURE__ */ s(({ radar: e } = {}) => {
