import { $n as e, A as t, B as n, Bn as r, D as i, Dt as a, E as o, F as s, Gn as c, Gt as l, Hn as u, I as d, K as f, M as p, N as m, O as h, Ot as g, P as _, Q as v, T as y, U as b, Vn as x, W as S, Y as C, Yt as w, Z as T, _n as E, _t as D, ct as O, dt as k, et as A, ft as j, g as M, gn as ee, j as te, jn as ne, k as N, kt as re, lt as P, mt as ie, nt as ae, ot as oe, rt as F, st as se, tr as ce, tt as le, ut as ue, w as de, wn as fe, zt as pe } from "./events-sARIYVlw.mjs";
import { A as me, B as he, C as I, D as L, E as ge, F as _e, G as ve, H as ye, I as be, J as xe, K as Se, L as Ce, M as we, N as R, O as Te, R as Ee, S as De, T as Oe, U as ke, V as Ae, W as je, Y as Me, _ as Ne, a as Pe, b as Fe, c as Ie, d as Le, f as Re, g as ze, h as Be, i as Ve, j as He, k as Ue, l as We, m as Ge, n as Ke, o as qe, p as Je, q as Ye, r as Xe, s as Ze, u as Qe, v as $e, w as et, x as tt, y as nt } from "./Combination-dchHqP5q.mjs";
...
function Dt(e) {
	...
	if ((d || !d && !a) && ((ze(r) !== "body" || ge(o)) && (c = Ne(r)), et(r))) {
		let e = wt(r);
...
function kt(e) {
	let t = Ge(e), n = Ne(e), r = e.ownerDocument.body, i = Se(t.scrollWidth, t.clientWidth, r.scrollWidth, r.clientWidth), a = Se(t.scrollHeight, t.clientHeight, r.scrollHeight, r.clientHeight), o = -n.scrollLeft + Tt(e), s = -n.scrollTop;
	return Re(r).direction === "rtl" && (o += Se(t.clientWidth, r.clientWidth) - i), {
		width: i,
		height: a,
		x: o,
		y: s
...
function Pt(e, t) {
	let n = nt(e);
	return n === t || !I(n) || Oe(n) ? !1 : Re(n).position === "fixed" || Pt(n, t);
}
function Ft(e, t) {
	let n = t.get(e);
	if (n) return n;
	let r = $e(e, [], !1).filter((e) => I(e) && ze(e) !== "body"), i = null, a = Re(e).position === "fixed", o = a ? nt(e) : e;
	for (; I(o) && !Oe(o);) {
		let t = Re(o), n = De(o);
		!n && t.position === "fixed" && (i = null), (a ? !n && !i : !n && t.position === "static" && i && jt.has(i.position) || ge(o) && !n && Pt(e, o)) ? r = r.filter((e) => e !== o) : i = t, o = nt(o);
	}
	return t.set(e, r), r;
}
function It(e) {
	let { element: t, boundary: n, rootBoundary: r, strategy: i } = e, a = [...n === "clippingAncestors" ? Ue(t) ? [] : Ft(t, this._c) : [].concat(n), r], o = a[0], s = a.reduce((e, n) => {
		let r = Nt(t, n, i);
		return e.top = Se(r.top, e.top), e.right = Ye(r.right, e.right), e.bottom = Ye(r.bottom, e.bottom), e.left = Se(r.left, e.left), e;
	}, Nt(t, o, i));
	return {
...
function Rt(e, t, n) {
	...
	if (r || !r && !a) if ((ze(t) !== "body" || ge(i)) && (s = Ne(t)), r) {
		let e = wt(t, !0, a, t);
...
var Jt = he, Yt = we, Xt = Ae, Zt = _e, Qt = ye, $t = be, en = He, tn = Ee, nn = (e, t, n) => {
...
function Un({ classNames: e, styles: t, props: n, stylesCtx: r }) {
	let i = f();
	return {
		resolvedClassNames: e === void 0 ? void 0 : le({
			theme: i,
			classNames: e,
			props: n,
			stylesCtx: r || void 0
...
var [qn, Jn] = ie("ScrollArea.Root component was not found in tree");
//#endregion
...
function $n(e) {
	let { type: t, scrollHideDelay: n, scrollbars: r, getStyles: i, ref: a, ...o } = S("ScrollAreaRoot", Qn, e), [s, c] = U(null), [l, u] = U(null), [d, f] = U(null), [p, m] = U(null), [h, g] = U(null), [v, y] = U(0), [b, x] = U(0), [C, w] = U(!1), [T, E] = U(!1), D = Mn(a, c);
...
var [lr, ur] = ie("ScrollAreaScrollbar was not found in tree");
//#endregion
...
function Ni(e, t) {
	...
	let { open: n, onOpenChange: r, elements: i, dataRef: a } = e, { enabled: o = !0, escapeKey: s = !0, outsidePress: c = !0, outsidePressEvent: l = "pointerdown", referencePress: u = !1, referencePressEvent: d = "pointerdown", ancestorScroll: f = !1, bubbles: p, capture: m } = t, h = gi(), g = qr(typeof c == "function" ? c : () => !1), _ = typeof c == "function" ? g : c, v = z.useRef(!1), { escapeKey: y, outsidePress: b } = Mi(p), { escapeKey: x, outsidePress: S } = Mi(m), C = z.useRef(!1), w = qr((e) => {
		...
		let o = Nr(e), s = "[" + _i("inert") + "]", c = Ir(i.floating).querySelectorAll(s), u = I(o) ? o : null;
		for (; u && !Oe(u);) {
			let e = nt(u);
			if (Oe(e) || !I(e)) break;
			u = e;
		}
		if (c.length && I(o) && !Fr(o) && !Mr(o, i.floating) && Array.from(c).every((e) => !Mr(u, e))) return;
		if (et(o) && k) {
	...
	z.useEffect(() => {
		...
		let p = [];
		return f && (I(i.domReference) && (p = $e(i.domReference)), I(i.floating) && (p = p.concat($e(i.floating))), !I(i.reference) && i.reference && i.reference.contextElement && (p = p.concat($e(i.reference.contextElement)))), p = p.filter((e) => e !== d.defaultView?.visualViewport), p.forEach((e) => {
...
function Pi(e) {
	...
	if (process.env.NODE_ENV !== "production") {
		let e = r.reference;
		e && !I(e) && di("Cannot pass a virtual element to the `elements.reference` option,", "as it must be a real DOM element. Use `refs.setPositionReference()`", "instead.");
	}
...
function Fi(e) {
	...
	let f = Qe({
		...
		(I(e) || e === null) && (u.current = e, o(e)), (I(f.refs.reference.current) || f.refs.reference.current === null || e !== null && !I(e)) && f.refs.setReference(e);
	}, [f.refs]), h = z.useMemo(() => ({
		...f.refs,
		setReference: m,
...
function Li(e, t) {
	...
	let f = z.useMemo(() => ({
		...
		onBlur(e) {
			l.current = !1;
			let t = e.relatedTarget, n = e.nativeEvent, i = I(t) && t.hasAttribute(_i("focus-guard")) && t.getAttribute("data-type") === "outside";
...
function Gi(e) {
	...
	let u = (e) => {
		...
		return function(e) {
			...
			if (v && I(e.relatedTarget) && Oi(c.floating, e.relatedTarget) || f && Hi(f.nodesRef.current, d).length) return;
			...
			if (!Ui([m, h], ee)) {
				...
				Ui([m, h], te([n, o])) ? !a && r && (i.current = window.setTimeout(p, 40)) : p();
			}
		};
	};
...
var Ki = {
	...
	type: "hover",
	scrollbars: "xy"
}, qi = F((e, { scrollbarSize: t, overscrollBehavior: n, scrollbars: r }) => {
	let i = n;
	...
	let t = S("ScrollArea", Ki, e), { classNames: n, className: r, style: i, styles: a, unstyled: o, scrollbarSize: s, vars: c, type: l, scrollHideDelay: u, viewportProps: d, viewportRef: f, onScrollPositionChange: p, children: m, offsetScrollbars: h, scrollbars: g, onBottomReached: _, onTopReached: v, onLeftReached: y, onRightReached: x, overscrollBehavior: C, startScrollPosition: w, attributes: T, ...E } = t, [D, O] = U(!1), [k, A] = U(!1), [j, M] = U(!1), ee = H(!0), te = H(!1), ne = H(!0), N = H(!1), re = b({
		name: "ScrollArea",
		props: t,
		classes: Cr,
		className: r,
		...
		children: [
			/* @__PURE__ */ G(Sr, {
				...
				onScroll: (e) => {
					...
					s && !te.current && _?.(), c && !ee.current && v?.(), te.current = s, ee.current = c;
					let l = i - (a - o) >= -.8, u = i === 0;
					l && !N.current && x?.(), u && !ne.current && y?.(), N.current = l, ne.current = u;
				},
				children: m
			}),
			(g === "xy" || g === "x") && /* @__PURE__ */ G(vr, {
				...
				onMouseEnter: () => O(!0),
				onMouseLeave: () => O(!1),
				children: /* @__PURE__ */ G(xr, { ...re("thumb") })
			}),
...
var Yi = d((e) => {
	let { children: t, classNames: n, styles: r, scrollbarSize: i, scrollHideDelay: a, type: o, dir: s, offsetScrollbars: c, overscrollBehavior: l, viewportRef: u, onScrollPositionChange: d, unstyled: f, variant: p, viewportProps: m, scrollbars: h, style: g, vars: v, onBottomReached: y, onTopReached: b, startScrollPosition: x, onOverflowChange: C, ...w } = S("ScrollAreaAutosize", Ki, e), T = H(null), [E, D] = U(null), O = Jr([
		u,
		T,
		B((e) => {
			D((t) => t === e ? t : e);
	...
	return Yn(C ? E : null, j), /* @__PURE__ */ G(_, {
		...w,
		variant: p,
		style: [{
			display: "flex",
...
var Xi = { root: "m_515a97f8" }, Zi = d((e) => {
	let t = S("VisuallyHidden", null, e), { classNames: n, className: r, style: i, styles: a, unstyled: o, vars: s, attributes: c, ...l } = t;
	return /* @__PURE__ */ G(_, {
		component: "span",
		...b({
			name: "VisuallyHidden",
...
var sa = { root: "m_9814e45f" }, ca = { zIndex: dn("modal") }, la = F((e, { gradient: t, color: n, backgroundOpacity: r, blur: i, radius: a, zIndex: o }) => ({ root: {
	"--overlay-bg": t || (n !== void 0 || r !== void 0) && C(n || "#000", r ?? .6) || void 0,
	"--overlay-filter": i ? `blur(${D(i)})` : void 0,
	"--overlay-radius": a === void 0 ? void 0 : ue(a),
	"--overlay-z-index": o?.toString()
} })), ua = s((e) => {
	let t = S("Overlay", ca, e), { classNames: n, className: r, style: i, styles: a, unstyled: o, vars: s, fixed: c, center: l, children: u, radius: d, zIndex: f, gradient: p, blur: m, color: h, backgroundOpacity: g, mod: v, attributes: y, ...x } = t;
	return /* @__PURE__ */ G(_, {
		...b({
			name: "Overlay",
			props: t,
...
var pa = { reuseTargetNode: !0 }, ma = d((e) => {
	let { children: t, target: n, reuseTargetNode: r, ref: i, ...a } = S("Portal", pa, e), [o, s] = U(!1), c = H(null);
	return se(() => (s(!0), c.current = fa({
		target: n,
		reuseTargetNode: r,
		...a
...
var ha = d(({ withinPortal: e = !0, children: t, ...n }) => rt() === "test" || !e ? /* @__PURE__ */ G(W, { children: t }) : /* @__PURE__ */ G(ma, {
	...n,
	children: t
}));
...
var [va, ya] = ie("Popover component was not found in the tree");
//#endregion
...
function xa(e) {
	let { children: t, disabled: n, longPressDelay: r } = S("PopoverContextMenu", null, e), i = Hn(t);
...
var wa = {
	...
	let t = S("PopoverDropdown", null, e), { className: n, style: r, vars: i, children: a, onKeyDownCapture: o, variant: s, classNames: c, styles: l, ref: u, ...d } = t, f = ya(), { dir: p } = Kn(), m = f.arrowPosition === "merge" && f.withArrow ? ra({
...
var Ea = {
	...
	let { children: t, refProp: n, popupType: r, ref: i, ...a } = S("PopoverTarget", Ea, e), o = Hn(t);
	...
	return lt(o, {
		...
		...u,
		...c.targetProps,
		className: ae(c.targetProps.className, s.className, d.className),
		[n]: l,
...
var ja = {
	...
	width: "max-content"
}, Ma = F((e, { radius: t, shadow: n }) => ({ dropdown: {
	"--popover-radius": t === void 0 ? void 0 : ue(t),
	"--popover-shadow": k(n)
} }));
function J(e) {
	let t = S("Popover", ja, e), { children: n, position: r, offset: i, onPositionChange: a, opened: o, transitionProps: s, onExitTransitionEnd: c, onEnterTransitionEnd: l, width: u, middlewares: d, withArrow: f, arrowSize: p, arrowOffset: m, arrowRadius: h, arrowPosition: g, unstyled: _, classNames: v, styles: y, closeOnClickOutside: x, withinPortal: C, portalProps: w, closeOnEscape: T, clickOutsideEvents: E, trapFocus: D, onClose: O, onDismiss: k, onOpen: A, onChange: j, zIndex: M, radius: ee, shadow: ne, id: N, defaultOpened: re, __staticSelector: P, withRoles: ie, disabled: ae, returnFocus: oe, variant: F, keepMounted: se, keepMountedMode: ce, vars: le, floatingStrategy: ue, withOverlay: de, overlayProps: fe, hideDetached: pe, attributes: me, preventPositionChangeWhenVisible: he, ...I } = t, L = b({
		name: P,
		props: t,
		classes: wa,
		classNames: v,
		...
		vars: le,
		varsResolver: Ma
	}), { resolvedStyles: ge } = Un({
		classNames: v,
		styles: y,
		props: t
	}), _e = H(null), [ve, ye] = U(null), [be, xe] = U(null), { dir: Se } = Kn(), Ce = rt(), we = kn(N), R = Aa({
		middlewares: d,
		width: u,
		position: aa(Se, r),
		...
		strategy: ue,
		disabled: ae,
		preventPositionChangeWhenVisible: he,
		keepMounted: se
	});
	_n(() => {
		x && (R.onClose(), k?.());
	...
	let Te = B((e) => {
		ye(e), R.floating.refs.setReference(e);
	}, [R.floating.refs.setReference]), Ee = B((e) => {
		xe(e), R.floating.refs.setFloating(e);
	}, [R.floating.refs.setFloating]), De = B(() => {
	...
	return /* @__PURE__ */ K(va, {
		value: {
			...
			resolvedStyles: ge,
			floatingStrategy: ue,
			referenceHidden: pe && Ce !== "test" ? R.floating.middlewareData.hide?.referenceHidden : !1
		},
		children: [n, de && /* @__PURE__ */ G(te, {
			transition: "fade",
			mounted: R.opened,
...
}, Fa = { variant: "subtle" }, Ia = F((e, { size: t, radius: n, iconSize: r }) => ({ root: {
	"--cb-size": j(t, "cb-size"),
	"--cb-radius": n === void 0 ? void 0 : ue(n),
	"--cb-icon-size": D(r)
} })), La = s((e) => {
	let t = S("CloseButton", Fa, e), { iconSize: n, children: r, vars: i, radius: a, className: o, classNames: s, style: c, styles: l, unstyled: u, "data-disabled": d, disabled: f, variant: p, icon: h, mod: g, attributes: _, __staticSelector: v, ...y } = t, x = b({
		name: v || "CloseButton",
		props: t,
		className: o,
		style: c,
...
var Ra = ut({ size: "sm" }), za = d((e) => {
	let t = S("InputClearButton", null, e), { size: n, variant: r, vars: i, classNames: a, styles: o, ...s } = t, c = ft(Ra), { resolvedClassNames: l, resolvedStyles: u } = Un({
		classNames: a,
		styles: o,
		props: t
	});
...
}, Wa = F((e, { size: t }) => ({ description: { "--input-description-size": t === void 0 ? void 0 : `calc(${P(t)} - ${D(2)})` } })), Ga = d((e) => {
	let t = S("InputDescription", null, e), { classNames: n, className: r, style: i, styles: a, unstyled: o, vars: s, __staticSelector: c, __inheritStyles: l = !0, attributes: u, ...d } = S("InputDescription", null, t), f = ft(Ha), p = b({
		name: ["InputWrapper", c],
		props: t,
		classes: Ua,
		className: r,
...
var Ka = F((e, { size: t }) => ({ error: { "--input-error-size": t === void 0 ? void 0 : `calc(${P(t)} - ${D(2)})` } })), qa = d((e) => {
	let t = S("InputError", null, e), { classNames: n, className: r, style: i, styles: a, unstyled: o, vars: s, attributes: c, __staticSelector: l, __inheritStyles: u = !0, ...d } = t, f = b({
		name: ["InputWrapper", l],
		props: t,
		classes: Ua,
		className: r,
...
var Ja = { labelElement: "label" }, Ya = F((e, { size: t }) => ({ label: {
	"--input-label-size": P(t),
	"--input-asterisk-color": void 0
} })), Xa = d((e) => {
	let t = S("InputLabel", Ja, e), { classNames: n, className: r, style: i, styles: a, unstyled: o, vars: s, labelElement: c, required: l, htmlFor: u, onMouseDown: d, children: f, __staticSelector: p, mod: m, attributes: h, ...g } = t, v = b({
		name: ["InputWrapper", p],
		props: t,
		classes: Ua,
		className: r,
...
var Za = d((e) => {
	let t = S("InputPlaceholder", null, e), { classNames: n, className: r, style: i, styles: a, unstyled: o, vars: s, __staticSelector: c, error: l, mod: u, attributes: d, ...f } = t;
	return /* @__PURE__ */ G(_, {
		...b({
...
var $a = {
	...
	error: { "--input-error-size": t === void 0 ? void 0 : `calc(${P(t)} - ${D(2)})` },
	description: { "--input-description-size": t === void 0 ? void 0 : `calc(${P(t)} - ${D(2)})` }
})), to = d((e) => {
	let t = S("InputWrapper", $a, e), { classNames: n, className: r, style: i, styles: a, unstyled: o, vars: s, size: c, variant: l, __staticSelector: u, inputContainer: d, inputWrapperOrder: f, label: p, error: m, description: h, labelProps: g, descriptionProps: v, errorProps: y, labelElement: x, children: C, withAsterisk: w, id: T, required: E, __stylesApiProps: D, mod: O, attributes: k, ...A } = t, j = b({
		name: ["InputWrapper", u],
		props: D || t,
		classes: Ua,
		className: r,
		...
		variant: l,
		__staticSelector: u
	}, ee = kn(T), te = typeof w == "boolean" ? w : E, ne = y?.id || `${ee}-error`, N = v?.id || `${ee}-description`, re = ee, P = !!m && typeof m != "boolean", ie = !!h, ae = `${P ? ne : ""} ${ie ? N : ""}`, oe = ae.trim().length > 0 ? ae.trim() : void 0, F = g?.id || `${ee}-label`, se = p && /* @__PURE__ */ G(Xa, {
		labelElement: x,
		id: F,
		htmlFor: re,
		required: te,
		...
		...g,
		children: p
	}, "label"), ce = ie && /* @__PURE__ */ G(Ga, {
		...v,
		...M,
		size: v?.size || M.size,
		id: v?.id || N,
		children: h
	}, "description"), le = /* @__PURE__ */ G(ct, { children: d(C) }, "input"), ue = P && /* @__PURE__ */ dt(qa, {
		...y,
		...M,
		size: y?.size || M.size,
		key: "error",
		...
		switch (e) {
			case "label": return se;
			case "input": return le;
			case "description": return ce;
...
var no = {
	...
	let r = S("Input", no, e), { classNames: i, className: a, style: o, styles: s, unstyled: c, required: l, __staticSelector: u, __stylesApiProps: d, size: f, wrapperProps: p, error: m, disabled: h, leftSection: g, leftSectionProps: v, leftSectionWidth: y, rightSection: x, rightSectionProps: C, rightSectionWidth: w, rightSectionPointerEvents: T, leftSectionPointerEvents: E, variant: D, vars: O, pointer: k, multiline: A, radius: j, id: M, withAria: ee, withErrorStyles: te, mod: ne, inputSize: N, attributes: re, __clearSection: P, __clearable: ie, __clearSectionMode: ae, __defaultRightSection: oe, loading: F, loadingPosition: se, __bottomSection: ce, __bottomSectionProps: le, rootRef: ue, dir: de, ...fe } = r, { styleProps: pe, rest: me } = n(fe), he = ft(Ha), I = {
		offsetBottom: he?.offsetBottom,
		offsetTop: he?.offsetTop
	}, L = b({
		name: ["Input", u],
		props: d || r,
		classes: Ua,
		...
		id: he?.inputId || M
	} : {}, _e = F ? /* @__PURE__ */ G(t, { size: se === "left" ? "calc(var(--input-left-section-size) / 2)" : "calc(var(--input-right-section-size) / 2)" }) : null, ve = F && se === "left" ? _e : g, ye = Va({
		__clearable: ie,
		__clearSection: P,
		rightSection: F && se === "right" ? _e : x,
...
var yo = d((e) => {
	let { autosize: t, maxRows: n, minRows: r, __staticSelector: i, resize: a, bottomSection: o, bottomSectionProps: s, ...c } = S([
		"Input",
		"InputWrapper",
		"Textarea"
...
var [bo, xo] = ie("Menu component was not found in the tree"), So = ut(null);
//#endregion
...
function Co(e) {
	let { value: t, defaultValue: n, onChange: r, children: i } = S("MenuCheckboxGroup", null, e), [a, o] = Nn({
		value: t,
		defaultValue: n,
		finalValue: [],
		onChange: r
...
function To({ role: e, checked: t, indicator: n, onSelect: r, color: i, closeMenuOnClick: a, rightSection: o, children: s, disabled: c, dataDisabled: l, className: u, style: d, styles: p, classNames: h, buttonRef: g, others: _ }) {
	let y = xo(), b = ft(wo), x = f(), { dir: S } = Kn(), C = H(null), w = q(_.onClick, () => {
		l || (r(), a && y.closeDropdownImmediately());
	}), T = q(_.onMouseMove, () => {
...
var Eo = {
	...
	let { classNames: t, className: n, style: r, styles: i, vars: a, color: o, closeMenuOnClick: s, rightSection: c, children: l, disabled: u, "data-disabled": d, value: f, checked: p, defaultChecked: m, onChange: h, checkIcon: g, ref: _, ...v } = S("MenuCheckboxItem", null, e), y = xo(), b = ft(So), x = b && f !== void 0 ? b.values.includes(f) : void 0, [C, w] = Nn({
		value: p ?? x,
		defaultValue: m,
		finalValue: !1,
		onChange: h
	...
	return /* @__PURE__ */ G(To, {
		...
		onSelect: () => {
			h ? w(!C) : b && f !== void 0 ? b.onChange(f) : w(!C);
		},
		color: o,
		closeMenuOnClick: s,
		rightSection: c,
...
function Oo(e) {
	let { children: t, disabled: n, longPressDelay: r } = S("MenuContextMenu", null, e), i = Hn(t);
...
var ko = d((e) => {
	let { classNames: t, className: n, style: r, styles: i, vars: a, ...o } = S("MenuDivider", null, e);
	return /* @__PURE__ */ G(_, {
...
var Po = d((e) => {
	let { classNames: t, className: n, style: r, styles: i, vars: a, onMouseEnter: o, onMouseLeave: s, onKeyDown: c, children: l, ref: u, ...d } = S("MenuDropdown", null, e), f = H(null), p = xo(), m = No({
		enabled: !p.hasSearch,
		opened: p.opened,
...
var Fo = s((e) => {
	let { classNames: t, className: n, style: r, styles: i, vars: a, color: o, closeMenuOnClick: s, leftSection: c, rightSection: l, children: u, disabled: d, "data-disabled": p, ref: h, ...g } = S("MenuItem", null, e), _ = xo(), y = ft(wo), b = f(), { dir: x } = Kn(), C = H(null), w = g, T = q(w.onClick, () => {
		p || (typeof s == "boolean" ? s && _.closeDropdownImmediately() : _.closeOnItemClick && _.closeDropdownImmediately());
	}), E = q(w.onMouseMove, () => {
...
var Io = d((e) => {
	let { classNames: t, className: n, style: r, styles: i, vars: a, ...o } = S("MenuLabel", null, e);
	return /* @__PURE__ */ G(_, {
		...xo().getStyles("label", {
			className: n,
			style: r,
...
function Ro(e) {
	let { value: t, defaultValue: n, onChange: r, children: i } = S("MenuRadioGroup", null, e), [a, o] = Nn({
		value: t,
		defaultValue: n,
		finalValue: null,
		onChange: r
...
var Bo = d((e) => {
	let { classNames: t, className: n, style: r, styles: i, vars: a, color: o, closeMenuOnClick: s, rightSection: c, children: l, disabled: u, "data-disabled": d, value: f, checked: p, onChange: m, checkIcon: h, ref: g, ..._ } = S("MenuRadioItem", null, e), v = xo(), y = ft(Lo), b = p ?? (y ? y.value === f : !1);
	return /* @__PURE__ */ G(To, {
		role: "menuitemradio",
		checked: b,
...
var Jo = { clearSearchOnClose: !0 }, Yo = d((e) => {
	let { classNames: t, styles: n, onKeyDown: r, onChange: i, size: a, clearSearchOnClose: o, ref: s, ...c } = S("MenuSearch", Jo, e), l = xo(), u = H(null), d = Mn(s, u), f = H(i);
...
var Xo = d((e) => {
	let { classNames: t, className: n, style: r, styles: i, vars: a, onMouseEnter: o, onMouseLeave: s, onPointerEnter: c, onPointerLeave: l, onKeyDown: u, children: d, ref: f, ...p } = S("MenuSubDropdown", null, e), m = H(null), h = xo(), g = ft(wo), _ = No({
		enabled: !h.hasSearch,
		opened: g?.opened ?? !1,
...
var Zo = s((e) => {
	let { classNames: t, className: n, style: r, styles: i, vars: a, color: o, leftSection: s, rightSection: c, children: l, disabled: u, "data-disabled": d, closeMenuOnClick: p, ref: h, ...g } = S("MenuSubItem", null, e), _ = xo(), y = ft(wo), b = f(), { dir: x } = Kn(), C = H(null), w = g, T = o ? b.variantColorResolver({
		color: o,
		theme: b,
		variant: "light"
	}) : void 0, E = o ? v({
		...
		!d && p && _.closeDropdownImmediately();
	}), k = q(w.onMouseMove, () => {
		if (!_.hasSearch) return;
		let e = C.current?.closest("[data-menu-dropdown]");
		e && e.querySelectorAll("[data-menu-active]").forEach((t) => {
...
function es(e) {
	let { children: t, closeDelay: n, openDelay: r, position: i, safeAreaPolygon: a, opened: o, onChange: s, ...c } = S("MenuSub", $o, e), l = kn(), [u, d] = Nn({
		value: o,
		finalValue: !1,
		onChange: s
	...
	let { context: C, refs: w } = Fi({
		placement: h,
		open: u,
		onOpenChange: (e) => {
			e ? b() : x();
		}
	}), { getReferenceProps: T, getFloatingProps: E } = zi([Si(C, {
...
var ts = { refProp: "ref" };
function ns(e) {
	let { children: t, refProp: n, ...r } = S("MenuTarget", ts, e), i = Hn(t);
...
var rs = {
	...
	let t = S("Menu", rs, e), { children: n, onOpen: r, onClose: i, opened: a, defaultOpened: o, trapFocus: s, onChange: c, closeOnItemClick: l, loop: u, closeOnEscape: d, trigger: f, openDelay: p, closeDelay: m, classNames: h, styles: g, unstyled: _, variant: v, vars: y, menuItemTabIndex: x, keepMounted: C, withInitialFocusPlaceholder: w, attributes: T, onExitTransitionEnd: E, alignItemsLabels: D, checkIcon: O, ...k } = t, A = b({
		name: "Menu",
		classes: Eo,
		props: t,
		classNames: h,
		...
		j ? ne() : N();
	}, { openDropdown: P, closeDropdown: ie } = oa({
		open: N,
		close: ne,
		closeDelay: m,
		openDelay: p
		...
		let t = ae.current;
		return t && t !== e && t(), ae.current = e, () => {
			ae.current === e && (ae.current = null);
		};
	}, []), F = H(0), [se, ce] = U(!1), le = B(() => (F.current += 1, F.current === 1 && ce(!0), () => {
		--F.current, F.current === 0 && ce(!1);
	}), []), ue = H(null), de = () => {
		ue.current?.(), E?.();
	}, fe = (e) => pn("[data-menu-item]", "[data-menu-dropdown]", e), { resolvedClassNames: pe, resolvedStyles: me } = Un({
		classNames: h,
		styles: g,
		props: t
	});
	return /* @__PURE__ */ G(bo, {
		value: {
			...
			getItemIndex: fe,
			openedViaClick: ee,
			setOpenedViaClick: te,
			closeOnItemClick: l,
			closeDropdown: f === "click" ? ne : ie,
			openDropdown: f === "click" ? N : P,
			closeDropdownImmediately: ne,
			loop: u,
			trigger: f,
			unstyled: _,
			menuItemTabIndex: x,
...
var as = {
	...
	position: "right",
	zIndex: dn("popover")
}, ss = F((e, { radius: t, color: n }) => ({ tooltip: {
	"--tooltip-radius": t === void 0 ? void 0 : ue(t),
	"--tooltip-bg": n ? T(n, e) : void 0,
	"--tooltip-color": n ? "var(--mantine-color-white)" : void 0
} })), cs = d((e) => {
	let t = S("TooltipFloating", os, e), { children: n, refProp: r, withinPortal: i, style: a, className: o, classNames: s, styles: c, unstyled: l, radius: u, color: d, label: p, offset: m, position: h, multiline: g, zIndex: v, disabled: y, defaultOpened: x, variant: C, vars: w, portalProps: T, attributes: E, ref: D, ...O } = t, k = f(), A = b({
		...
		vars: w,
		varsResolver: ss
	}), { handleMouseMove: j, x: M, y: ee, opened: te, boundaryRef: ne, floating: N, setOpened: re } = is({
		offset: m,
		position: h,
		defaultOpened: x
	}), P = Hn(n);
	if (!P) throw Error("[@mantine/core] Tooltip.Floating component children should be an element or a component that accepts ref, fragments, strings, numbers and other primitive values are not supported");
	let ie = Mn(ne, Vn(P), D), ae = P.props, oe = (e) => {
		ae.onMouseEnter?.(e), j(e), re(!0);
	}, F = (e) => {
		ae.onMouseLeave?.(e), re(!1);
	};
	return /* @__PURE__ */ K(W, { children: [/* @__PURE__ */ G(ha, {
		...
		children: /* @__PURE__ */ G(_, {
			...
			...A("tooltip", { style: {
				...Wn(a, k),
				zIndex: v,
				display: !y && te ? "block" : "none",
				top: (ee && Math.round(ee)) ?? "",
				left: (M && Math.round(M)) ?? ""
			} }),
			variant: C,
			ref: N,
...
function ds(e) {
	let { openDelay: t, closeDelay: n, children: r } = S("TooltipGroup", us, e);
...
var hs = {
...
}, gs = F((e, { radius: t, color: n, variant: r, autoContrast: i }) => {
	...
	let t = S("Tooltip", hs, e), { children: n, position: r, refProp: i, label: a, openDelay: o, closeDelay: s, onPositionChange: c, opened: l, defaultOpened: u, withinPortal: d, radius: f, color: p, classNames: m, styles: h, unstyled: g, style: v, className: y, withArrow: x, arrowSize: C, arrowOffset: w, arrowRadius: T, arrowPosition: E, offset: D, transitionProps: O, multiline: k, events: A, zIndex: j, disabled: M, onClick: ee, onMouseEnter: ne, onMouseLeave: N, inline: re, variant: P, keepMounted: ie, vars: oe, portalProps: F, mod: se, floatingStrategy: ce, middlewares: le, autoContrast: ue, attributes: de, target: fe, ref: pe, ...me } = t, { dir: he } = Kn(), I = H(null), L = ms({
		position: aa(he, r),
		closeDelay: s,
		openDelay: o,
		onPositionChange: c,
		...
		arrowRef: I,
		arrowOffset: w,
		offset: typeof D == "number" ? D + (x ? C / 2 : 0) : D,
		inline: re,
		strategy: ce,
		middlewares: le
	});
	V(() => {
		let e = fe instanceof HTMLElement ? fe : typeof fe == "string" ? document.querySelector(fe) : fe?.current || null;
		e && L.reference(e);
	}, [fe, L]);
	let ge = b({
		name: "Tooltip",
	...
	if (!fe && !_e) throw Error("[@mantine/core] Tooltip component children should be an element or a component that accepts ref, fragments, strings, numbers and other primitive values are not supported");
	let ve = ge("tooltip"), ye = E === "merge" && x ? ra({
	...
	if (fe) {
		...
		return /* @__PURE__ */ G(W, { children: /* @__PURE__ */ G(ha, {
			...
			children: /* @__PURE__ */ G(te, {
				...
				keepMounted: ie,
				mounted: !M && !!L.opened,
				duration: L.isGroupPhase ? 10 : e.duration,
				children: (e) => /* @__PURE__ */ K(_, {
					...me,
					"data-fixed": ce === "fixed" || void 0,
					variant: P,
					mod: [{ multiline: k }, se],
					...ve,
					...L.getFloatingProps({
	...
	let be = _e.props, xe = Mn(L.reference, Vn(_e), pe), Se = _a(O, {
		duration: 100,
		transition: "fade"
	});
	return /* @__PURE__ */ K(W, { children: [/* @__PURE__ */ G(ha, {
		...
		children: /* @__PURE__ */ G(te, {
			...
			keepMounted: ie,
			mounted: !M && !!L.opened,
			duration: L.isGroupPhase ? 10 : Se.duration,
			children: (e) => /* @__PURE__ */ K(_, {
				...me,
				"data-fixed": ce === "fixed" || void 0,
				variant: P,
				...
				...L.getFloatingProps({
					ref: L.floating,
					className: ge("tooltip").className,
					style: {
						...ge("tooltip").style,
						...e,
						...ye,
...
var _s = y("outline", "adjustments-horizontal", "AdjustmentsHorizontal", [
...
]), bs = y("outline", "align-justified", "AlignJustified", [
	["path", {
		d: "M4 6l16 0",
		key: "svg-0"
	}],
...
]), xs = y("outline", "align-left", "AlignLeft", [
	["path", {
		d: "M4 6l16 0",
		key: "svg-0"
	}],
...
]), Ss = y("outline", "align-right", "AlignRight", [
	["path", {
		d: "M4 6l16 0",
		key: "svg-0"
	}],
...
]), ws = y("outline", "arrow-down", "ArrowDown", [
	["path", {
		d: "M12 5l0 14",
		key: "svg-0"
	}],
...
]), Ts = y("outline", "arrow-left", "ArrowLeft", [
	["path", {
		d: "M5 12l14 0",
		key: "svg-0"
	}],
...
]), Es = y("outline", "arrow-right", "ArrowRight", [
	["path", {
		d: "M5 12l14 0",
		key: "svg-0"
	}],
...
]), Os = y("outline", "arrows-horizontal", "ArrowsHorizontal", [
	["path", {
		d: "M7 8l-4 4l4 4",
		key: "svg-0"
	}],
...
]), ks = y("outline", "arrows-minimize", "ArrowsMinimize", [
	["path", {
		d: "M5 9l4 0l0 -4",
		key: "svg-0"
	}],
...
]), As = y("outline", "arrows-shuffle", "ArrowsShuffle", [
	["path", {
		d: "M18 4l3 3l-3 3",
		key: "svg-0"
	}],
...
]), js = y("outline", "aspect-ratio", "AspectRatio", [
	["path", {
...
]), Ms = y("outline", "blockquote", "Blockquote", [
	["path", {
		d: "M6 15h15",
		key: "svg-0"
	}],
...
]), Z = y("outline", "check", "Check", [["path", {
	d: "M5 12l5 5l10 -10",
	key: "svg-0"
}]]), Ns = y("outline", "checkbox", "Checkbox", [["path", {
	d: "M9 11l3 3l8 -8",
	key: "svg-0"
}], ["path", {
	d: "M20 12v6a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2v-12a2 2 0 0 1 2 -2h9",
	key: "svg-1"
}]]), Ps = y("outline", "chevron-down", "ChevronDown", [["path", {
	d: "M6 9l6 6l6 -6",
	key: "svg-0"
}]]), Fs = y("outline", "clipboard", "Clipboard", [["path", {
	d: "M9 5h-2a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-12a2 2 0 0 0 -2 -2h-2",
	key: "svg-0"
}], ["path", {
	d: "M9 5a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2a2 2 0 0 1 -2 2h-2a2 2 0 0 1 -2 -2",
	key: "svg-1"
}]]), Is = y("outline", "clock", "Clock", [["path", {
	d: "M3 12a9 9 0 1 0 18 0a9 9 0 0 0 -18 0",
	key: "svg-0"
}], ["path", {
	d: "M12 7v5l3 3",
	key: "svg-1"
}]]), Ls = y("outline", "code", "Code", [
	["path", {
		d: "M7 8l-4 4l4 4",
		key: "svg-0"
	}],
...
]), Rs = y("outline", "columns-3", "Columns3", [
	["path", {
...
]), Hs = y("outline", "download", "Download", [
	["path", {
...
]), Us = y("outline", "external-link", "ExternalLink", [
	["path", {
...
]), Ws = y("outline", "file-type-pdf", "FileTypePdf", [
	["path", {
...
]), Js = y("outline", "info-circle", "InfoCircle", [
	["path", {
		d: "M3 12a9 9 0 1 0 18 0a9 9 0 0 0 -18 0",
		key: "svg-0"
	}],
...
]), Ys = y("outline", "layout-align-center", "LayoutAlignCenter", [
	["path", {
		d: "M12 4l0 5",
		key: "svg-0"
	}],
...
]), tc = y("outline", "list-details", "ListDetails", [
	["path", {
		d: "M13 5h8",
		key: "svg-0"
	}],
...
]), nc = y("outline", "list-numbers", "ListNumbers", [
	["path", {
		d: "M11 6h9",
		key: "svg-0"
	}],
...
]), ic = y("outline", "player-skip-forward", "PlayerSkipForward", [["path", {
	d: "M4 5v14l12 -7l-12 -7",
	key: "svg-0"
}], ["path", {
	d: "M20 5l0 14",
	key: "svg-1"
}]]), ac = y("outline", "plus", "Plus", [["path", {
	d: "M12 5l0 14",
	key: "svg-0"
}], ["path", {
	d: "M5 12l14 0",
	key: "svg-1"
}]]), oc = y("outline", "quote", "Quote", [["path", {
	...
	key: "svg-1"
}]]), sc = y("outline", "refresh", "Refresh", [["path", {
	d: "M20 11a8.1 8.1 0 0 0 -15.5 -2m-.5 -4v4h4",
	key: "svg-0"
}], ["path", {
	d: "M4 13a8.1 8.1 0 0 0 15.5 2m.5 4v-4h-4",
	key: "svg-1"
}]]), cc = y("outline", "repeat", "Repeat", [["path", {
	d: "M4 12v-3a3 3 0 0 1 3 -3h13m-3 -3l3 3l-3 3",
	key: "svg-0"
}], ["path", {
	d: "M20 12v3a3 3 0 0 1 -3 3h-13m3 3l-3 -3l3 -3",
	key: "svg-1"
}]]), lc = y("outline", "spacing-horizontal", "SpacingHorizontal", [
	["path", {
...
]), dc = y("outline", "switch-horizontal", "SwitchHorizontal", [
	["path", {
		d: "M16 3l4 4l-4 4",
		key: "svg-0"
	}],
	...
	key: "svg-1"
}]]), pc = y("outline", "text-wrap", "TextWrap", [
	["path", {
		d: "M4 6l16 0",
		key: "svg-0"
	}],
...
]), gc = y("outline", "typography", "Typography", [
	["path", {
		d: "M4 20l3 0",
		key: "svg-0"
	}],
...
]), _c = y("filled", "caret-right-filled", "CaretRightFilled", [["path", {
	d: "M9 6c0 -.852 .986 -1.297 1.623 -.783l.084 .076l6 6a1 1 0 0 1 .083 1.32l-.083 .094l-6 6l-.094 .083l-.077 .054l-.096 .054l-.036 .017l-.067 .027l-.108 .032l-.053 .01l-.06 .01l-.057 .004l-.059 .002l-.059 -.002l-.058 -.005l-.06 -.009l-.052 -.01l-.108 -.032l-.067 -.027l-.132 -.07l-.09 -.065l-.081 -.073l-.083 -.094l-.054 -.077l-.054 -.096l-.017 -.036l-.027 -.067l-.032 -.108l-.01 -.053l-.01 -.06l-.004 -.057l-.002 -12.059z",
	key: "svg-0"
}]]);
//#endregion
//#region src/features/editor/portfolio/portfolio-editor-mode.ts
l();
var vc = re();
function yc(e) {
	if (!e || e.isDestroyed) return !1;
	let t = e.options?.editorProps?.attributes;
	if (t && typeof t != "function") {
		let e = t.class;
		if (typeof e == "string" && e.split(/\s+/).includes("ramzy-portfolio-editor")) return !0;
	}
	if (!(0, vc.isEditorReady)(e)) return !1;
	try {
...
function bc(e) {
	if (!(0, vc.isEditorReady)(e) || e.isDestroyed) return null;
	try {
		let t = e.view.dom;
...
var Sc = { timeout: 1e3 };
function Cc(e) {
	let { children: t, timeout: n, value: r, ...i } = S("CopyButton", Sc, e), a = xc({ timeout: n });
...
Cc.displayName = "@mantine/core/CopyButton";
//#endregion
...
var Tc = class {
	constructor({ editor: e, element: t, view: n, pluginKey: r = "bubbleMenu", updateDelay: i = 250, resizeDelay: a = 60, shouldShow: o, appendTo: s, getReferencedVirtualElement: c, options: l }) {
		this.preventHide = !1, this.isVisible = !1, this.scrollTarget = window, this.floatingUIOptions = {
			...
			let { doc: i, selection: a } = t, { empty: o } = a, s = !i.textBetween(n, r).length && fe(t.selection), c = this.element.contains(document.activeElement);
	...
	get virtualElement() {
		...
		let n = ne(this.view, e.from, e.to), i = {
		...
		if (e instanceof pe) {
			...
			if (!o || !s) return;
			let c = o === s ? o.getBoundingClientRect() : wc(o.getBoundingClientRect(), s.getBoundingClientRect());
			i = {
	...
	key: typeof e.pluginKey == "string" ? new u(e.pluginKey) : e.pluginKey,
	view: (t) => new Tc({
		view: t,
		...e
	})
...
w.create({
	...
	addProseMirrorPlugins() {
		return this.options.element ? [Ec({
...
var Dc = class {
	...
	getTextContent(e) {
		return ee(e, { textSerializers: E(this.editor.schema) });
	}
	get middlewares() {
		let e = [];
		return this.floatingUIOptions.flip && e.push(Zt(typeof this.floatingUIOptions.flip == "boolean" ? void 0 : this.floatingUIOptions.flip)), this.floatingUIOptions.shift && e.push(Xt(typeof this.floatingUIOptions.shift == "boolean" ? void 0 : this.floatingUIOptions.shift)), this.floatingUIOptions.offset && e.push(Jt(typeof this.floatingUIOptions.offset == "boolean" ? void 0 : this.floatingUIOptions.offset)), this.floatingUIOptions.arrow && e.push(en(this.floatingUIOptions.arrow)), this.floatingUIOptions.size && e.push(Qt(typeof this.floatingUIOptions.size == "boolean" ? void 0 : this.floatingUIOptions.size)), this.floatingUIOptions.autoPlacement && e.push(Yt(typeof this.floatingUIOptions.autoPlacement == "boolean" ? void 0 : this.floatingUIOptions.autoPlacement)), this.floatingUIOptions.hide && e.push($t(typeof this.floatingUIOptions.hide == "boolean" ? void 0 : this.floatingUIOptions.hide)), this.floatingUIOptions.inline && e.push(tn(typeof this.floatingUIOptions.inline == "boolean" ? void 0 : this.floatingUIOptions.inline)), e;
	...
	updatePosition() {
		if (!this.view?.dom?.parentNode) return;
		let { selection: e } = this.editor.state, t = ne(this.view, e.from, e.to);
		nn({
...
w.create({
	...
	addProseMirrorPlugins() {
		return this.options.element ? [Oc({
			pluginKey: this.options.pluginKey,
			editor: this.editor,
			element: this.options.element,
			updateDelay: this.options.updateDelay,
...
var Ac = typeof window < "u" ? ht : V, jc = /* @__PURE__ */ new Set([
	"left",
	"opacity",
	"position",
	"top",
	"visibility",
	"width"
]), Mc = /* @__PURE__ */ new Set(/* @__PURE__ */ "animationIterationCount.aspectRatio.borderImageOutset.borderImageSlice.borderImageWidth.columnCount.columns.fillOpacity.flex.flexGrow.flexShrink.fontWeight.gridArea.gridColumn.gridColumnEnd.gridColumnStart.gridRow.gridRowEnd.gridRowStart.lineClamp.lineHeight.opacity.order.orphans.scale.stopOpacity.strokeDasharray.strokeDashoffset.strokeMiterlimit.strokeOpacity.strokeWidth.tabSize.widows.zIndex.zoom".split(".")), Nc = /* @__PURE__ */ new Set([
	"children",
	"className",
	"style"
]), Pc = /* @__PURE__ */ new Set(["tabIndex"]), Fc = /* @__PURE__ */ new Set([
	"accessKey",
	"autoCapitalize",
	"contentEditable",
	"contextMenu",
...
function zc(e) {
	return e.startsWith("aria-") || e.startsWith("data-") || Fc.has(e);
}
function Bc(e) {
...
function Kc(e, t) {
	return typeof t != "number" || t === 0 || e.startsWith("--") || Mc.has(e) ? String(t) : `${t}px`;
}
function qc(e, t) {
	jc.has(t) || e.style.removeProperty(Bc(t));
}
function Jc(e, t, n) {
	jc.has(t) || e.style.setProperty(Bc(t), Kc(t, n));
}
function Yc(e, t, n) {
	(/* @__PURE__ */ new Set([...Object.keys(t), ...Object.keys(n)])).forEach((r) => {
		if (Nc.has(r) || !zc(r) || Lc(r, t[r]) || Lc(r, n[r])) return;
		let i = t[r], a = n[r];
		if (i === a) return;
		let o = Rc(r);
		if (a == null || a === !1) {
			Uc(r) && Gc(e, r), e.removeAttribute(o);
			return;
		}
		if (a === !0) {
			Uc(r) && Wc(e, r, !0), e.setAttribute(o, "");
			return;
		}
		if (Uc(r)) {
			Wc(e, r, a);
...
function Qc(e, t, n) {
	...
	return Object.entries(n).forEach(([t, n]) => {
		if (!Lc(t, n)) return;
		let { eventName: i, options: a } = Vc(t), o = (t) => {
			n(Hc(e, t));
		};
...
function $c(e, t) {
	...
	Ac(() => {
		let i = n.current;
		return Xc(e, i.className, t.className), Zc(e, i.style, t.style), Yc(e, i, t), r.current = Qc(e, r.current, t), n.current = t, () => {
...
var el = ot.forwardRef(({ pluginKey: e, editor: t, updateDelay: n, resizeDelay: r, appendTo: i, shouldShow: o = null, getReferencedVirtualElement: s, options: c, children: l, ...u }, d) => {
	let f = H(document.createElement("div")), p = H(kc(e, "bubbleMenu")).current;
	$c(f.current, u), typeof d == "function" ? d(f.current) : d && (d.current = f.current);
	let { editor: m } = a(), h = t || m, g = {
		updateDelay: n,
		resizeDelay: r,
		appendTo: i,
		pluginKey: p,
...
ot.forwardRef(({ pluginKey: e, editor: t, updateDelay: n, resizeDelay: r, appendTo: i, shouldShow: o = null, options: s, children: c, ...l }, u) => {
	let d = H(document.createElement("div")), f = H(kc(e, "floatingMenu")).current;
	$c(d.current, l), typeof u == "function" ? u(d.current) : u && (u.current = d.current);
	let { editor: p } = a(), m = t || p, h = {
		updateDelay: n,
		resizeDelay: r,
		appendTo: i,
		pluginKey: f,
...
var tl = {
...
}, nl = ({ editor: e, isOpen: t, setIsOpen: n }) => {
	let { t: r } = it(), i = g({
		editor: e,
		selector: (t) => e ? {
		...
		},
		{
			...
			isActive: () => i?.isTransclusionSource
		},
		{
			name: "Code",
			icon: Ls,
		...
		},
		{
			...
			isActive: () => i?.isCallout
		},
		{
			name: "Toggle block",
			icon: _c,
			command: () => e.chain().focus().setDetails().run(),
			isActive: () => i?.isDetails
		}
	], s = a.filter((e) => e.isActive()).pop() ?? { name: "Multiple" };
	return /* @__PURE__ */ K(J, {
		opened: t,
		onChange: n,
		withArrow: !0,
		children: [/* @__PURE__ */ G(J.Target, { children: /* @__PURE__ */ G(X, {
			...
			children: /* @__PURE__ */ G(o, {
				...
				radius: "0",
				rightSection: /* @__PURE__ */ G(Ps, { size: 16 }),
				onClick: () => n(!t),
			...
			type: "scroll",
			mah: 400,
			children: /* @__PURE__ */ G(o.Group, {
				orientation: "vertical",
				children: a.map((t, i) => /* @__PURE__ */ G(o, {
					variant: "default",
					...
					fullWidth: !0,
					onClick: () => {
						(0, vc.isEditorReady)(e) && t.command(), n(!1);
					},
					style: { border: "none" },
					children: r(t.name)
				}, i))
...
}, rl = ({ editor: e, isOpen: t, setIsOpen: n }) => {
	let { t: r } = it(), i = g({
		editor: e,
		selector: (e) => e.editor ? {
	...
	return /* @__PURE__ */ K(Y, {
		...
		}) }), /* @__PURE__ */ G(Y.Dropdown, { children: a.map((t, i) => /* @__PURE__ */ G(Y.Item, {
			leftSection: /* @__PURE__ */ G(t.icon, { size: 16 }),
	...
	toolbar: "_toolbar_1gvib_1",
	active: "_active_1gvib_20",
	divider: "_divider_1gvib_35"
};
//#endregion
...
function cl(e) {
	let t = pl(e)?.node.type.name;
	return t ? sl.has(t) ? "custom" : ol.includes(t) ? t : "generic" : null;
}
var ll = new Set([
	"blockquote",
	"bulletList",
...
function dl(e) {
	return (e.extensionManager?.extensions?.find((e) => e.name === "codeBlock")?.options)?.lowlight?.listLanguages?.() ?? ul;
}
var fl = {
	attachment: "File",
	audio: "Audio",
...
function pl(e) {
	let { selection: t, doc: n } = e.state, r = 0;
	for (let e = t.$from.depth; e > 0; e--) if (t.$from.node(e).type.name === "column") {
		r = e;
		break;
	}
	let i = t.$from.depth > r ? t.$from.before(r + 1) : t.from, a = n.nodeAt(i);
	return a ? {
		position: i,
		node: a,
		isSectionHeading: r === 0 && a.type.name === "heading" && a.attrs.level === 1
	} : null;
}
function ml(e) {
	let t = [];
...
function hl(e) {
	let t = pl(e);
	if (!t) return !1;
	let n = t.isSectionHeading ? ml(e).find((e) => e.position === t.position) : null, r = e.state.tr.delete(t.position, n?.end ?? t.position + t.node.nodeSize);
	return r.doc.childCount === 0 && r.insert(0, e.schema.nodes.paragraph.create()), e.view.dispatch(r), e.commands.focus(), !0;
}
function gl(e) {
	let t = pl(e);
	if (!t) return null;
	let n = t.isSectionHeading ? ml(e).find((e) => e.position === t.position) : null;
	return {
		...t,
...
function _l(t) {
	if (t.isText) return t.type.schema.text(t.text || "", t.marks);
	let n = { ...t.attrs };
	Object.prototype.hasOwnProperty.call(n, "id") && (n.id = null);
	let r = [];
	return t.content.forEach((e) => r.push(_l(e))), t.type.create(n, r.length ? e.fromArray(r) : void 0, t.marks);
}
function vl(t) {
	let n = gl(t);
	if (!n) return !1;
	let r = [];
	return t.state.doc.slice(n.position, n.end).content.forEach((e) => {
		r.push(_l(e));
	}), r.length ? (t.view.dispatch(t.state.tr.insert(n.end, e.fromArray(r)).scrollIntoView()), t.commands.focus(), !0) : !1;
}
function yl(e, t) {
	let n = gl(e);
	if (!n) return !1;
	let r = [], i = e.state.doc.resolve(n.position);
	if (i.parent.forEach((e, t) => r.push({
		node: e,
		position: i.start() + t
	})), n.isSectionHeading) {
		let r = ml(e), i = r[r.findIndex((e) => e.position === n.position) + (t === "up" ? -1 : 1)];
		if (!i) return !1;
	...
	let a = r[r.findIndex((e) => e.position === n.position) + (t === "up" ? -1 : 1)];
	if (!a) return !1;
	let o = e.state.doc.slice(n.position, n.end).content, s = e.state.tr.delete(n.position, n.end), c = t === "up" ? a.position : n.position + a.node.nodeSize;
	return s.insert(c, o), e.view.dispatch(s.scrollIntoView()), e.commands.setNodeSelection(c), e.commands.focus(), !0;
}
function bl(e, t) {
	let n = gl(e);
...
function Sl(e, t) {
	...
	let r = n.node.nodeSize, i = e.state.tr.delete(n.position, n.position + r), a = i.mapping.map(t.end);
	return i.insert(a, n.node), e.view.dispatch(i.scrollIntoView()), e.commands.focus(), !0;
}
function Cl(e, t) {
	let n = pl(e);
...
function wl(e) {
	return e.type.name === "heading" && typeof e.attrs.level == "number" ? `Heading ${e.attrs.level}` : e.type.name === "mediaPlaylist" ? e.attrs.kind === "audio" ? "Audio playlist" : "Video playlist" : fl[e.type.name] || "Element";
}
function Q(e, t) {
	let n = pl(e);
	if (!n) return !1;
...
function El({ editor: e }) {
	let { t } = it(), [n, r] = U(!1), [i, a] = U("root"), o = g({
		editor: e,
		selector: ({ editor: e }) => {
			let t = pl(e), n = t ? e.state.doc.resolve(t.position) : null;
			return t ? {
				position: t.position,
				isSectionHeading: t.isSectionHeading,
				sections: ml(e),
				canMoveUp: t.position > n.start(),
				canMoveDown: (t.isSectionHeading ? ml(e).find((e) => e.position === t.position)?.end : t.position + t.node.nodeSize) !== n.end()
			} : null;
		}
	});
	if (!al(e) || !o) return null;
	function s() {
		r(!1), a("root");
	}
	function c() {
	...
	return /* @__PURE__ */ K(Y, {
		...
		children: [/* @__PURE__ */ G(Y.Target, { children: /* @__PURE__ */ G(X, {
			...
			children: /* @__PURE__ */ G(N, {
				...
				onMouseDown: (e) => e.preventDefault(),
				children: /* @__PURE__ */ G(Vs, { size: 18 })
			})
		}) }), /* @__PURE__ */ G(Y.Dropdown, {
			"data-ramzy-block-menu": !0,
			children: i === "root" ? /* @__PURE__ */ K(W, { children: [
				/* @__PURE__ */ G(Y.Item, {
					leftSection: /* @__PURE__ */ G(zs, { size: 16 }),
					onClick: () => l(() => vl(e)),
					children: t("Duplicate")
				}),
				/* @__PURE__ */ G(Y.Item, {
					leftSection: /* @__PURE__ */ G(Fs, { size: 16 }),
					onClick: () => l(() => bl(e, !1)),
					children: t("Copy")
				}),
				/* @__PURE__ */ G(Y.Item, {
					leftSection: /* @__PURE__ */ G(Bs, { size: 16 }),
					onClick: () => l(() => bl(e, !0)),
					children: t("Cut")
				}),
				/* @__PURE__ */ G(Y.Divider, {}),
				/* @__PURE__ */ G(Y.Item, {
					leftSection: /* @__PURE__ */ G(Ds, { size: 16 }),
				...
				!o.isSectionHeading && /* @__PURE__ */ G(Y.Item, {
					leftSection: /* @__PURE__ */ G(Es, { size: 16 }),
				...
				/* @__PURE__ */ G(Y.Item, {
					leftSection: /* @__PURE__ */ G(ec, { size: 16 }),
					onClick: () => l(() => xl(e)),
				...
				/* @__PURE__ */ G(Y.Item, {
					color: "red",
					leftSection: /* @__PURE__ */ G(hc, { size: 16 }),
					onClick: c,
					children: t("Delete")
				})
				...
				/* @__PURE__ */ G(Y.Divider, {}),
				/* @__PURE__ */ G(Y.Item, {
					leftSection: /* @__PURE__ */ G(ac, { size: 16 }),
					onClick: d,
...
function Dl({ editor: e }) {
	let [t, n] = U(!1), [i, a] = U(!1), o = B(({ state: t }) => !al(e) || !e.isEditable || !t.selection.empty && !(t.selection instanceof r) ? !1 : cl(e) === "generic", [e]), s = B(() => {
		let t = pl(e);
		if (!t) return;
		...
		selector: ({ editor: e }) => {
			...
			return t ? {
				...
				label: wl(t.node),
				supportsTextTools: ll.has(t.node.type.name),
				isSectionHeading: t.isSectionHeading,
	...
	return /* @__PURE__ */ G(el, {
		...
		children: /* @__PURE__ */ K("div", {
			...
			children: [
				c?.supportsTextTools && /* @__PURE__ */ K(W, { children: [/* @__PURE__ */ G(nl, {
					editor: e,
					isOpen: t,
					setIsOpen: (e) => {
				...
				c?.isSectionHeading && /* @__PURE__ */ G(X, {
					...
					children: /* @__PURE__ */ G(N, {
						...
						children: /* @__PURE__ */ G(fc, { size: 18 })
					})
				}),
				c?.name === "details" && /* @__PURE__ */ G(X, {
					label: c.open ? "Open by default" : "Closed by default",
					position: "top",
					withinPortal: !1,
					children: /* @__PURE__ */ G(N, {
						size: "lg",
						variant: "subtle",
						"aria-label": c.open ? "Open by default" : "Closed by default",
						className: c.open ? il.active : void 0,
						onMouseDown: (e) => e.preventDefault(),
						onClick: () => Q(e, { open: !c.open }),
						children: /* @__PURE__ */ G(mc, { size: 18 })
					})
				}),
				c?.name === "mathBlock" && /* @__PURE__ */ K(W, { children: [/* @__PURE__ */ G(Cc, {
					value: c.mathText,
					timeout: 2e3,
					...
					shadow: "md",
					width: 160,
					children: [/* @__PURE__ */ G(Y.Target, { children: /* @__PURE__ */ G(N, {
						size: "lg",
						variant: "subtle",
						"aria-label": "Equation alignment",
						children: c.align === "left" ? /* @__PURE__ */ G(xs, { size: 18 }) : c.align === "right" ? /* @__PURE__ */ G(Ss, { size: 18 }) : /* @__PURE__ */ G(ys, { size: 18 })
				...
				c?.name === "pageBreak" && /* @__PURE__ */ G(X, {
					label: "Convert to divider",
					position: "top",
					withinPortal: !1,
					children: /* @__PURE__ */ G(N, {
						size: "lg",
						variant: "subtle",
						"aria-label": "Convert to divider",
						onMouseDown: (e) => e.preventDefault(),
						onClick: () => Tl(e, "horizontalRule"),
						children: /* @__PURE__ */ G(dc, { size: 18 })
					})
				}),
				c?.name === "horizontalRule" && /* @__PURE__ */ K(W, { children: [/* @__PURE__ */ K(Y, {
					...
					children: [/* @__PURE__ */ G(Y.Target, { children: /* @__PURE__ */ G(X, {
						...
						children: /* @__PURE__ */ G(N, {
							...
							onMouseDown: (e) => e.preventDefault(),
							children: /* @__PURE__ */ G(_s, { size: 18 })
						})
					...
					label: "Convert to page break",
					position: "top",
					withinPortal: !1,
					children: /* @__PURE__ */ G(N, {
						size: "lg",
						variant: "subtle",
						"aria-label": "Convert to page break",
						onMouseDown: (e) => e.preventDefault(),
						onClick: () => Tl(e, "pageBreak"),
						children: /* @__PURE__ */ G(dc, { size: 18 })
					})
				})] }),
				(c?.supportsTextTools || c?.isSectionHeading || c?.name === "details" || c?.name === "mathBlock" || c?.name === "pageBreak" || c?.name === "horizontalRule") && /* @__PURE__ */ G("div", { className: il.divider }),
				/* @__PURE__ */ G(El, { editor: e })
			]
		})
	});
}
function Ol({ editor: e }) {
	let t = B(({ state: t }) => !al(e) || !e.isEditable || !t.selection.empty && !(t.selection instanceof r) ? !1 : cl(e) === "custom", [e]), n = B(() => {
		let t = pl(e);
		if (!t) return;
		let n = e.view.nodeDOM(t.position);
		if (!(n instanceof HTMLElement)) return;
		...
		selector: ({ editor: e }) => {
			...
			return t.node.type.name === "base" ? {
				...
				theme: ["light", "dark"].includes(t.node.attrs.theme) ? t.node.attrs.theme : "auto",
	...
	return /* @__PURE__ */ G(el, {
		...
		children: /* @__PURE__ */ K("div", {
			...
			"data-ramzy-element-toolbar": !0,
			children: [
				i?.type === "sync-source" ? /* @__PURE__ */ K(W, { children: [/* @__PURE__ */ G(X, {
					...
					children: /* @__PURE__ */ G(N, {
						...
						children: /* @__PURE__ */ G($s, { size: 18 })
					})
				})] }) : i?.type === "sync-reference" ? /* @__PURE__ */ K(W, { children: [
					/* @__PURE__ */ G(X, {
						...
						children: /* @__PURE__ */ G(N, {
							...
							children: /* @__PURE__ */ G(sc, { size: 18 })
						})
					}),
					/* @__PURE__ */ G(X, {
						label: "Open source",
						...
						children: /* @__PURE__ */ G(N, {
							...
							disabled: !i.hasSource,
							onMouseDown: (e) => e.preventDefault(),
							onClick: () => $(e, "open-synced-source"),
							children: /* @__PURE__ */ G(Us, { size: 18 })
						})
					}),
					/* @__PURE__ */ G(X, {
						label: "Unsync block",
				...
				] }) : i?.type === "base" ? /* @__PURE__ */ K(W, { children: [/* @__PURE__ */ G(X, {
				...
				})] }) : i?.type === "tabs" ? /* @__PURE__ */ K(W, { children: [
					/* @__PURE__ */ G(X, {
						label: "Add tab",
						position: "top",
						withinPortal: !1,
						children: /* @__PURE__ */ G(N, {
							...
							onMouseDown: (e) => e.preventDefault(),
							onClick: () => $(e, "add-tab"),
							children: /* @__PURE__ */ G(ac, { size: 18 })
						})
					}),
					/* @__PURE__ */ G(X, {
						...
						children: /* @__PURE__ */ G(N, {
							...
							children: /* @__PURE__ */ G(de, { size: 18 })
						})
					}),
					/* @__PURE__ */ G(X, {
					...
					/* @__PURE__ */ G(X, {
						...
						children: /* @__PURE__ */ G(N, {
							...
							children: /* @__PURE__ */ G(Ts, { size: 18 })
						})
					}),
					/* @__PURE__ */ G(X, {
					...
					/* @__PURE__ */ G(X, {
						...
						children: /* @__PURE__ */ G(N, {
							...
							children: /* @__PURE__ */ G(hc, { size: 18 })
						})
					})
				] }) : i?.type === "youtube" ? /* @__PURE__ */ K(W, { children: [
					/* @__PURE__ */ G(X, {
						...
						children: /* @__PURE__ */ G(N, {
							...
							onMouseDown: (e) => e.preventDefault(),
							onClick: () => {
								let t = window.prompt("Edit YouTube link", i.source)?.trim();
								t && Q(e, { src: t });
							},
							children: /* @__PURE__ */ G(de, { size: 18 })
						})
					...
					/* @__PURE__ */ G(X, {
						...
						children: /* @__PURE__ */ G(N, {
							...
							disabled: !i.source,
							onMouseDown: (e) => e.preventDefault(),
							onClick: () => window.open(i.source, "_blank", "noopener,noreferrer"),
							children: /* @__PURE__ */ G(Us, { size: 18 })
						})
					}),
					/* @__PURE__ */ K(Y, {
						...
						width: 180,
						children: [/* @__PURE__ */ G(Y.Target, { children: /* @__PURE__ */ G(X, {
							label: `Video width: ${i.width}px`,
							position: "top",
							withinPortal: !1,
							children: /* @__PURE__ */ G(N, {
								size: "lg",
								variant: "subtle",
								"aria-label": `Video width: ${i.width}px`,
								onMouseDown: (e) => e.preventDefault(),
								children: /* @__PURE__ */ G(Os, { size: 18 })
							})
						}) }), /* @__PURE__ */ G(Y.Dropdown, { children: [
							480,
							640,
							...
							rightSection: i.width === t ? /* @__PURE__ */ G(Z, { size: 14 }) : null,
							onClick: () => Q(e, {
								width: t,
					...
					/* @__PURE__ */ G(X, {
						label: `Start time: ${i.start}s`,
						position: "top",
						withinPortal: !1,
						children: /* @__PURE__ */ G(N, {
							size: "lg",
							variant: "subtle",
							"aria-label": `Start time: ${i.start}s`,
							onMouseDown: (e) => e.preventDefault(),
							onClick: () => {
								let t = window.prompt("Start time in seconds", String(i.start));
								t !== null && Q(e, { start: Math.max(0, Math.round(Number(t) || 0)) });
							},
							children: /* @__PURE__ */ G(Is, { size: 18 })
						})
					})
				] }) : i?.type === "embed" ? /* @__PURE__ */ K(W, { children: [
					/* @__PURE__ */ G(X, {
					...
					/* @__PURE__ */ K(Y, {
						...
						children: [/* @__PURE__ */ G(Y.Target, { children: /* @__PURE__ */ G(N, {
							...
							onMouseDown: (e) => e.preventDefault(),
							children: i.align === "left" ? /* @__PURE__ */ G(xs, { size: 18 }) : i.align === "right" ? /* @__PURE__ */ G(Ss, { size: 18 }) : /* @__PURE__ */ G(ys, { size: 18 })
						}) }), /* @__PURE__ */ G(Y.Dropdown, { children: [
							"left",
							"center",
							"right"
						].map((t) => /* @__PURE__ */ G(Y.Item, {
							leftSection: G(t === "left" ? xs : t === "right" ? Ss : ys, { size: 16 }),
							rightSection: i.align === t ? /* @__PURE__ */ G(Z, { size: 14 }) : null,
							onClick: () => Q(e, { align: t }),
							children: t[0].toUpperCase() + t.slice(1)
						}, t)) })]
					}),
					/* @__PURE__ */ K(Y, {
						...
						width: 180,
						children: [/* @__PURE__ */ G(Y.Target, { children: /* @__PURE__ */ G(X, {
							label: `Embed width: ${i.width}px`,
							position: "top",
							withinPortal: !1,
							children: /* @__PURE__ */ G(N, {
								size: "lg",
								variant: "subtle",
								"aria-label": `Embed width: ${i.width}px`,
								onMouseDown: (e) => e.preventDefault(),
								children: /* @__PURE__ */ G(Os, { size: 18 })
							})
						}) }), /* @__PURE__ */ G(Y.Dropdown, { children: [
							...
							rightSection: i.width === t.width ? /* @__PURE__ */ G(Z, { size: 14 }) : null,
							onClick: () => Q(e, {
								width: t.width,
								height: t.height
							}),
				...
				] }) : i?.type === "code" ? /* @__PURE__ */ K(W, { children: [
					/* @__PURE__ */ K(Y, {
						withinPortal: !1,
						position: "bottom-start",
						shadow: "md",
						width: 220,
						children: [/* @__PURE__ */ G(Y.Target, { children: /* @__PURE__ */ G(X, {
							label: `Language: ${i.language || "Auto-detect"}`,
							position: "top",
							withinPortal: !1,
							children: /* @__PURE__ */ G(N, {
								size: "lg",
								variant: "subtle",
								"aria-label": `Language: ${i.language || "Auto-detect"}`,
								onMouseDown: (e) => e.preventDefault(),
							...
							children: [/* @__PURE__ */ G(Y.Item, {
								rightSection: i.language ? null : /* @__PURE__ */ G(Z, { size: 14 }),
								onClick: () => Q(e, { language: null }),
								children: "Auto-detect"
							}), a.map((t) => /* @__PURE__ */ G(Y.Item, {
								rightSection: i.language === t ? /* @__PURE__ */ G(Z, { size: 14 }) : null,
					...
					/* @__PURE__ */ G(X, {
						...
						children: /* @__PURE__ */ G(N, {
							...
							className: i.wrap ? il.active : void 0,
							onMouseDown: (e) => e.preventDefault(),
							onClick: () => Q(e, { wrap: !i.wrap }),
							children: /* @__PURE__ */ G(pc, { size: 18 })
						})
					}),
					/* @__PURE__ */ G(X, {
						...
						children: /* @__PURE__ */ G(N, {
							...
							className: i.lineNumbers ? il.active : void 0,
							onMouseDown: (e) => e.preventDefault(),
							onClick: () => Q(e, { lineNumbers: !i.lineNumbers }),
					...
					/* @__PURE__ */ K(Y, {
						...
						width: 170,
						children: [/* @__PURE__ */ G(Y.Target, { children: /* @__PURE__ */ G(X, {
							label: `${i.theme === "auto" ? "Page" : i.theme === "light" ? "Light" : "Dark"} theme`,
							position: "top",
							withinPortal: !1,
							children: /* @__PURE__ */ G(N, {
								size: "lg",
								variant: "subtle",
								"aria-label": `${i.theme === "auto" ? "Page" : i.theme === "light" ? "Light" : "Dark"} theme`,
								onMouseDown: (e) => e.preventDefault(),
								children: /* @__PURE__ */ G(uc, { size: 18 })
							})
						}) }), /* @__PURE__ */ K(Y.Dropdown, { children: [
							/* @__PURE__ */ G(Y.Item, {
								rightSection: i.theme === "auto" ? /* @__PURE__ */ G(Z, { size: 14 }) : null,
								onClick: () => Q(e, { theme: "auto" }),
								children: "Page theme"
							}),
							/* @__PURE__ */ G(Y.Item, {
								rightSection: i.theme === "dark" ? /* @__PURE__ */ G(Z, { size: 14 }) : null,
								onClick: () => Q(e, { theme: "dark" }),
								children: "Dark theme"
							}),
							/* @__PURE__ */ G(Y.Item, {
								rightSection: i.theme === "light" ? /* @__PURE__ */ G(Z, { size: 14 }) : null,
					...
					/* @__PURE__ */ G(X, {
						label: i.collapsed ? "Expand code" : "Collapse code",
						position: "top",
						children: /* @__PURE__ */ G(N, {
							size: "lg",
							variant: "subtle",
							"aria-label": i.collapsed ? "Expand code" : "Collapse code",
							className: i.collapsed ? il.active : void 0,
							onMouseDown: (e) => e.preventDefault(),
							onClick: () => Q(e, { collapsed: !i.collapsed }),
							children: /* @__PURE__ */ G(ks, { size: 18 })
						})
					})
				] }) : i?.type === "attachment" ? /* @__PURE__ */ K(W, { children: [
					/* @__PURE__ */ G(X, {
						label: "Rename file",
						position: "top",
						children: /* @__PURE__ */ G(N, {
							...
							onMouseDown: (e) => e.preventDefault(),
							onClick: () => {
								let t = window.prompt("Rename file", i.name)?.trim();
								t && Q(e, { name: t });
							},
							children: /* @__PURE__ */ G(de, { size: 18 })
						})
					...
					/* @__PURE__ */ G(X, {
						...
						children: /* @__PURE__ */ G(N, {
							...
							disabled: !i.source,
							onMouseDown: (e) => e.preventDefault(),
							onClick: () => window.open(M(i.source), "_blank", "noopener,noreferrer"),
							children: /* @__PURE__ */ G(Us, { size: 18 })
						})
					}),
					/* @__PURE__ */ G(Cc, {
						value: i.source ? M(i.source) : "",
						timeout: 2e3,
						children: ({ copied: e, copy: t }) => /* @__PURE__ */ G(X, {
					...
					/* @__PURE__ */ K(Y, {
						...
						width: 170,
						children: [/* @__PURE__ */ G(Y.Target, { children: /* @__PURE__ */ G(X, {
							label: `File display: ${i.display === "inline" ? "Inline" : "Card"}`,
							position: "top",
							withinPortal: !1,
							children: /* @__PURE__ */ G(N, {
								size: "lg",
								variant: "subtle",
								"aria-label": `File display: ${i.display === "inline" ? "Inline" : "Card"}`,
								onMouseDown: (e) => e.preventDefault(),
								children: /* @__PURE__ */ G(Qs, { size: 18 })
							})
						}) }), /* @__PURE__ */ G(Y.Dropdown, { children: ["card", "inline"].map((t) => /* @__PURE__ */ G(Y.Item, {
							rightSection: i.display === t ? /* @__PURE__ */ G(Z, { size: 14 }) : null,
							onClick: () => Q(e, { display: t }),
							children: t === "card" ? "Card" : "Inline"
						}, t)) })]
					}),
					i.canEmbedAsPdf && /* @__PURE__ */ G(X, {
						label: "Embed as PDF",
						position: "top",
						children: /* @__PURE__ */ G(N, {
							size: "lg",
					...
					/* @__PURE__ */ G(X, {
						...
						children: /* @__PURE__ */ G(N, {
							...
							disabled: !i.canDownload,
							onMouseDown: (e) => e.preventDefault(),
							onClick: () => $(e, "download-file"),
							children: /* @__PURE__ */ G(Hs, { size: 18 })
						})
					})
				] }) : i?.type === "playlist" ? /* @__PURE__ */ K(W, { children: [
					/* @__PURE__ */ G(X, {
						label: i.kind === "video" ? "Add videos" : "Add tracks",
						position: "top",
						withinPortal: !1,
						children: /* @__PURE__ */ G(N, {
							size: "lg",
							variant: "subtle",
							"aria-label": i.kind === "video" ? "Add videos" : "Add tracks",
							onMouseDown: (e) => e.preventDefault(),
							onClick: () => $(e, "add-media"),
							children: /* @__PURE__ */ G(ac, { size: 18 })
						})
					...
					/* @__PURE__ */ G(X, {
						...
						children: /* @__PURE__ */ G(N, {
							...
							className: i.autoplay ? il.active : void 0,
							onMouseDown: (e) => e.preventDefault(),
							onClick: () => Q(e, { autoplay: !i.autoplay }),
							children: /* @__PURE__ */ G(ic, { size: 18 })
						})
					}),
					/* @__PURE__ */ G(X, {
						label: "Loop playlist",
						...
						children: /* @__PURE__ */ G(N, {
							...
							className: i.loop ? il.active : void 0,
							onMouseDown: (e) => e.preventDefault(),
							onClick: () => Q(e, { loop: !i.loop }),
							children: /* @__PURE__ */ G(cc, { size: 18 })
						})
					}),
					/* @__PURE__ */ G(X, {
						...
						children: /* @__PURE__ */ G(N, {
							...
							className: i.shuffle ? il.active : void 0,
							onMouseDown: (e) => e.preventDefault(),
							onClick: () => Q(e, { shuffle: !i.shuffle }),
							children: /* @__PURE__ */ G(As, { size: 18 })
						})
					}),
					/* @__PURE__ */ K(Y, {
						withinPortal: !1,
						...
						children: [/* @__PURE__ */ G(Y.Target, { children: /* @__PURE__ */ G(N, {
							...
							/* @__PURE__ */ G(Y.Item, {
								rightSection: i.showQueue ? /* @__PURE__ */ G(Z, { size: 14 }) : null,
								onClick: () => Q(e, { showQueue: !i.showQueue }),
								children: "Show queue"
							}),
							/* @__PURE__ */ G(Y.Divider, {}),
							/* @__PURE__ */ G(Y.Item, {
								rightSection: i.queueLayout === "detailed" ? /* @__PURE__ */ G(Z, { size: 14 }) : null,
								onClick: () => Q(e, { queueLayout: "detailed" }),
								children: "Detailed queue"
							}),
							/* @__PURE__ */ G(Y.Item, {
								rightSection: i.queueLayout === "compact" ? /* @__PURE__ */ G(Z, { size: 14 }) : null,
								onClick: () => Q(e, { queueLayout: "compact" }),
								children: "Compact queue"
							})
						] })]
					})
				] }) : i?.type === "photos" ? /* @__PURE__ */ K(W, { children: [
					/* @__PURE__ */ G(X, {
						label: "Add photos",
						position: "top",
						withinPortal: !1,
					...
					i.kind === "album" && /* @__PURE__ */ G(X, {
						...
						children: /* @__PURE__ */ G(N, {
							...
							onMouseDown: (e) => e.preventDefault(),
							onClick: () => $(e, "edit-album-details"),
							children: /* @__PURE__ */ G(de, { size: 18 })
						})
					}),
					i.kind === "grid" && /* @__PURE__ */ K(Y, {
						withinPortal: !1,
						position: "bottom-start",
						shadow: "md",
						width: 175,
						children: [/* @__PURE__ */ G(Y.Target, { children: /* @__PURE__ */ G(X, {
							label: i.columns ? `Grid columns: ${i.columns}` : "Grid columns: Auto layout",
							position: "top",
							withinPortal: !1,
							children: /* @__PURE__ */ G(N, {
								size: "lg",
								variant: "subtle",
								"aria-label": i.columns ? `Grid columns: ${i.columns}` : "Grid columns: Auto layout",
								onMouseDown: (e) => e.preventDefault(),
							...
							rightSection: i.columns === t ? /* @__PURE__ */ G(Z, { size: 14 }) : null,
					...
					/* @__PURE__ */ K(Y, {
						...
						width: 180,
						children: [/* @__PURE__ */ G(Y.Target, { children: /* @__PURE__ */ G(X, {
							label: i.fit === "contain" ? "Fit image" : "Fill frame",
							position: "top",
							withinPortal: !1,
							children: /* @__PURE__ */ G(N, {
								size: "lg",
								variant: "subtle",
								"aria-label": i.fit === "contain" ? "Fit image" : "Fill frame",
								onMouseDown: (e) => e.preventDefault(),
								children: /* @__PURE__ */ G(js, { size: 18 })
							})
						}) }), /* @__PURE__ */ K(Y.Dropdown, { children: [
							/* @__PURE__ */ G(Y.Item, {
								rightSection: i.fit === "cover" ? /* @__PURE__ */ G(Z, { size: 14 }) : null,
								onClick: () => Q(e, { fit: "cover" }),
								children: "Fill frame"
							}),
							/* @__PURE__ */ G(Y.Item, {
								rightSection: i.fit === "contain" ? /* @__PURE__ */ G(Z, { size: 14 }) : null,
								onClick: () => Q(e, { fit: "contain" }),
								children: "Fit image"
							}),
							i.kind === "grid" && /* @__PURE__ */ K(W, { children: [/* @__PURE__ */ G(Y.Divider, {}), [
								["auto", "Natural ratio"],
								["square", "Square"],
								["landscape", "Landscape"],
								["portrait", "Portrait"]
							].map(([t, n]) => /* @__PURE__ */ G(Y.Item, {
								rightSection: i.aspect === t ? /* @__PURE__ */ G(Z, { size: 14 }) : null,
					...
					/* @__PURE__ */ K(Y, {
						...
						width: 190,
						children: [/* @__PURE__ */ G(Y.Target, { children: /* @__PURE__ */ G(X, {
							label: `Spacing: ${i.gap}px`,
							position: "top",
							withinPortal: !1,
							children: /* @__PURE__ */ G(N, {
								size: "lg",
								variant: "subtle",
								"aria-label": `Spacing: ${i.gap}px`,
								onMouseDown: (e) => e.preventDefault(),
								children: /* @__PURE__ */ G(lc, { size: 18 })
							})
						}) }), /* @__PURE__ */ G(Y.Dropdown, { children: [
							0,
							8,
							...
							rightSection: i.gap === t ? /* @__PURE__ */ G(Z, { size: 14 }) : null,
							onClick: () => Q(e, { gap: t }),
							children: t === 0 ? "No gap" : `${t}px gap`
						}, t)) })]
					}),
					i.kind === "album" && /* @__PURE__ */ K(Y, {
						withinPortal: !1,
						position: "bottom-start",
						shadow: "md",
						width: 200,
						children: [/* @__PURE__ */ G(Y.Target, { children: /* @__PURE__ */ G(X, {
							...
							/* @__PURE__ */ G(Y.Item, {
								rightSection: i.thumbnailPosition === "right" ? /* @__PURE__ */ G(Z, { size: 14 }) : null,
								onClick: () => Q(e, { thumbnailPosition: "right" }),
								children: "Right side"
							}),
							/* @__PURE__ */ G(Y.Item, {
								rightSection: i.thumbnailPosition === "bottom" ? /* @__PURE__ */ G(Z, { size: 14 }) : null,
								onClick: () => Q(e, { thumbnailPosition: "bottom" }),
								children: "Below photo"
							}),
							/* @__PURE__ */ G(Y.Divider, {}),
							/* @__PURE__ */ G(Y.Item, {
								rightSection: i.autoplay ? /* @__PURE__ */ G(Z, { size: 14 }) : null,
								onClick: () => Q(e, { autoplay: !i.autoplay }),
							...
							[
								...
								disabled: !i.autoplay,
								rightSection: i.interval === t ? /* @__PURE__ */ G(Z, { size: 14 }) : null,
					...
					/* @__PURE__ */ G(X, {
						...
						children: /* @__PURE__ */ G(N, {
							...
							className: i.lightbox ? il.active : void 0,
							onMouseDown: (e) => e.preventDefault(),
							onClick: () => Q(e, { lightbox: !i.lightbox }),
							children: /* @__PURE__ */ G(Us, { size: 18 })
						})
					})
				] }) : null,
				/* @__PURE__ */ G("div", { className: il.divider }),
				/* @__PURE__ */ G(El, { editor: e })
			]
		})
	});
...
function jl({ editor: e, nodeName: t, currentAlt: n }) {
	let { t: r } = it(), [a, s] = U(!1), [c, l] = U(""), u = B(() => {
		l(n || ""), s(!0);
	}, [n]);
	V(() => {
		let n = () => {
	...
	let d = B(() => {
		...
		e.chain().focus(void 0, { scrollIntoView: !1 }).updateAttributes(t, { alt: Al(c) || void 0 }).run(), s(!1);
	}, [
		e,
		t,
		c
	]), m = B((e) => {
		e.key === "Enter" && (e.metaKey || e.ctrlKey) ? (e.preventDefault(), f()) : e.key === "Escape" && (e.preventDefault(), d());
	}, [f, d]);
	return {
		button: /* @__PURE__ */ G(X, {
			position: "top",
			...
			children: /* @__PURE__ */ G(N, {
				onClick: u,
				size: "lg",
				"aria-label": r("Alt text"),
				variant: "subtle",
				children: /* @__PURE__ */ G(Cs, { size: 18 })
			})
		}),
		panel: a ? /* @__PURE__ */ K(p, {
			withBorder: !0,
			shadow: "md",
			radius: 6,
			p: "sm",
			...
			children: [
				...
				/* @__PURE__ */ G(i, {
					...
					c: "dimmed",
					mb: "xs",
					children: r("Describe this for accessibility.")
				}),
				/* @__PURE__ */ G(yo, {
					size: "xs",
					placeholder: r("Add a description"),
					value: c,
...
//#endregion
export { ws as $, Xs as A, Mn as At, zs as B, nn as Bt, ac as C, Un as Ct, $s as D, Nn as Dt, ec as E, Bn as Et, Gs as F, mn as Ft, Ns as G, Ls as H, Jt as Ht, Ws as I, dn as It, js as J, Z as K, Us as L, ln as Lt, Js as M, vn as Mt, qs as N, _n as Nt, Qs as O, An as Ot, Ks as P, hn as Pt, Ts as Q, Hs as R, rn as Rt, sc as S, Wn as St, nc as T, Vn as Tt, Is as U, Xt as Ut, Rs as V, Zt as Vt, Ps as W, Ds as X, Os as Y, Es as Z, _c as _, Zi as _t, cl as a, yo as at, fc as b, sr as bt, il as c, co as ct, tl as d, Ha as dt, Ss as et, el as f, La as ft, yc as g, ua as gt, bc as h, ha as ht, Dl as i, Y as it, Ys as j, kn as jt, Zs as k, jn as kt, rl as l, so as lt, xc as m, Sa as mt, Ol as n, ys as nt, al as o, lo as ot, Cc as p, J as pt, Ms as q, El as r, X as rt, Q as s, uo as st, jl as t, xs as tt, nl as u, io as ut, gc as v, Ji as vt, rc as w, Hn as wt, lc as x, Kn as xt, hc as y, Fi as yt, Vs as z, qt as zt };
