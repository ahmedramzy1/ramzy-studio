...
//#region ../../node_modules/.pnpm/@excalidraw+excalidraw@0.18.0-3a5ef40_@types+react-dom@19.2.3_@types+react@19.2.17__@ty_b5c0bb913e6bf58bb5b24f479fd5a57a/node_modules/@excalidraw/excalidraw/dist/prod/locales/fa-IR-26LZG4PM.js
var e = {
	paste: "جایگذاری",
	...
	arrowtype_elbowed: "پیکان گوشه‌دار",
	fontSize: "اندازه قلم",
	fontFamily: "نوع قلم",
	...
	couldNotCopyToClipboard: "در بریده‌دان رونویسی نشد.",
	...
	saveLibraryError: "ذخیره‌سازی در سرور با مشکل مواجه شد. لطفا فایل خود را در دستگاه خود به صورت محلی ذخیره کنید تا مطمئن شوید تغییرات اعمال شده را از دست نخواهید داد.",
	...
	link: "افزودن/به‌روزرسانی لینک برای شکل انتخابی",
	eraser: "پاک کن",
	frame: "ابزار فریم",
	...
	tooltip: { embedScene: "داده های صحنه در فایل PNG/SVG صادر شده ذخیره می شود تا صحنه را بتوان از آن بازیابی کرد.\nاندازه فایل خروجی را افزایش می دهد." },
	title: {
	...
	selected: "انتخاب شده",
	storage: "حافظه",
	fullTitle: "ویژگی‌های بوم و شکل",
	title: "ویژگی‌ها",
	generalStats: "عمومی",
	elementProperties: "ویژگی‌های شکل",
	total: "مجموع",
	version: "نسخه",
	...
	elementLinkCopied: "لینک در کلیپ‌بورد کپی شد"
}, E = {
	transparent: "شفاف",
	black: "سیاه",
	white: "سفید",
	...
	hint: {
		...
		followStatus: "هم‌اینک این کاربر را دنبال میکنید",
		inCall: "کاربر در تماسی صوتی است",
		micMuted: "میکروفون کاربر بی‌صدا است",
	...
	search: {
		placeholder: "در فهرست‌ها و دستورها را جستجو کنید هم سنگهای پنهان را کشف کنید",
