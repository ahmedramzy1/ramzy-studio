import { Bn as e, C as t, Dn as n, Et as r, P as i, Rn as a, Vn as o, Wn as s, ar as c, bn as l, cr as u, ln as d, on as f, pn as p, vn as m, wn as h, wt as g, yn as _ } from "./chunk-J7OUQ5F2-BUGcDHyW.mjs";
import { t as v } from "./linear-D4tQfDWZ.mjs";
import { t as y } from "./ordinal-BTZmV7vg.mjs";
import { t as b } from "./init-Co4dhKfe.mjs";
...
function S() {
	var e = y().unknown(void 0), t = e.domain, n = e.range, r = 0, i = 1, a, o, s = !1, c = 0, l = 0, u = .5;
	delete e.unknown;
	function d() {
...
var C = (function() {
	var e = /* @__PURE__ */ u(function(e, t, n, r) {
		...
		37,
		38
	], c = [1, 25], l = [1, 26], d = [1, 28], f = [1, 29], p = [1, 30], m = [1, 31], h = [1, 32], g = [1, 33], _ = [1, 34], v = [1, 35], y = [1, 36], b = [1, 37], x = [1, 43], S = [1, 42], C = [1, 47], w = [1, 50], T = [
		1,
		10,
		12,
		14,
	...
	return u(j, "Parser"), j.prototype = A, A.Parser = j, new j();
})();
C.parser = C;
var w = C;
function T(e) {
...
u(D, "isLinearAxisData");
var O = class {
	constructor(e) {
		this.parentGroup = e;
	}
	static {
		u(this, "TextDimensionCalculatorWithFont");
	}
	getMaxDimension(e, n) {
		if (!this.parentGroup) return {
			width: e.reduce((e, t) => Math.max(t.length, e), 0) * n,
			height: n
		};
		let r = {
			width: 0,
			height: 0
		}, i = this.parentGroup.append("g").attr("visibility", "hidden").attr("font-size", n);
		for (let a of e) {
			let e = t(i, 1, a), o = e ? e.width : a.length * n, s = e ? e.height : n;
			r.width = Math.max(r.width, o), r.height = Math.max(r.height, s);
		}
		return i.remove(), r;
	}
}, k = .7, A = .2, j = class {
	...
	recalculateScale() {
		this.scale = S().domain(this.categories).range(this.getRange()).paddingInner(1).paddingOuter(0).align(.5), c.trace("BandAxis axis final categories, range: ", this.categories, this.getRange());
	}
	getTickValues() {
	...
	constructor(e, t, n, r, i) {
		super(e, r, i, t), this.domain = n, this.scale = v().domain(this.domain).range(this.getRange());
	}
	getTickValues() {
	...
	recalculateScale() {
		let e = [...this.domain];
		this.axisPosition === "left" && e.reverse(), this.scale = v().domain(e).range(this.getRange());
	}
	getScaleValue(e) {
		return this.scale(e);
	}
...
var re = class {
	...
	getDrawableElement() {
		...
		if (t = this.orientation === "horizontal" ? r().y((e) => e[0]).x((e) => e[1])(e) : r().x((e) => e[0]).y((e) => e[1])(e), !t) return [];
		let n = [{
...
function U() {
	let e = n(), t = l();
	return i(e.xyChart, t.themeVariables.xyChart);
}
u(U, "getChartDefaultThemeConfig");
function W() {
	let e = l();
	return i(p.xyChart, e.xyChart);
}
u(W, "getChartDefaultConfig");
function G() {
	return {
		yAxis: {
			type: "linear",
...
u(de, "setYAxisRangeFromPlotData");
function Z(e) {
	let t = [];
...
u(Z, "transformDataWithoutCategory");
function Q(e) {
	return B[e === 0 ? 0 : e % B.length];
}
u(Q, "getPlotColorFromPalette");
function fe(e, t) {
...
function me() {
	...
	return z.title = h(), se.build(L, z, R, I);
}
u(me, "getDrawableElem");
function he() {
	return R;
}
u(he, "getChartThemeConfig");
function ge() {
	return L;
}
u(ge, "getChartConfig");
...
var _e = {
	...
	db: {
		...
		clear: /* @__PURE__ */ u(function() {
			f(), F = 0, L = W(), z = G(), R = U(), B = R.plotColorPalette.split(",").map((e) => e.trim()), V = !1, H = !1;
		}, "clear"),
		setAccTitle: o,
		getAccTitle: _,
		setDiagramTitle: s,
	...
	renderer: { draw: /* @__PURE__ */ u((e, t, n, r) => {
		...
		u(p, "getTextTransformation"), c.debug("Rendering xychart chart\n" + e);
		let m = g(t), h = m.append("g").attr("class", "main"), _ = h.append("rect").attr("width", o.width).attr("height", o.height).attr("class", "background");
		d(m, o.height, o.width, !0), m.attr("viewBox", `0 0 ${o.width} ${o.height}`), _.attr("fill", a.backgroundColor), i.setTmpSVGG(m.append("g").attr("class", "mermaid-tmp-group"));
		let v = i.getDrawableElem(), y = {};
		function b(e) {
			let t = h, n = "";
			for (let [r] of e.entries()) {
				let i = h;
				r > 0 && y[n] && (i = y[n]), n += e[r], t = y[n], t ||= y[n] = i.append("g").attr("class", e[r]);
			}
			return t;
		}
		u(b, "getGroup");
		for (let e of v) {
			...
			switch (e.type) {
				case "rect":
					if (t.selectAll("rect").data(e.data).enter().append("rect").attr("x", (e) => e.x).attr("y", (e) => e.y).attr("width", (e) => e.width).attr("height", (e) => e.height).attr("fill", (e) => e.fill).attr("stroke", (e) => e.strokeFill).attr("stroke-width", (e) => e.strokeWidth), o.showDataLabel) {
						...
						if (o.chartOrientation === "horizontal") {
							...
							let i = .7, o = 10, c = e.data.map((e, t) => ({
								...
								for (; !r(e, n) && n > 0;) --n;
								return n;
							}), d = Math.floor(Math.min(...l)), f = /* @__PURE__ */ u((e) => n ? e.data.x + e.data.width + 10 : e.data.x + e.data.width - 10, "determineLabelXPosition");
							t.selectAll("text").data(c).enter().append("text").attr("x", f).attr("y", (e) => e.data.y + e.data.height / 2).attr("text-anchor", n ? "start" : "end").attr("dominant-baseline", "middle").attr("fill", a.dataLabelColor).attr("font-size", `${d}px`).text((e) => e.label);
						} else {
							...
							let i = e.data.map((e, t) => ({
								...
								for (; !r(e, i, 10) && i > 0;) --i;
								return i;
							}), c = Math.floor(Math.min(...o)), l = /* @__PURE__ */ u((e) => n ? e.data.y - 10 : e.data.y + 10, "determineLabelYPosition");
					...
					break;
				case "text":
					t.selectAll("text").data(e.data).enter().append("text").attr("x", 0).attr("y", 0).attr("fill", (e) => e.fill).attr("font-size", (e) => e.fontSize).attr("dominant-baseline", (e) => l(e.verticalPos)).attr("text-anchor", (e) => f(e.horizontalPos)).attr("transform", (e) => p(e)).text((e) => e.text);
					break;
				case "path":
