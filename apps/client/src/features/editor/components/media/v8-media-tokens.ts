...
export function dsTheme(mode: DsMode) {
  ...
  return {
    ...
    errorText: d ? "#FCA5A5" : "#BC2727",
    successText: d ? "#4ADE80" : SEMANTIC.success,
    warningText: d ? "#FDE68A" : SEMANTIC.warning,
    infoText: d ? "#7DD3FC" : SEMANTIC.info,
