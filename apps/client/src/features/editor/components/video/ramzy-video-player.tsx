...
function Icon({ name, size = 24 }: { name: IconName; size?: number }) {
  ...
  if (name === "volume")
    return (
      <svg {...common}>
        <path d="M4 9.5v5h4L13 19V5L8 9.5H4Z" fill="currentColor" />
        <path
          d="M16 8.2c1.6 1.6 1.6 6 0 7.6M18.8 5.8c3.1 3.2 3.1 9.2 0 12.4"
          stroke="currentColor"
          strokeWidth="1.65"
          strokeLinecap="round"
        />
  ...
  if (name === "muted")
    return (
      <svg {...common}>
        <path d="M4 9.5v5h4L13 19V5L8 9.5H4Z" fill="currentColor" />
        <path
          d="m16.2 9.2 4.2 5.6m0-5.6-4.2 5.6"
          stroke="currentColor"
          strokeWidth="1.8"
          strokeLinecap="round"
        />
    ...
    return (
      <svg {...common}>
        <rect
          ...
          strokeWidth="1.5"
        />
        <rect x="11.5" y="11" width="7" height="5" rx="1" fill="currentColor" />
      </svg>
    );
  if (name === "previous")
    return (
      <svg {...common}>
        <path
          d="M7 5v14M18 6.5 9.5 12 18 17.5v-11Z"
          stroke="currentColor"
          strokeWidth="1.8"
          strokeLinecap="round"
  ...
  if (name === "next")
    return (
      <svg {...common}>
        <path
          d="M17 5v14M6 6.5 14.5 12 6 17.5v-11Z"
          stroke="currentColor"
          strokeWidth="1.8"
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  if (name === "settings")
    return (
      <svg {...common}>
        ...
        />
        <path
          d="M19.4 13.4a7.7 7.7 0 0 0 0-2.8l2-1.5-2-3.4-2.4 1a8.4 8.4 0 0 0-2.4-1.4L14.3 2h-4.6l-.3 3.3A8.4 8.4 0 0 0 7 6.7l-2.4-1-2 3.4 2 1.5a7.7 7.7 0 0 0 0 2.8l-2 1.5 2 3.4 2.4-1a8.4 8.4 0 0 0 2.4 1.4l.3 3.3h4.6l.3-3.3a8.4 8.4 0 0 0 2.4-1.4l2.4 1 2-3.4-2-1.5Z"
          stroke="currentColor"
          strokeWidth="1.35"
          strokeLinejoin="round"
        />
  ...
  if (name === "captions")
    return (
      <svg {...common}>
        ...
        />
        <path
          d="M10.3 10a2.2 2.2 0 1 0 0 4M17.1 10a2.2 2.2 0 1 0 0 4"
          stroke="currentColor"
          strokeWidth="1.6"
          strokeLinecap="round"
        />
...
export default function RamzyVideoPlayer({
  ...
  useEffect(
    () => () => {
      ...
      if (seekFeedbackTimer.current)
        window.clearTimeout(seekFeedbackTimer.current);
      if (floatingExitTimer.current)
        window.clearTimeout(floatingExitTimer.current);
      if (floatingFrame.current)
        window.cancelAnimationFrame(floatingFrame.current);
  ...
  function showSeekFeedback(delta: -5 | 5) {
    ...
    if (seekFeedbackTimer.current)
      window.clearTimeout(seekFeedbackTimer.current);
    seekFeedbackTimer.current = window.setTimeout(
  ...
  async function toggleFullscreen() {
    ...
    const webkitRoot = root as HTMLDivElement & {
  ...
  const player = (
    <div
      ...
      onDoubleClick={(event) => {
        ...
        if (
          target.closest(
            'button,[role="slider"],[data-ramzy-volume-control="true"]',
          )
        )
          return;
      ...
      style={{
        ...
        zIndex: pseudoFullscreen
          ? 2147483000
          : floatingMounted
            ? 2147482400
            : undefined,
        width: pseudoFullscreen
          ? "100vw"
          : floatingMounted
    ...
    >
          ...
          {playlistTrackCount && playlistTrackCount > 1 ? (
            ...
            >
              ...
              {playlistIndex !== undefined
                ? `${playlistIndex + 1} / ${playlistTrackCount}`
                : `${playlistTrackCount} videos`}
            </div>
          ) : (
            <div />
          )}
      ...
      {seekFeedback && (
        <div
          ...
          style={{
            position: "absolute",
            top: "50%",
            [seekFeedback.delta < 0 ? "left" : "right"]: "8%",
            ...
            backdropFilter: "blur(10px)",
            pointerEvents: "none",
            animation: "ramzySeekFeedback 420ms ease-out both",
          }}
        >
      ...
      <div
        style={{
          ...
          right: 0,
          bottom: 0,
          padding: fullscreen ? "48px 28px 22px" : "42px 18px 14px",
      ...
      >
        ...
        >
          <div
            style={{
              ...
              left: 0,
              right: 0,
              height: seeking || hoverProgress !== null ? 6 : 4,
              borderRadius: 99,
          ...
          <div
            style={{
              ...
              borderRadius: "50%",
              background: SIGNAL,
              opacity: seeking || hoverProgress !== null ? 1 : 0,
              transform: `scale(${seeking ? 1.12 : 1})`,
        ...
        >
          ...
          >
            {formatTime(currentTime)} <span style={{ opacity: 0.58 }}>/</span>{" "}
            {formatTime(duration)}
          </span>
          <div style={{ flex: 1 }} />
          {captions.length > 0 && (
            <button
              ...
              title={captionsEnabled ? "Captions off" : "Captions on"}
              style={{
                ...controlButton,
                color: captionsEnabled ? SIGNAL : "#FFFFFF",
              }}
              onClick={() => setCaptionsEnabled((value) => !value)}
            >
              <Icon name="captions" size={23} />
            </button>
          )}
