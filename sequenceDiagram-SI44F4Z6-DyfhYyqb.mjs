import { t as e } from "./dist-CBm5yHDZ.mjs";
import { An as t, Bn as n, Ct as r, Fn as i, On as a, Rn as o, St as s, Un as c, V as l, Vn as u, W as d, Wn as f, an as p, ar as m, bn as h, cn as g, cr as _, in as v, ln as y, on as b, tn as x, vn as S, wn as C, xn as w, yn as T } from "./chunk-J7OUQ5F2-BUGcDHyW.mjs";
import { a as E, c as D, i as O, n as k, r as A, s as j } from "./chunk-2GRJ4B5K-DKbJpHGI.mjs";
import { t as M } from "./chunk-2Q5K7J3B-BW0iFO2P.mjs";
...
var N = e(), P = (function() {
	var e = /* @__PURE__ */ _(function(e, t, n, r) {
		...
		return n;
	}, "o"), t = [1, 2], n = [1, 3], r = [1, 4], i = [2, 4], a = [1, 9], o = [1, 11], s = [1, 12], c = [1, 14], l = [1, 15], u = [1, 17], d = [1, 18], f = [1, 19], p = [1, 25], m = [1, 26], h = [1, 27], g = [1, 28], v = [1, 29], y = [1, 30], b = [1, 31], x = [1, 32], S = [1, 33], C = [1, 34], w = [1, 35], T = [1, 36], E = [1, 37], D = [1, 38], O = [1, 39], k = [1, 40], A = [1, 42], j = [1, 43], M = [1, 44], N = [1, 45], P = [1, 46], F = [1, 47], I = [
		1,
		4,
		5,
		10,
	...
	return _(Te, "Parser"), Te.prototype = we, we.Parser = Te, new Te();
})();
P.parser = P;
var F = P, I = {
	SOLID: 0,
	...
	constructor() {
		...
		})), this.setAccTitle = u, this.setAccDescription = n, this.setDiagramTitle = f, this.getAccTitle = T, this.getAccDescription = S, this.getDiagramTitle = C, this.apply = this.apply.bind(this), this.parseBoxData = this.parseBoxData.bind(this), this.parseMessage = this.parseMessage.bind(this), this.clear(), this.setWrap(w().wrap), this.LINETYPE = I, this.ARROWTYPE = ee, this.PLACEMENT = L;
	}
	static {
		_(this, "SequenceDB");
	}
	...
	addActor(e, t, n, i, a) {
		let o = this.state.records.currentBox, c;
		if (a !== void 0) {
			let e;
			e = a.includes("\n") ? a + "\n" : "{\n" + a + "\n}", c = r(e, { schema: s });
		}
		i = c?.type ?? i, c?.alias && (!n || n.text === t) && (n = {
			text: c.alias,
			wrap: n?.wrap,
			type: i
		});
		let l = this.state.records.actors.get(e);
		if (l) {
			if (this.state.records.currentBox && l.box && this.state.records.currentBox !== l.box) throw Error(`A same participant should only be defined in one Box: ${l.name} can't be in '${l.box.name}' and in '${this.state.records.currentBox.name}' at the same time.`);
			if (o = l.box ? l.box : this.state.records.currentBox, l.box = o, l && t === l.name && n == null) return;
		}
		if (n?.text ?? (n = {
			text: t,
			type: i
		}), (i == null || n.text == null) && (n = {
			text: t,
			type: i
	...
	autoWrap() {
		return this.state.records.wrapEnabled === void 0 ? w().sequence?.wrap ?? !1 : this.state.records.wrapEnabled;
	}
	clear() {
		this.state.reset(), b();
	}
	parseMessage(e) {
		...
		return m.debug(`parseMessage: ${JSON.stringify(i)}`), i;
	}
	parseBoxData(e) {
	...
	addLinks(e, t) {
		...
		try {
			...
			m.error("error while parsing actor link text", e);
		}
	}
	addALink(e, t) {
		let n = this.getActor(e);
		try {
			let e = {}, r = o(t.text, w()), i = r.indexOf("@");
	...
	addProperties(e, t) {
		let n = this.getActor(e);
		try {
			let e = o(t.text, w()), r = JSON.parse(e);
			this.insertProperties(n, r);
		} catch (e) {
			m.error("error while parsing actor properties text", e);
		}
	}
	...
	addDetails(e, t) {
		...
		try {
			...
			m.error("error while parsing actor details text", e);
		}
	}
	...
	let t = e.dropShadow ?? "none", { look: n } = w();
	return `.actor {
...
`;
}, "getStyles"), z = 36, B = "actor-top", V = "actor-bottom", re = "actor-box", H = "actor-man", U = /* @__PURE__ */ new Set(["redux-color", "redux-dark-color"]), W = /* @__PURE__ */ _(function(e, t) {
	let n = E(e, t);
	return h().look === "neo" && n.attr("data-look", "neo"), n;
}, "drawRect"), ie = /* @__PURE__ */ _(function(e, t, n, r, i) {
...
}, "drawPopup"), ae = /* @__PURE__ */ _(function(e) {
	return "var pu = document.getElementById('" + e + "'); if (pu != null) { pu.style.display = pu.style.display == 'block' ? 'none' : 'block'; }";
}, "popupMenuToggle"), oe = /* @__PURE__ */ _(async function(e, t, n = null) {
	let r = e.append("foreignObject"), a = await i(t.text, h()), o = r.append("xhtml:div").attr("style", "width: fit-content;").attr("xmlns", "http://www.w3.org/1999/xhtml").html(a).node().getBoundingClientRect();
	...
	return [r];
}, "drawKatex"), G = /* @__PURE__ */ _(function(e, t) {
	let n = 0, r = 0, i = t.text.split(g.lineBreakRegex), [a, o] = l(t.fontSize), s = [], c = 0, u = /* @__PURE__ */ _(() => t.y, "yfunc");
	if (t.valign !== void 0 && t.textMargin !== void 0 && t.textMargin > 0) switch (t.valign) {
		case "top":
		case "start":
			u = /* @__PURE__ */ _(() => Math.round(t.y + t.textMargin), "yfunc");
			break;
		case "middle":
		case "center":
			u = /* @__PURE__ */ _(() => Math.round(t.y + (n + r + t.textMargin) / 2), "yfunc");
			break;
		case "bottom":
		case "end":
			u = /* @__PURE__ */ _(() => Math.round(t.y + (n + r + 2 * t.textMargin) - t.textMargin), "yfunc");
			break;
	}
	...
	for (let [l, d] of i.entries()) {
		t.textMargin !== void 0 && t.textMargin === 0 && a !== void 0 && (c = l * a);
		let i = e.append("text");
		i.attr("x", t.x), i.attr("y", u()), t.anchor !== void 0 && i.attr("text-anchor", t.anchor).attr("dominant-baseline", t.dominantBaseline).attr("alignment-baseline", t.alignmentBaseline), t.fontFamily !== void 0 && i.style("font-family", t.fontFamily), o !== void 0 && i.style("font-size", o), t.fontWeight !== void 0 && i.style("font-weight", t.fontWeight), t.fill !== void 0 && i.attr("fill", t.fill), t.class !== void 0 && i.attr("class", t.class), t.dy === void 0 ? c !== 0 && i.attr("dy", c) : i.attr("dy", t.dy);
		let f = d || "​";
		if (t.tspan) {
	...
	return s;
}, "drawText"), se = /* @__PURE__ */ _(function(e, t) {
...
}, "drawLabel"), K = -1, ce = /* @__PURE__ */ _((e, t, n, r) => {
...
}, "fixLifeLineHeights"), le = /* @__PURE__ */ _(function(e, n, r, i, a) {
	let o = i ? n.stopy : n.starty, s = n.x + n.width / 2, c = o + n.height, { look: l, theme: u, themeVariables: d } = r, { bkgColorArray: f, borderColorArray: p } = d, m = e.append("g").lower();
	var h = m;
	i || (K++, Object.keys(n.links || {}).length && !r.forceMenus && h.attr("onclick", ae(`actor${K}_popup`)).attr("cursor", "pointer"), h.append("line").attr("id", "actor" + K).attr("x1", s).attr("y1", c).attr("x2", s).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", n.name).attr("data-et", "life-line").attr("data-id", n.name), h = m.append("g"), n.actorCnt = K, n.links != null && h.attr("id", "root-" + K), l === "neo" && h.attr("data-look", "neo"));
	let g = j();
	var _ = "actor";
	n.properties?.class ? _ = n.properties.class : g.fill = "#eaeaea", i ? _ += ` ${V}` : _ += ` ${B}`, g.x = n.x, g.y = o, g.width = n.width, g.height = n.height, g.class = _, g.rx = 3, g.ry = 3, g.name = n.name, l === "neo" && (g.rx = 6, g.ry = 6);
	let v = W(h, g), y = a.get(n.name) ?? 0;
	if (U.has(u) && (v.style("stroke", p[y % p.length]), v.style("fill", f[y % p.length])), l === "neo" && v.attr("filter", "url(#drop-shadow)"), n.rectData = g, n.properties?.icon) {
		let e = n.properties.icon.trim();
		e.charAt(0) === "@" ? A(h, g.x + g.width - 20, g.y + 10, e.substr(1)) : O(h, g.x + g.width - 20, g.y + 10, e);
	}
	i || (h.attr("data-et", "participant"), h.attr("data-type", "participant"), h.attr("data-id", n.name)), Y(r, t(n.description))(n.description, h, g.x, g.y, g.width, g.height, { class: `actor ${re}` }, r);
	let b = n.height;
	if (v.node) {
		let e = v.node().getBBox();
		n.height = e.height, b = e.height;
	}
	return b;
}, "drawActorTypeParticipant"), ue = /* @__PURE__ */ _(function(e, n, r, i, a) {
	let o = i ? n.stopy : n.starty, s = n.x + n.width / 2, c = o + n.height, { look: l, theme: u, themeVariables: d } = r, { bkgColorArray: f, borderColorArray: p } = d, m = e.append("g").lower();
	var h = m;
	i || (K++, Object.keys(n.links || {}).length && !r.forceMenus && h.attr("onclick", ae(`actor${K}_popup`)).attr("cursor", "pointer"), h.append("line").attr("id", "actor" + K).attr("x1", s).attr("y1", c).attr("x2", s).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", n.name).attr("data-et", "life-line").attr("data-id", n.name), h = m.append("g"), n.actorCnt = K, n.links != null && h.attr("id", "root-" + K), l === "neo" && h.attr("data-look", "neo"));
	let g = j();
	var _ = "actor";
	n.properties?.class ? _ = n.properties.class : g.fill = "#eaeaea", i ? _ += ` ${V}` : _ += ` ${B}`, g.x = n.x, g.y = o, g.width = n.width, g.height = n.height, g.class = _, g.name = n.name;
	let v = {
		...g,
		x: g.x + -6,
		y: g.y + 6,
	...
	n.rectData = g, l === "neo" && h.attr("filter", "url(#drop-shadow)");
	let x = a.get(n.name) ?? 0;
	if (U.has(u) && (y.style("stroke", p[x % p.length]), y.style("fill", f[x % p.length]), b.style("stroke", p[x % p.length]), b.style("fill", f[x % p.length])), n.properties?.icon) {
		let e = n.properties.icon.trim();
		e.charAt(0) === "@" ? A(h, g.x + g.width - 20, g.y + 10, e.substr(1)) : O(h, g.x + g.width - 20, g.y + 10, e);
	}
	Y(r, t(n.description))(n.description, h, g.x - 6, g.y + 6, g.width, g.height, { class: `actor ${re}` }, r);
	let S = n.height;
	if (y.node) {
		let e = y.node().getBBox();
		n.height = e.height, S = e.height;
	}
	return i || (h.attr("data-et", "participant"), h.attr("data-type", "collections"), h.attr("data-id", n.name)), S;
}, "drawActorTypeCollections"), de = /* @__PURE__ */ _(function(e, n, r, i, a) {
	let o = i ? n.stopy : n.starty, s = n.x + n.width / 2, c = o + n.height, { look: l, theme: u, themeVariables: d } = r, { bkgColorArray: f, borderColorArray: p } = d, m = e.append("g").lower(), h = m;
	i || (K++, Object.keys(n.links || {}).length && !r.forceMenus && h.attr("onclick", ae(`actor${K}_popup`)).attr("cursor", "pointer"), h.append("line").attr("id", "actor" + K).attr("x1", s).attr("y1", c).attr("x2", s).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", n.name).attr("data-et", "life-line").attr("data-id", n.name), h = m.append("g"), n.actorCnt = K, n.links != null && h.attr("id", "root-" + K), l === "neo" && h.attr("data-look", "neo"));
	let g = j(), _ = "actor";
	n.properties?.class ? _ = n.properties.class : g.fill = "#eaeaea", i ? _ += ` ${V}` : _ += ` ${B}`, h.attr("class", _), g.x = n.x, g.y = o, g.width = n.width, g.height = n.height, g.name = n.name;
  ...
  `;
	b.append("path").attr("d", S), x.append("path").attr("d", `M ${g.x},${g.y + v}
      a ${y},${v} 0 0 0 0,${g.height}`), b.attr("transform", `translate(${y}, ${-(g.height / 2)})`), x.attr("transform", `translate(${g.width - y}, ${-g.height / 2})`), n.rectData = g, l === "neo" && b.attr("filter", "url(#drop-shadow)");
	let C = a.get(n.name) ?? 0;
	if (U.has(u) && (b.style("stroke", p[C % p.length]), b.style("fill", f[C % p.length]), x.style("stroke", p[C % p.length]), x.style("fill", f[C % p.length])), n.properties?.icon) {
		let e = n.properties.icon.trim(), t = g.x + g.width - 20, r = g.y + 10;
		e.charAt(0) === "@" ? A(h, t, r, e.substr(1)) : O(h, t, r, e);
	}
	Y(r, t(n.description))(n.description, h, g.x, g.y, g.width, g.height, { class: `actor ${re}` }, r);
	let w = n.height, T = b.select("path:last-child");
	if (T.node()) {
		let e = T.node().getBBox();
		n.height = e.height, w = e.height;
	}
	return i || (h.attr("data-et", "participant"), h.attr("data-type", "queue"), h.attr("data-id", n.name)), w;
}, "drawActorTypeQueue"), fe = /* @__PURE__ */ _(function(e, n, r, i, a, o) {
	let s = i ? n.stopy : n.starty, c = n.x + n.width / 2, l = s + 75, { look: u, theme: d, themeVariables: f } = r, { bkgColorArray: p, borderColorArray: m, actorBorder: h, actorBkg: g } = f, _ = e.append("g").lower();
	i || (K++, _.append("line").attr("id", "actor" + K).attr("x1", c).attr("y1", l).attr("x2", c).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", n.name).attr("data-et", "life-line").attr("data-id", n.name), n.actorCnt = K);
	let v = e.append("g"), y = H;
	i ? y += ` ${V}` : y += ` ${B}`, v.attr("class", y), v.attr("name", n.name);
	let b = j();
	b.x = n.x, b.y = s, b.fill = "#eaeaea", b.width = n.width, b.height = n.height, b.class = "actor";
	let x = n.x + n.width / 2, S = s + 32;
	...
	let C = o.get(n.name) ?? 0;
	return U.has(d) ? (v.style("stroke", m[C % m.length]), v.style("fill", p[C % m.length])) : (v.style("stroke", h), v.style("fill", g)), n.height = v.node().getBBox().height + 2 * (r?.sequence?.labelBoxHeight ?? 0), Y(r, t(n.description))(n.description, v, b.x, b.y + 22 + (i ? 5 : 12), b.width, b.height, { class: `actor ${H}` }, r), i || (v.attr("data-et", "participant"), v.attr("data-type", "control"), v.attr("data-id", n.name)), n.height;
}, "drawActorTypeControl"), pe = /* @__PURE__ */ _(function(e, n, r, i, a) {
	let o = i ? n.stopy : n.starty, s = n.x + n.width / 2, c = o + 75, { look: l, theme: u, themeVariables: d } = r, { bkgColorArray: f, borderColorArray: p } = d, m = e.append("g").lower(), h = e.append("g"), g = "actor";
	i ? g += ` ${V}` : g += ` ${B}`, h.attr("class", g), h.attr("name", n.name);
	let _ = j();
	_.x = n.x, _.y = o, _.fill = "#eaeaea", _.width = n.width, _.height = n.height, _.class = "actor";
	let v = n.x + n.width / 2, y = o + (i ? 10 : 25);
	h.append("circle").attr("cx", v).attr("cy", y).attr("r", 22).attr("width", n.width).attr("height", n.height), h.append("line").attr("x1", v - 22).attr("x2", v + 22).attr("y1", y + 22).attr("y2", y + 22).attr("stroke-width", 2), l === "neo" && h.attr("filter", "url(#drop-shadow)");
	let b = a.get(n.name) ?? 0;
	return U.has(u) && (h.style("stroke", p[b % p.length]), h.style("fill", f[b % p.length])), n.height = h.node().getBBox().height + (r?.sequence?.labelBoxHeight ?? 0), i || (K++, m.append("line").attr("id", "actor" + K).attr("x1", s).attr("y1", c).attr("x2", s).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", n.name).attr("data-et", "life-line").attr("data-id", n.name), n.actorCnt = K), Y(r, t(n.description))(n.description, h, _.x, _.y + (i ? 15 : 30), _.width, _.height, { class: `actor ${H}` }, r), i ? h.attr("transform", "translate(0, 22)") : (h.attr("transform", `translate(0, ${22 / 2 - 5})`), h.attr("data-et", "participant"), h.attr("data-type", "entity"), h.attr("data-id", n.name)), n.height;
}, "drawActorTypeEntity"), me = /* @__PURE__ */ _(function(e, n, r, i, a) {
	let o = i ? n.stopy : n.starty, s = n.x + n.width / 2, c = o + n.height + 2 * r.boxTextMargin, { theme: l, themeVariables: u, look: d } = r, { bkgColorArray: f, borderColorArray: p, actorBorder: m } = u, h = e.append("g").lower(), g = h;
	i || (K++, Object.keys(n.links || {}).length && !r.forceMenus && g.attr("onclick", ae(`actor${K}_popup`)).attr("cursor", "pointer"), g.append("line").attr("id", "actor" + K).attr("x1", s).attr("y1", c).attr("x2", s).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", n.name).attr("data-et", "life-line").attr("data-id", n.name), g = h.append("g"), n.actorCnt = K, n.links != null && g.attr("id", "root-" + K), d === "neo" && g.attr("data-look", "neo"));
	let _ = j(), v = "actor";
	n.properties?.class ? v = n.properties.class : _.fill = "#eaeaea", i ? v += ` ${V}` : v += ` ${B}`, _.x = n.x, _.y = o, _.width = n.width, _.height = n.height, _.class = v, _.name = n.name, _.x = n.x, _.y = o;
...
`;
	...
	let T = a.get(n.name) ?? 0;
	U.has(l) ? (C.style("stroke", p[T % p.length]), C.style("fill", f[T % p.length])) : C.style("stroke", m), C.attr("transform", `translate(${y}, ${S})`), n.rectData = _, Y(r, t(n.description))(n.description, g, _.x, _.y + 35, _.width, _.height, { class: `actor ${re}` }, r);
	let E = C.select("path:last-child");
	return E.node() && (n.height = E.node().getBBox().height + (r.sequence.labelBoxHeight ?? 0)), i || (g.attr("data-et", "participant"), g.attr("data-type", "database"), g.attr("data-id", n.name)), n.height;
}, "drawActorTypeDatabase"), he = /* @__PURE__ */ _(function(e, n, r, i, a) {
	let o = i ? n.stopy : n.starty, s = n.x + n.width / 2, c = o + 80, l = e.append("g").lower(), { look: u, theme: d, themeVariables: f } = r, { bkgColorArray: p, borderColorArray: m, actorBorder: h } = f;
	i || (K++, l.append("line").attr("id", "actor" + K).attr("x1", s).attr("y1", c).attr("x2", s).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", n.name).attr("data-et", "life-line").attr("data-id", n.name), n.actorCnt = K);
	let g = e.append("g"), _ = H;
	i ? _ += ` ${V}` : _ += ` ${B}`, g.attr("class", _), g.attr("name", n.name);
	let v = j();
	v.x = n.x, v.y = o, v.fill = "#eaeaea", v.width = n.width, v.height = n.height, v.class = "actor", g.append("line").attr("id", "actor-man-torso" + K).attr("x1", n.x + n.width / 2 - 22 * 2.5).attr("y1", o + 12).attr("x2", n.x + n.width / 2 - 15).attr("y2", o + 12), g.append("line").attr("id", "actor-man-arms" + K).attr("x1", n.x + n.width / 2 - 22 * 2.5).attr("y1", o + 2).attr("x2", n.x + n.width / 2 - 22 * 2.5).attr("y2", o + 22), g.append("circle").attr("cx", n.x + n.width / 2).attr("cy", o + 12).attr("r", 22), u === "neo" && g.attr("filter", "url(#drop-shadow)");
	let y = a.get(n.name) ?? 0;
	return U.has(d) ? (g.style("stroke", m[y % m.length]), g.style("fill", p[y % m.length])) : g.style("stroke", h), n.height = g.node().getBBox().height + (r.sequence.labelBoxHeight ?? 0), Y(r, t(n.description))(n.description, g, v.x, v.y + 15, v.width, v.height, { class: `actor ${H}` }, r), g.attr("transform", "translate(0,21)"), i || (g.attr("data-et", "participant"), g.attr("data-type", "boundary"), g.attr("data-id", n.name)), n.height;
}, "drawActorTypeBoundary"), ge = /* @__PURE__ */ _(function(e, n, r, i, a) {
	let o = i ? n.stopy : n.starty, s = n.x + n.width / 2, c = o + 80, { look: l, theme: u, themeVariables: d } = r, { bkgColorArray: f, borderColorArray: p, actorBorder: m } = d, h = e.append("g").lower();
	i || (K++, h.append("line").attr("id", "actor" + K).attr("x1", s).attr("y1", c).attr("x2", s).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", n.name).attr("data-et", "life-line").attr("data-id", n.name), n.actorCnt = K);
	let g = e.append("g"), _ = H;
	i ? _ += ` ${V}` : _ += ` ${B}`, g.attr("class", _), g.attr("name", n.name), i || g.attr("data-et", "participant").attr("data-type", "actor").attr("data-id", n.name);
	...
	b.attr("cx", n.x + n.width / 2), b.attr("cy", y + 10 * v), b.attr("r", 15 * v), b.attr("width", n.width * v), b.attr("height", n.height * v), n.height = g.node().getBBox().height;
	let x = j();
	x.x = n.x, x.y = y, x.fill = "#eaeaea", x.width = n.width, x.height = n.height / v, x.class = "actor", x.rx = 3, x.ry = 3;
	let S = a.get(n.name) ?? 0;
	return U.has(u) ? (g.style("stroke", p[S % p.length]), g.style("fill", f[S % p.length])) : g.style("stroke", m), Y(r, t(n.description))(n.description, g, x.x, y + 35 * v - (l === "neo" ? 10 : 0), x.width, x.height, { class: `actor ${H}` }, r), n.height;
}, "drawActorTypeActor"), _e = /* @__PURE__ */ _(async function(e, t, n, r, i, a, o) {
...
}, "drawActor"), ve = /* @__PURE__ */ _(function(e, t, n) {
	let r = e.append("g");
	Se(r, t), t.name && Y(n)(t.name, r, t.x, t.y + n.boxTextMargin + (t.textMaxHeight || 0) / 2, t.width, 0, { class: "text" }, n), r.lower();
}, "drawBox"), ye = /* @__PURE__ */ _(function(e) {
	return e.append("g");
}, "anchorElement"), be = /* @__PURE__ */ _(function(e, t, n, r, i, a, o) {
...
}, "drawActivation"), xe = /* @__PURE__ */ _(async function(e, n, r, i, a) {
	let { boxMargin: o, boxTextMargin: s, labelBoxHeight: c, labelBoxWidth: l, messageFontFamily: u, messageFontSize: d, messageFontWeight: f } = i, p = e.append("g").attr("data-et", "control-structure").attr("data-id", "i" + a.id), m = /* @__PURE__ */ _(function(e, t, n, r) {
	...
	let h = D();
	h.text = r, h.x = n.startx, h.y = n.starty, h.fontFamily = u, h.fontSize = d, h.fontWeight = f, h.anchor = "middle", h.valign = "middle", h.tspan = !1, h.width = Math.max(l ?? 0, 50), h.height = c + (i.look === "neo" ? 15 : 0) || 20, h.textMargin = s, h.class = "labelText", se(p, h), h = ke(), h.text = n.title, h.x = n.startx + l / 2 + (n.stopx - n.startx) / 2, h.y = n.starty + o + s, h.anchor = "middle", h.valign = "middle", h.textMargin = s, h.class = "loopText", h.fontFamily = u, h.fontSize = d, h.fontWeight = f, h.wrap = !0;
	let g = t(h.text) ? await oe(p, h, n) : G(p, h);
	if (n.sectionTitles !== void 0) {
		for (let [e, r] of Object.entries(n.sectionTitles)) if (r.message) {
			h.text = r.message, h.x = n.startx + (n.stopx - n.startx) / 2, h.y = n.sections[e].y + o + s, h.class = "sectionTitle", h.anchor = "middle", h.valign = "middle", h.tspan = !1, h.fontFamily = u, h.fontSize = d, h.fontWeight = f, h.wrap = n.wrap, t(h.text) ? (n.starty = n.sections[e].y, await oe(p, h, n)) : G(p, h);
			let i = Math.round(g.map((e) => (e._groups || e)[0][0].getBBox().height).reduce((e, t) => e + t));
			n.sections[e].height += i - (o + s);
		}
	}
	return n.height = Math.round(n.stopy - n.starty), p;
}, "drawLoop"), Se = /* @__PURE__ */ _(function(e, t) {
	k(e, t);
}, "drawBackgroundRect"), Ce = /* @__PURE__ */ _(function(e, t) {
...
}, "insertDatabaseIcon"), q = /* @__PURE__ */ _(function(e, t) {
...
}, "insertComputerIcon"), J = /* @__PURE__ */ _(function(e, t) {
...
}, "insertClockIcon"), we = /* @__PURE__ */ _(function(e, t) {
...
}, "insertArrowHead"), Te = /* @__PURE__ */ _(function(e, t) {
...
}, "insertArrowFilledHead"), Ee = /* @__PURE__ */ _(function(e, t) {
...
}, "insertSequenceNumber"), De = /* @__PURE__ */ _(function(e, t) {
...
}, "insertArrowCrossHead"), Oe = /* @__PURE__ */ _(function(e, t) {
	let { theme: n } = t;
...
}, "insertDropShadow"), ke = /* @__PURE__ */ _(function() {
	return {
		x: 0,
		y: 0,
		fill: void 0,
...
}, "getTextObj"), Ae = /* @__PURE__ */ _(function() {
	return {
		x: 0,
		y: 0,
		fill: "#EDF2AE",
	...
	function t(e, t, n, r, i, o, s, c) {
		let { actorFontSize: u, actorFontFamily: d, actorFontWeight: f } = c, [p, m] = l(u), h = e.split(g.lineBreakRegex);
		for (let e = 0; e < h.length; e++) {
			let c = e * p - p * (h.length - 1) / 2, l = t.append("text").attr("x", n + i / 2).attr("y", r).style("text-anchor", "middle").style("font-size", m).style("font-weight", f).style("font-family", d);
			l.append("tspan").attr("x", n + i / 2).attr("dy", c).text(h[e]), l.attr("y", r + o / 2).attr("dominant-baseline", "central").attr("alignment-baseline", "central"), a(l, s);
		}
	}
	_(t, "byTspan");
	...
	async function r(e, n, r, o, s, c, l, u) {
		let d = await p(e, h()), f = n.append("switch"), m = f.append("foreignObject").attr("x", r + s / 2 - d.width / 2).attr("y", o + c / 2 - d.height / 2).attr("width", d.width).attr("height", d.height).append("xhtml:div").style("height", "100%").style("width", "100%");
		m.append("div").style("text-align", "center").style("vertical-align", "middle").html(await i(e, h())), t(e, f, r, o, s, c, l, u), a(m, l);
	}
	_(r, "byKatex");
	function a(e, t) {
		for (let n in t) t.hasOwnProperty(n) && e.attr(n, t[n]);
	}
	return _(a, "_setTextAttrs"), function(i, a = !1) {
	...
	function t(e, t, n, i, a, o, s, c) {
		let { actorFontSize: l, actorFontFamily: u, actorFontWeight: d } = c, f = e.split(g.lineBreakRegex);
	...
	return _(r, "_setTextAttrs"), function(r) {
	...
	insertDropShadow: Oe,
	insertSolidTopArrowHead: /* @__PURE__ */ _(function(e, t) {
	...
	insertSolidBottomArrowHead: /* @__PURE__ */ _(function(e, t) {
	...
	insertStickTopArrowHead: /* @__PURE__ */ _(function(e, t) {
	...
	insertStickBottomArrowHead: /* @__PURE__ */ _(function(e, t) {
	...
	init: /* @__PURE__ */ _(function() {
		this.sequenceItems = [], this.activations = [], this.models.clear(), this.data = {
			...
			starty: void 0,
			stopy: void 0
		}, this.verticalPos = 0, He(w());
	}, "init"),
	updateVal: /* @__PURE__ */ _(function(e, t, n, r) {
		e[t] === void 0 ? e[t] = n : e[t] = r(n, e[t]);
	}, "updateVal"),
	updateBounds: /* @__PURE__ */ _(function(e, t, n, r) {
		let i = this, a = 0;
		function o(o) {
			return /* @__PURE__ */ _(function(s) {
				a++;
	...
	insert: /* @__PURE__ */ _(function(e, t, n, r) {
		let i = g.getMin(e, n), a = g.getMax(e, n), o = g.getMin(t, r), s = g.getMax(t, r);
	...
	newActivation: /* @__PURE__ */ _(function(e, t, n) {
	...
	createLoop: /* @__PURE__ */ _(function(e = {
		message: void 0,
		wrap: !1,
		width: void 0
	}, t) {
	...
	bumpVerticalPos: /* @__PURE__ */ _(function(e) {
		this.verticalPos += e, this.data.stopy = g.getMax(this.data.stopy, this.verticalPos);
	}, "bumpVerticalPos"),
...
}, Me = /* @__PURE__ */ _(async function(e, n, r) {
	Q.bumpVerticalPos(Z.boxMargin), n.height = Z.boxMargin, n.starty = Q.getVerticalPos();
	let i = j();
	i.x = n.startx, i.y = n.starty, i.width = n.width || Z.width, i.class = "note";
	let a = e.append("g");
	a.attr("data-et", "note"), a.attr("data-id", "i" + r);
	let o = X.drawRect(a, i), s = D();
	s.x = n.startx, s.y = n.starty, s.width = i.width, s.dy = "1em", s.text = n.message, s.class = "noteText", s.fontFamily = Z.noteFontFamily, s.fontSize = Z.noteFontSize, s.fontWeight = Z.noteFontWeight, s.anchor = Z.noteAlign, s.textMargin = Z.noteMargin, s.valign = "center";
	let c = t(s.text) ? await oe(a, s) : G(a, s), l = Math.round(c.map((e) => (e._groups || e)[0][0].getBBox().height).reduce((e, t) => e + t));
	o.attr("height", l + 2 * Z.noteMargin), n.height += l + 2 * Z.noteMargin, Q.bumpVerticalPos(l + 2 * Z.noteMargin), n.stopy = n.starty + l + 2 * Z.noteMargin, n.stopx = n.startx + i.width, Q.insert(n.startx, n.starty, n.stopx, n.stopy), Q.models.addNote(n);
}, "drawNote"), Ne = /* @__PURE__ */ _(function(e, t, n, r, i, a, o) {
	let s = r.db.getActors(), c = s.get(t.from), l = s.get(t.to), u = n.sequenceVisible, d = c.x + c.width / 2, f = l.x + l.width / 2, p = d <= f, m = tt(t, r), h = e.append("g"), g = /* @__PURE__ */ _((e, t) => {
		let n = e ? 16.5 : -16.5;
		return t ? -n : n;
	}, "getCircleOffset"), v = /* @__PURE__ */ _((e) => {
		h.append("circle").attr("cx", e).attr("cy", o).attr("r", 5).attr("width", 10).attr("height", 10);
	}, "drawCircle"), { CENTRAL_CONNECTION: y, CENTRAL_CONNECTION_REVERSE: b, CENTRAL_CONNECTION_DUAL: x } = r.db.LINETYPE;
...
async function Le(e, n) {
	...
	let { startx: r, stopx: i, message: a } = n, o = g.splitBreaks(a).length, s = t(a), c = s ? await p(a, w()) : d.calculateTextDimensions(a, Pe(Z));
	if (!s) {
		let e = c.height / o;
		n.height += e, Q.bumpVerticalPos(e);
	}
	let l, u = c.height - 10, f = c.width;
	if (r === i) {
		l = Q.getVerticalPos() + u, Z.rightAngles || (u += Z.boxMargin, l = Q.getVerticalPos() + u), u += 30;
		let e = g.getMax(f / 2, Z.width / 2);
		Q.insert(r - e, Q.getVerticalPos() - 10 + u, i + e, Q.getVerticalPos() + 30 + u);
	} else u += Z.boxMargin, l = Q.getVerticalPos() + u, Q.insert(r, l - 10, i, l);
	return Q.bumpVerticalPos(u), n.height += u, n.stopy = n.starty + n.height, Q.insert(n.fromBounds, n.starty, n.toBounds, n.stopy), l;
}
_(Le, "boundMessage");
var Re = /* @__PURE__ */ _(async function(e, n, r, i, o, s) {
	let { startx: c, stopx: l, starty: u, message: f, type: p, sequenceIndex: m, sequenceVisible: h } = n, _ = d.calculateTextDimensions(f, Pe(Z)), v = D();
	v.x = Math.min(c, l), v.y = u + 10, v.width = Math.abs(l - c), v.class = "messageText", v.dy = "1em", v.text = f, v.fontFamily = Z.messageFontFamily, v.fontSize = Z.messageFontSize, v.fontWeight = Z.messageFontWeight, v.anchor = Z.messageAlign, v.valign = "center", v.textMargin = Z.wrapPadding, v.tspan = !1, t(v.text) ? await oe(e, v, {
		startx: c,
		stopx: l,
		starty: r
	}) : G(e, v);
	let y = _.width, b;
	if (c === l) {
		let t = h || Z.showSequenceNumbers, a = tt(o, i), s = nt(o, i), u = c + (t && (a || s) ? 10 : 0);
		b = Z.rightAngles ? e.append("path").attr("d", `M  ${u},${r} H ${c + g.getMax(Z.width / 2, y / 2)} V ${r + 25} H ${c}`) : e.append("path").attr("d", "M " + u + "," + r + " C " + (u + 60) + "," + (r - 10) + " " + (c + 60) + "," + (r + 30) + " " + c + "," + (r + 20)), $e(o, i) && Ne(e, o, n, i, c, l, r);
	} else b = e.append("line"), b.attr("x1", c), b.attr("y1", r), b.attr("x2", l), b.attr("y2", r), $e(o, i) && Ne(e, o, n, i, c, l, r);
	p === i.db.LINETYPE.DOTTED || p === i.db.LINETYPE.DOTTED_CROSS || p === i.db.LINETYPE.DOTTED_POINT || p === i.db.LINETYPE.DOTTED_OPEN || p === i.db.LINETYPE.BIDIRECTIONAL_DOTTED || p === i.db.LINETYPE.SOLID_TOP_DOTTED || p === i.db.LINETYPE.SOLID_BOTTOM_DOTTED || p === i.db.LINETYPE.STICK_TOP_DOTTED || p === i.db.LINETYPE.STICK_BOTTOM_DOTTED || p === i.db.LINETYPE.SOLID_ARROW_TOP_REVERSE_DOTTED || p === i.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE_DOTTED || p === i.db.LINETYPE.STICK_ARROW_TOP_REVERSE_DOTTED || p === i.db.LINETYPE.STICK_ARROW_BOTTOM_REVERSE_DOTTED ? (b.style("stroke-dasharray", "3, 3"), b.attr("class", "messageLine1")) : b.attr("class", "messageLine0"), b.attr("data-et", "message"), b.attr("data-id", "i" + n.id), b.attr("data-from", n.from), b.attr("data-to", n.to);
	let x = "";
	if (Z.arrowMarkerAbsolute && (x = a(!0)), b.attr("stroke-width", 2), b.attr("stroke", "none"), b.style("fill", "none"), (p === i.db.LINETYPE.SOLID_TOP || p === i.db.LINETYPE.SOLID_TOP_DOTTED) && b.attr("marker-end", "url(" + x + "#" + s + "-solidTopArrowHead)"), (p === i.db.LINETYPE.SOLID_BOTTOM || p === i.db.LINETYPE.SOLID_BOTTOM_DOTTED) && b.attr("marker-end", "url(" + x + "#" + s + "-solidBottomArrowHead)"), (p === i.db.LINETYPE.STICK_TOP || p === i.db.LINETYPE.STICK_TOP_DOTTED) && b.attr("marker-end", "url(" + x + "#" + s + "-stickTopArrowHead)"), (p === i.db.LINETYPE.STICK_BOTTOM || p === i.db.LINETYPE.STICK_BOTTOM_DOTTED) && b.attr("marker-end", "url(" + x + "#" + s + "-stickBottomArrowHead)"), (p === i.db.LINETYPE.SOLID_ARROW_TOP_REVERSE || p === i.db.LINETYPE.SOLID_ARROW_TOP_REVERSE_DOTTED) && b.attr("marker-start", "url(" + x + "#" + s + "-solidBottomArrowHead)"), (p === i.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE || p === i.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE_DOTTED) && b.attr("marker-start", "url(" + x + "#" + s + "-solidTopArrowHead)"), (p === i.db.LINETYPE.STICK_ARROW_TOP_REVERSE || p === i.db.LINETYPE.STICK_ARROW_TOP_REVERSE_DOTTED) && b.attr("marker-start", "url(" + x + "#" + s + "-stickBottomArrowHead)"), (p === i.db.LINETYPE.STICK_ARROW_BOTTOM_REVERSE || p === i.db.LINETYPE.STICK_ARROW_BOTTOM_REVERSE_DOTTED) && b.attr("marker-start", "url(" + x + "#" + s + "-stickTopArrowHead)"), (p === i.db.LINETYPE.SOLID || p === i.db.LINETYPE.DOTTED) && b.attr("marker-end", "url(" + x + "#" + s + "-arrowhead)"), (p === i.db.LINETYPE.BIDIRECTIONAL_SOLID || p === i.db.LINETYPE.BIDIRECTIONAL_DOTTED) && (b.attr("marker-start", "url(" + x + "#" + s + "-arrowhead)"), b.attr("marker-end", "url(" + x + "#" + s + "-arrowhead)")), (p === i.db.LINETYPE.SOLID_POINT || p === i.db.LINETYPE.DOTTED_POINT) && b.attr("marker-end", "url(" + x + "#" + s + "-filled-head)"), (p === i.db.LINETYPE.SOLID_CROSS || p === i.db.LINETYPE.DOTTED_CROSS) && b.attr("marker-end", "url(" + x + "#" + s + "-crosshead)"), h || Z.showSequenceNumbers) {
		let t = p === i.db.LINETYPE.BIDIRECTIONAL_SOLID || p === i.db.LINETYPE.BIDIRECTIONAL_DOTTED, a = p === i.db.LINETYPE.SOLID_ARROW_TOP_REVERSE || p === i.db.LINETYPE.SOLID_ARROW_TOP_REVERSE_DOTTED || p === i.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE || p === i.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE_DOTTED || p === i.db.LINETYPE.STICK_ARROW_TOP_REVERSE || p === i.db.LINETYPE.STICK_ARROW_TOP_REVERSE_DOTTED || p === i.db.LINETYPE.STICK_ARROW_BOTTOM_REVERSE || p === i.db.LINETYPE.STICK_ARROW_BOTTOM_REVERSE_DOTTED, u = $e(o, i), d = c, f = l;
		t ? (c < l ? d = c + 12 : (d = c - 6 + (u ? -5 : 0), d += o?.centralConnection === i.db.LINETYPE.CENTRAL_CONNECTION_DUAL || o?.centralConnection === i.db.LINETYPE.CENTRAL_CONNECTION_REVERSE ? -7.5 : 0), b.attr("x1", d)) : a ? (l > c ? f = l - 12 : (f = l - 6, d += o?.centralConnection === i.db.LINETYPE.CENTRAL_CONNECTION_DUAL || o?.centralConnection === i.db.LINETYPE.CENTRAL_CONNECTION_REVERSE ? -7.5 : 0), f += u ? 15 : 0, b.attr("x2", f), b.attr("x1", d)) : b.attr("x1", c + 6);
		let h = 0, g = c === l, _ = c <= l;
		h = g ? n.fromBounds + 1 : a ? _ ? n.toBounds - 1 : n.fromBounds + 1 : _ ? n.fromBounds + 1 : n.toBounds - 1;
		let v = "12px", y = m.toString().length;
		y > 5 ? v = "7px" : y > 3 && (v = "9px"), e.append("line").attr("x1", h).attr("y1", r).attr("x2", h).attr("y2", r).attr("stroke-width", 0).attr("marker-start", "url(" + x + "#" + s + "-sequencenumber)"), e.append("text").attr("x", h).attr("y", r + 4).attr("font-family", "sans-serif").attr("font-size", v).attr("text-anchor", "middle").attr("class", "sequenceNumber").text(m);
	}
}, "drawMessage"), ze = /* @__PURE__ */ _(function(e, t, n, r, i, a, o) {
	let s = 0, c = 0, l, u = 0;
	for (let e of r) {
...
}, "addActorRenderingData"), Be = /* @__PURE__ */ _(async function(e, t, n, r, i, a, o) {
	if (r) {
		let r = 0;
...
}, "drawActors"), Ve = /* @__PURE__ */ _(function(e, t, n, r) {
	let i = 0, a = 0;
	for (let o of n) {
	...
	v(Z, e), e.fontFamily && (Z.actorFontFamily = Z.noteFontFamily = Z.messageFontFamily = e.fontFamily), e.fontSize && (Z.actorFontSize = Z.noteFontSize = Z.messageFontSize = e.fontSize), e.fontWeight && (Z.actorFontWeight = Z.noteFontWeight = Z.messageFontWeight = e.fontWeight);
}, "setConf"), Ue = /* @__PURE__ */ _(function(e) {
	return Q.activations.filter(function(t) {
		return t.actor === e;
	});
}, "actorActivations"), We = /* @__PURE__ */ _(function(e, t) {
	let n = t.get(e), r = Ue(e);
	return [r.reduce(function(e, t) {
		return g.getMin(e, t.startx);
	}, n.x + n.width / 2 - 1), r.reduce(function(e, t) {
		return g.getMax(e, t.stopx);
	}, n.x + n.width / 2 + 1)];
}, "activationBounds");
function $(e, t, n, r, i) {
	Q.bumpVerticalPos(n);
	...
	if (t.id && t.message && e[t.id]) {
		...
		t.message = d.wrapLabel(`[${t.message}]`, n - 2 * Z.wrapPadding, i), t.width = n, t.wrap = !0;
		let o = d.calculateTextDimensions(t.message, i), s = g.getMax(o.height, Z.labelBoxHeight);
		a = r + s, m.debug(`${s} - ${t.message}`);
	}
	i(t), Q.bumpVerticalPos(a);
}
_($, "adjustLoopHeightForWrap");
...
_(Ge, "adjustCreatedDestroyedData");
var Ke = /* @__PURE__ */ _(async function(e, t, n, r) {
	let { securityLevel: i, sequence: a, look: o, themeVariables: s } = w();
	Z = a;
	let c;
	i === "sandbox" && (c = x("#i" + t));
	let l = x(i === "sandbox" ? c.nodes()[0].contentDocument.body : "body"), u = i === "sandbox" ? c.nodes()[0].contentDocument : document;
	Q.init(), m.debug(r.db);
	let d = i === "sandbox" ? l.select(`[id="${t}"]`) : x(`[id="${t}"]`), f = r.db.getActors(), p = r.db.getCreatedActors(), h = r.db.getDestroyedActors(), g = r.db.getBoxes(), v = r.db.getActorKeys(), b = r.db.getMessages(), S = r.db.getDiagramTitle(), C = r.db.hasAtLeastOneBox(), T = r.db.hasAtLeastOneBoxWithTitle(), E = await qe(f, b, r);
	if (Z.height = await Ye(f, E, g), X.insertComputerIcon(d, t), X.insertDatabaseIcon(d, t), X.insertClockIcon(d, t), C && (Q.bumpVerticalPos(Z.boxMargin), T && Q.bumpVerticalPos(g[0].textMaxHeight)), Z.hideUnusedParticipants === !0) {
		let e = /* @__PURE__ */ new Set();
		b.forEach((t) => {
			e.add(t.from), e.add(t.to);
		}), v = v.filter((t) => e.has(t));
	}
	let D = new Map(v.map((e, t) => [f.get(e)?.name ?? e, t]));
	ze(d, f, p, v, 0, b, !1);
	let O = await it(b, f, E, r);
	X.insertArrowHead(d, t), X.insertArrowCrossHead(d, t), X.insertArrowFilledHead(d, t), X.insertSequenceNumber(d, t), X.insertSolidTopArrowHead(d, t), X.insertSolidBottomArrowHead(d, t), X.insertStickTopArrowHead(d, t), X.insertStickBottomArrowHead(d, t), o === "neo" && X.insertDropShadow(d, Z);
	function k(e, t) {
		let n = Q.endActivation(e);
		n.starty + 18 > t && (n.starty = t - 6, t += 12), X.drawActivation(d, n, t, Z, Ue(e.from).length, r, D), Q.insert(n.startx, t - 10, n.stopx, t);
	}
	_(k, "activeEnd");
	let A = 1, j = 1, M = [], N = [], P = 0;
	for (let e of b) {
		...
		switch (e.type) {
			case r.db.LINETYPE.NOTE:
				Q.resetVerticalPos(), n = e.noteModel, await Me(d, n, e.id);
				break;
			case r.db.LINETYPE.ACTIVE_START:
				Q.newActivation(e, d, f);
				break;
			...
			case r.db.LINETYPE.LOOP_END:
				t = Q.endLoop(), await X.drawLoop(d, t, "loop", Z, e), Q.bumpVerticalPos(t.stopy - Q.getVerticalPos()), Q.models.addLoop(t);
				break;
			case r.db.LINETYPE.RECT_START:
				$(O, e, Z.boxMargin, Z.boxMargin, (e) => {
					let t = e.message;
					t ||= s?.rectBkgColor || s?.actorBkg || "rgba(128, 128, 128, 0.5)", Q.newLoop(void 0, t);
				});
				break;
			case r.db.LINETYPE.RECT_END:
				t = Q.endLoop(), N.push(t), Q.models.addLoop(t), Q.bumpVerticalPos(t.stopy - Q.getVerticalPos());
				break;
			case r.db.LINETYPE.OPT_START:
				$(O, e, Z.boxMargin, Z.boxMargin + Z.boxTextMargin, (e) => Q.newLoop(e));
				break;
			case r.db.LINETYPE.OPT_END:
				t = Q.endLoop(), await X.drawLoop(d, t, "opt", Z, e), Q.bumpVerticalPos(t.stopy - Q.getVerticalPos()), Q.models.addLoop(t);
				break;
			...
			case r.db.LINETYPE.ALT_END:
				t = Q.endLoop(), await X.drawLoop(d, t, "alt", Z, e), Q.bumpVerticalPos(t.stopy - Q.getVerticalPos()), Q.models.addLoop(t);
				break;
			...
			case r.db.LINETYPE.PAR_END:
				t = Q.endLoop(), await X.drawLoop(d, t, "par", Z, e), Q.bumpVerticalPos(t.stopy - Q.getVerticalPos()), Q.models.addLoop(t);
				break;
			case r.db.LINETYPE.AUTONUMBER:
				A = e.message.start || A, j = e.message.step || j, e.message.visible ? r.db.enableSequenceNumbers() : r.db.disableSequenceNumbers();
				break;
			...
			case r.db.LINETYPE.CRITICAL_END:
				t = Q.endLoop(), await X.drawLoop(d, t, "critical", Z, e), Q.bumpVerticalPos(t.stopy - Q.getVerticalPos()), Q.models.addLoop(t);
				break;
			case r.db.LINETYPE.BREAK_START:
				$(O, e, Z.boxMargin, Z.boxMargin + Z.boxTextMargin, (e) => Q.newLoop(e));
				break;
			case r.db.LINETYPE.BREAK_END:
				t = Q.endLoop(), await X.drawLoop(d, t, "break", Z, e), Q.bumpVerticalPos(t.stopy - Q.getVerticalPos()), Q.models.addLoop(t);
				break;
			default: try {
				i = e.msgModel, i.starty = Q.getVerticalPos(), i.sequenceIndex = A, i.sequenceVisible = r.db.showSequenceNumbers(), i.id = e.id, i.from = e.from, i.to = e.to;
				let t = await Le(d, i);
				Ge(e, i, t, P, f, p, h), M.push({
					messageModel: i,
					lineStartY: t,
					msg: e
				}), Q.models.addMessage(i);
			} catch (e) {
				m.error("error while drawing message", e);
			}
		}
		[
	...
	m.debug("createdActors", p), m.debug("destroyedActors", h), await Be(d, f, v, !1, t, r, D);
	for (let e of M) await Re(d, e.messageModel, e.lineStartY, r, e.msg, t);
	Z.mirrorActors && await Be(d, f, v, !0, t, r, D), N.forEach((e) => X.drawBackgroundRect(d, e)), ce(d, f, v, Z);
	for (let e of Q.models.boxes) {
		e.height = Q.getVerticalPos() - e.y, Q.insert(e.x, e.y, e.x + e.width, e.height);
		let t = Z.boxMargin * 2;
		e.startx = e.x - t, e.starty = e.y - t * .25, e.stopx = e.startx + e.width + 2 * t, e.stopy = e.starty + e.height + t * .75, e.stroke = "rgb(0,0,0, 0.5)", X.drawBox(d, e, Z);
	}
	C && Q.bumpVerticalPos(Z.boxMargin);
	let F = Ve(d, f, v, u), { bounds: I } = Q.getBounds();
	...
	S && d.append("text").text(S).attr("x", (I.stopx - I.startx) / 2 - 2 * Z.diagramMarginX).attr("y", -25), y(d, L, te, Z.useMaxWidth);
	let ne = S ? 40 : 0, z = f.size && o === "neo" ? 30 : 0;
	d.attr("viewBox", I.startx - Z.diagramMarginX + " -" + (Z.diagramMarginY + ne) + " " + te + " " + (L + ne + z)), m.debug("models:", Q.models);
}, "draw");
async function qe(e, n, r) {
	let i = {};
	for (let a of n) if (e.get(a.to) && e.get(a.from)) {
		let n = e.get(a.to);
		if (a.placement === r.db.PLACEMENT.LEFTOF && !n.prevActor || a.placement === r.db.PLACEMENT.RIGHTOF && !n.nextActor) continue;
		let o = a.placement !== void 0, s = !o, c = o ? Fe(Z) : Pe(Z), l = a.wrap ? d.wrapLabel(a.message, Z.width - 2 * Z.wrapPadding, c) : a.message, u = (t(l) ? await p(a.message, w()) : d.calculateTextDimensions(l, c)).width + 2 * Z.wrapPadding;
		s && a.from === n.nextActor ? i[a.to] = g.getMax(i[a.to] || 0, u) : s && a.from === n.prevActor ? i[a.from] = g.getMax(i[a.from] || 0, u) : s && a.from === a.to ? (i[a.from] = g.getMax(i[a.from] || 0, u / 2), i[a.to] = g.getMax(i[a.to] || 0, u / 2)) : a.placement === r.db.PLACEMENT.RIGHTOF ? i[a.from] = g.getMax(i[a.from] || 0, u) : a.placement === r.db.PLACEMENT.LEFTOF ? i[n.prevActor] = g.getMax(i[n.prevActor] || 0, u) : a.placement === r.db.PLACEMENT.OVER && (n.prevActor && (i[n.prevActor] = g.getMax(i[n.prevActor] || 0, u / 2)), n.nextActor && (i[a.from] = g.getMax(i[a.from] || 0, u / 2)));
	}
	return m.debug("maxMessageWidthPerActor:", i), i;
}
_(qe, "getMaxMessageWidthPerActor");
var Je = /* @__PURE__ */ _(function(e) {
	let t = 0, n = Ie(Z);
	for (let r in e.links) {
		let e = d.calculateTextDimensions(r, n).width + 2 * Z.wrapPadding + 2 * Z.boxMargin;
		t < e && (t = e);
	}
	return t;
...
async function Ye(e, n, r) {
	...
	for (let n of e.keys()) {
		let r = e.get(n);
		r.wrap && (r.description = d.wrapLabel(r.description, Z.width - 2 * Z.wrapPadding, Ie(Z)));
		let a = t(r.description) ? await p(r.description, w()) : d.calculateTextDimensions(r.description, Ie(Z));
		r.width = r.wrap ? Z.width : g.getMax(Z.width, a.width + 2 * Z.wrapPadding), r.height = r.wrap ? g.getMax(a.height, Z.height) : Z.height, i = g.getMax(i, r.height);
	}
	for (let t in n) {
		let r = e.get(t);
		if (!r) continue;
		...
		if (!i) {
			let e = n[t] + Z.actorMargin - r.width / 2;
			r.margin = g.getMax(e, Z.actorMargin);
			continue;
		}
		let a = n[t] + Z.actorMargin - r.width / 2 - i.width / 2;
		r.margin = g.getMax(a, Z.actorMargin);
	}
	let a = 0;
	return r.forEach((t) => {
		let n = Pe(Z), r = t.actorKeys.reduce((t, n) => t += e.get(n).width + (e.get(n).margin || 0), 0), i = Z.boxMargin * 8;
		r += i, r -= 2 * Z.boxTextMargin, t.wrap && (t.name = d.wrapLabel(t.name, r - 2 * Z.wrapPadding, n));
		let o = d.calculateTextDimensions(t.name, n);
		a = g.getMax(o.height, a);
		let s = g.getMax(r, o.width + 2 * Z.wrapPadding);
		if (t.margin = Z.boxTextMargin, r < s) {
			let e = (s - r) / 2;
			t.margin += e;
		}
	}), r.forEach((e) => e.textMaxHeight = a), g.getMax(i, Z.height);
}
_(Ye, "calculateActorMargins");
var Xe = /* @__PURE__ */ _(async function(e, n, r) {
	let i = n.get(e.from), a = n.get(e.to), o = i.x, s = a.x, c = e.wrap && e.message, l = t(e.message) ? await p(e.message, w()) : d.calculateTextDimensions(c ? d.wrapLabel(e.message, Z.width, Fe(Z)) : e.message, Fe(Z)), u = {
		width: c ? Z.width : g.getMax(Z.width, l.width + 2 * Z.noteMargin),
		height: 0,
		startx: i.x,
		stopx: 0,
		starty: 0,
	...
	return e.placement === r.db.PLACEMENT.RIGHTOF ? (u.width = c ? g.getMax(Z.width, l.width) : g.getMax(i.width / 2 + a.width / 2, l.width + 2 * Z.noteMargin), u.startx = o + (i.width + Z.actorMargin) / 2) : e.placement === r.db.PLACEMENT.LEFTOF ? (u.width = c ? g.getMax(Z.width, l.width + 2 * Z.noteMargin) : g.getMax(i.width / 2 + a.width / 2, l.width + 2 * Z.noteMargin), u.startx = o - u.width + (i.width - Z.actorMargin) / 2) : e.to === e.from ? (l = d.calculateTextDimensions(c ? d.wrapLabel(e.message, g.getMax(Z.width, i.width), Fe(Z)) : e.message, Fe(Z)), u.width = c ? g.getMax(Z.width, i.width) : g.getMax(i.width, Z.width, l.width + 2 * Z.noteMargin), u.startx = o + (i.width - u.width) / 2) : (u.width = Math.abs(o + i.width / 2 - (s + a.width / 2)) + Z.actorMargin, u.startx = o < s ? o + i.width / 2 - Z.actorMargin / 2 : s + a.width / 2 - Z.actorMargin / 2), c && (u.message = d.wrapLabel(e.message, u.width - 2 * Z.wrapPadding, Fe(Z))), m.debug(`NM:[${u.startx},${u.stopx},${u.starty},${u.stopy}:${u.width},${u.height}=${e.message}]`), u;
}, "buildNoteModel"), Ze = 4, Qe = 6, $e = /* @__PURE__ */ _(function(e, t) {
...
}, "hasCentralConnection"), et = /* @__PURE__ */ _(function(e, t, n) {
...
}, "calculateCentralConnectionOffset"), tt = /* @__PURE__ */ _(function(e, t) {
...
}, "isReverseArrowType"), nt = /* @__PURE__ */ _(function(e, t) {
	let { BIDIRECTIONAL_SOLID: n, BIDIRECTIONAL_DOTTED: r } = t.db.LINETYPE;
	return [n, r].includes(e.type);
}, "isBidirectionalArrowType"), rt = /* @__PURE__ */ _(function(e, t, n) {
	let { look: r } = w();
	if (![
	...
	let [i, a] = We(e.from, t), [o, s] = We(e.to, t), c = i <= o, l = c ? a : i, u = c ? o : s;
	r === "neo" && (e.type !== n.db.LINETYPE.SOLID_OPEN && (u += c ? -3 : 3), (e.type === n.db.LINETYPE.BIDIRECTIONAL_SOLID || e.type === n.db.LINETYPE.BIDIRECTIONAL_DOTTED) && (l += c ? 3 : -3)), l += et(e, n, c);
	let f = Math.abs(o - s) > 2, p = /* @__PURE__ */ _((e) => c ? -e : e, "adjustValue");
	e.from === e.to ? u = l : (e.activate && !f && (u += p(Z.activationWidth / 2 - 1)), [
		n.db.LINETYPE.SOLID_OPEN,
		n.db.LINETYPE.DOTTED_OPEN,
		n.db.LINETYPE.STICK_TOP,
		n.db.LINETYPE.STICK_BOTTOM,
	...
	e.wrap && e.message && (e.message = d.wrapLabel(e.message, g.getMax(h + 2 * Z.wrapPadding, Z.width), Pe(Z)));
	let v = d.calculateTextDimensions(e.message, Pe(Z));
	return {
		width: g.getMax(e.wrap ? 0 : v.width + 2 * Z.wrapPadding, h + 2 * Z.wrapPadding, Z.width),
		height: 0,
		startx: l,
		stopx: u,
		starty: 0,
...
}, "buildMessageModel"), it = /* @__PURE__ */ _(async function(e, t, n, r) {
	let i = {}, a = [], o, s, c;
	for (let n of e) {
		switch (n.type) {
			case r.db.LINETYPE.LOOP_START:
		...
		n.placement === void 0 ? (c = rt(n, t, r), n.msgModel = c, c.startx && c.stopx && a.length > 0 && a.forEach((e) => {
			if (o = e, c.startx === c.stopx) {
				...
				o.from = g.getMin(e.x - c.width / 2, e.x - e.width / 2, o.from), o.to = g.getMax(r.x + c.width / 2, r.x + e.width / 2, o.to), o.width = g.getMax(o.width, Math.abs(o.to - o.from)) - Z.labelBoxWidth;
			} else o.from = g.getMin(c.startx, o.from), o.to = g.getMax(c.stopx, o.to), o.width = g.getMax(o.width, c.width) - Z.labelBoxWidth;
		})) : (s = await Xe(n, t, r), n.noteModel = s, a.forEach((e) => {
			o = e, o.from = g.getMin(o.from, s.startx), o.to = g.getMax(o.to, s.startx + s.width), o.width = g.getMax(o.width, Math.abs(o.from - o.to)) - Z.labelBoxWidth;
		}));
	}
	return Q.activations = [], m.debug("Loop type widths:", i), i;
	...
	styles: ne,
	init: /* @__PURE__ */ _((e) => {
		e.sequence ||= {}, e.wrap && (e.sequence.wrap = e.wrap, c({ sequence: { wrap: e.wrap } }));
	}, "init")
};
//#endregion
