import { $n as e, Ct as t, Kn as n, Qn as r, Rn as i, St as a, _ as o, ar as s, cr as c, g as l, pn as u, tr as d, wt as f, xn as p, y as m } from "./chunk-J7OUQ5F2-BUGcDHyW.mjs";
import { t as h } from "./chunk-5VM5RSS4-C77-LDhP.mjs";
...
var g = (function() {
	var e = /* @__PURE__ */ c(function(e, t, n, r) {
		...
		return n;
	}, "o"), t = [1, 4], n = [1, 13], r = [1, 12], i = [1, 15], a = [1, 16], o = [1, 20], s = [1, 19], l = [
		6,
		7,
		8
	...
	return c(S, "Parser"), S.prototype = x, x.Parser = S, new S();
})();
g.parser = g;
var _ = g, v = [], y = [], b = 0, x = {}, S = /* @__PURE__ */ c(() => {
	v = [], y = [], b = 0, x = {};
}, "clear"), C = /* @__PURE__ */ c((e) => {
...
}, "getSection"), w = /* @__PURE__ */ c(function() {
	return y;
}, "getSections"), T = /* @__PURE__ */ c(function() {
	let e = [], t = [], n = w(), r = p();
	for (let e of n) {
		let n = {
			id: e.id,
...
}, "getData"), E = /* @__PURE__ */ c((e, n, r, o, s) => {
	let c = p(), l = c.mindmap?.padding ?? u.mindmap.padding;
	switch (o) {
		case D.ROUNDED_RECT:
		case D.RECT:
		case D.HEXAGON: l *= 2;
	...
	let d = {
		...
		level: e,
		label: i(r, c),
		width: c.mindmap?.maxNodeWidth ?? u.mindmap.maxNodeWidth,
		padding: l,
		isGroup: !1
	};
	if (s !== void 0) {
		...
		e = s.includes("\n") ? s + "\n" : "{\n" + s + "\n}";
		let n = t(e, { schema: a });
		if (n.shape && (n.shape !== n.shape.toLowerCase() || n.shape.includes("_"))) throw Error(`No such shape: ${n.shape}. Shape names should be lowercase.`);
		n?.shape && n.shape === "kanbanItem" && (d.shape = n?.shape), n?.label && (d.label = n?.label), n?.icon && (d.icon = n?.icon.toString()), n?.assigned && (d.assigned = n?.assigned.toString()), n?.ticket && (d.ticket = n?.ticket.toString()), n?.priority && (d.priority = n?.priority);
	}
	let f = C(e);
	f ? d.parentId = f.id || "kbn" + b++ : y.push(d), v.push(d);
}, "addNode"), D = {
	DEFAULT: 0,
	NO_BORDER: 0,
	ROUNDED_RECT: 1,
	...
	getData: T,
	nodeType: D,
	getType: /* @__PURE__ */ c((e, t) => {
		switch (s.debug("In get type", e, t), e) {
			case "[": return D.RECT;
			case "(": return t === ")" ? D.ROUNDED_RECT : D.CLOUD;
	...
	setElementForId: /* @__PURE__ */ c((e, t) => {
		x[e] = t;
	}, "setElementForId"),
	decorateNode: /* @__PURE__ */ c((e) => {
		if (!e) return;
		let t = p(), n = v[v.length - 1];
		e.icon && (n.icon = i(e.icon, t)), e.class && (n.cssClasses = i(e.class, t));
	}, "decorateNode"),
	type2Str: /* @__PURE__ */ c((e) => {
		switch (e) {
	...
	getElementById: /* @__PURE__ */ c((e) => x[e], "getElementById")
}, k = { draw: /* @__PURE__ */ c(async (e, t, r, i) => {
	s.debug("Rendering kanban diagram\n" + e);
	let a = i.db.getData(), c = p();
	c.htmlLabels = !1;
	let d = f(t);
	for (let e of a.nodes) e.domId = `${t}-${e.id}`;
	let h = d.append("g");
	h.attr("class", "sections");
	let g = d.append("g");
	g.attr("class", "items");
	let _ = a.nodes.filter((e) => e.isGroup), v = 0, y = [], b = 25;
	for (let e of _) {
	...
	for (let e of _) {
		let t = y[x];
		x += 1;
		let n = c?.kanban?.sectionWidth || 200, r = -n * 3 / 2 + b, i = r, s = a.nodes.filter((t) => t.parentId === e.id);
		for (let t of s) {
			if (t.isGroup) throw Error("Groups within groups are not allowed in Kanban diagrams");
			t.x = e.x, t.width = n - 1.5 * 10;
			let r = (await o(g, t, { config: c })).node().getBBox();
			t.y = i + r.height / 2, await m(t), i = t.y + r.height / 2 + 10 / 2;
		}
		let l = t.cluster.select("rect"), u = Math.max(i - r + 30, 50) + (b - 25);
		l.attr("height", u);
	}
	n(void 0, d, c.mindmap?.padding ?? u.kanban.padding, c.mindmap?.useMaxWidth ?? u.kanban.useMaxWidth);
}, "draw") }, A = /* @__PURE__ */ c((t) => {
	let n = "";
	for (let n = 0; n < t.THEME_COLOR_LIMIT; n++) t["lineColor" + n] = t["lineColor" + n] || t["cScaleInv" + n], d(t["lineColor" + n]) ? t["lineColor" + n] = e(t["lineColor" + n], 20) : t["lineColor" + n] = r(t["lineColor" + n], 20);
	let i = /* @__PURE__ */ c((n, i) => t.darkMode ? r(n, i) : e(n, i), "adjuster");
