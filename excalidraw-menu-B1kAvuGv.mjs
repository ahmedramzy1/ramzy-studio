import { C as e, D as t, E as n, O as r, Ot as i, g as a, it as o, jn as s, k as c, kt as l, l as u, nt as d, sn as ee, t as te, w as f } from "./events-sARIYVlw.mjs";
import { A as p, R as m, c as h, f as g, j as _, k as v, o as ne, r as re, rt as y, t as b, y as x } from "./use-alt-text-control-pS4ggT10.mjs";
import { d as ie, t as ae } from "./useTranslation-Egl4mJFn.mjs";
import { X as S, n as C, t as w } from "./excalidraw-utils-BOlRvSWI.mjs";
...
function F({ editor: l }) {
	let { t: E } = ae(), F = ne(l), [I, { open: L, close: R }] = o(!1), [z, B] = k(null);
	C({
		excalidrawAPI: z,
		adapter: w
	});
	let [V, H] = k(null), U = ie(), W = O(!1), G = O(!1), [K, q] = k(!1), [se, J] = k(!1), Y = O(!0), X = O(""), Z = i({
		editor: l,
		selector: (e) => {
		...
		let { selection: e } = l.state, t = ee((e) => e.type.name === "excalidraw")(e);
		if (t) {
		...
		if (!Z?.src) return;
		let e = a(Z.src), t = document.createElement("a");
		t.href = e, t.download = "", t.click();
	}, [Z?.src]), me = D(() => {
		l.commands.deleteSelection();
	}, [l]), { button: he, panel: ge, isEditing: _e } = b({
		editor: l,
		nodeName: "excalidraw",
		currentAlt: Z?.alt || ""
	}), ve = D(async () => {
	...
	}, [I, Q]), /* @__PURE__ */ M(A, { children: [/* @__PURE__ */ j(g, {
		editor: l,
			...
			children: [
				/* @__PURE__ */ j(y, {
					...
					children: /* @__PURE__ */ j(c, {
						...
						variant: "subtle",
						className: d({ [h.active]: Z?.isAlignLeft }),
				...
				/* @__PURE__ */ j(y, {
					...
					children: /* @__PURE__ */ j(c, {
						...
						variant: "subtle",
						className: d({ [h.active]: Z?.isAlignCenter }),
						children: /* @__PURE__ */ j(_, { size: 18 })
					})
				}),
				/* @__PURE__ */ j(y, {
					position: "top",
					...
					children: /* @__PURE__ */ j(c, {
						...
						variant: "subtle",
						className: d({ [h.active]: Z?.isAlignRight }),
						children: /* @__PURE__ */ j(v, { size: 18 })
					})
				}),
				/* @__PURE__ */ j("div", { className: h.divider }),
				he,
				/* @__PURE__ */ j("div", { className: h.divider }),
				/* @__PURE__ */ j(y, {
					position: "top",
				...
				!F && /* @__PURE__ */ j(y, {
					...
					children: /* @__PURE__ */ j(c, {
						...
						"aria-label": E("Delete"),
						variant: "subtle",
						children: /* @__PURE__ */ j(x, { size: 18 })
					})
				}),
				F && /* @__PURE__ */ M(A, { children: [/* @__PURE__ */ j("div", { className: h.divider }), /* @__PURE__ */ j(re, { editor: l })] })
			]
		})
	}), /* @__PURE__ */ M(S, {
		style: {
