...
//#region ../../node_modules/.pnpm/@excalidraw+excalidraw@0.18.0-3a5ef40_@types+react-dom@19.2.3_@types+react@19.2.17__@ty_b5c0bb913e6bf58bb5b24f479fd5a57a/node_modules/@excalidraw/excalidraw/dist/prod/locales/ru-RU-YBIIY43T.js
var e = {
	paste: "Вставить",
	...
	stroke: "Обводка",
	changeStroke: "Изменить цвет обводки",
	background: "Фон",
	changeBackground: "Изменить цвет фона",
	fill: "Заливка",
	...
	arrowhead_bar: "Черта",
	arrowhead_circle: "Круг",
	arrowhead_circle_outline: "Круг (контур)",
	...
	arrowtype_elbowed: "Прямоугольная стрелка",
	...
	loadScene: "Загрузить сцену из файла",
	align: "Выровнять",
	...
	saveLibraryError: "Не удалось сохранить библиотеку в хранилище. Пожалуйста, сохраните библиотеку в файл локально, чтобы не потерять изменения.",
	...
	arrowBindModifiers: "Удерживайте {{shortcut_1}} , чтобы отключить привязку, или {{shortcut_2}} для привязки в фиксированной точке",
	...
	createFlowchart: "{{shortcut}} — создать блок-схему",
	deepBoxSelect: "Удерживайте {{shortcut}} для глубокого выделения и предотвращения перетаскивания",
	eraserRevert: "Удерживайте {{shortcut}}, чтобы восстановить элементы, помеченные для удаления",
	...
	disableSnapping: "Удерживайте {{shortcut}}, чтобы отключить привязку",
	enterCropEditor: "Дважды щёлкните по изображению или нажмите {{shortcut}}, чтобы обрезать изображение",
	leaveCropEditor: "Щёлкните за пределами изображения или нажмите {{shortcut_1}} или {{shortcut_2}}, чтобы завершить кадрирование"
}, d = {
	...
	copyToClipboardAsSvg: "{{exportSelection}} скопировано в буфер обмена как SVG\n({{exportColorScheme}})",
	...
	viewAsMermaid: "Просмотреть как Mermaid",
	placeholder: {
	...
	retry: "Повторить",
	errors: {
		promptTooShort: "Подсказка слишком короткая (мин. символов: {{min}})",
		promptTooLong: "Подсказка слишком длинная (макс. символов: {{max}})",
		generationFailed: "Генерация не удалась",
		invalidDiagram: "Сгенерирована неверная диаграмма :(. Вы можете редактировать вручную, повторите с автоисправлением или попробуйте другую подсказку.",
		fixInMermaid: "Изменить Mermaid вручную →",
	...
	rateLimit: {
		...
		generalRateLimit: "Подождите, вы слишком быстры для нас! Пожалуйста, подождите немного, прежде чем повторить попытку.",
		messageLimitInputPlaceholder: "Вы достигли лимита сообщений"
	},
	upsellBtnLabel: "Перейти на Plus"
}, N = { placeholder: "Быстрый поиск" }, P = {
	badge: { old: "старый" },
