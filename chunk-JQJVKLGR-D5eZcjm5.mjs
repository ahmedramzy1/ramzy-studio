import { Bn as e, Ct as t, R as n, St as r, Un as i, Vn as a, W as o, Wn as s, Zn as c, ar as l, cn as u, cr as d, fn as f, kn as p, nr as m, on as h, r as g, t as ee, tn as _, v as te, vn as ne, wn as re, xn as v, yn as y } from "./chunk-J7OUQ5F2-BUGcDHyW.mjs";
import { t as b } from "./channel-CLnV92vg.mjs";
import { t as x } from "./chunk-5VM5RSS4-C77-LDhP.mjs";
import { t as S } from "./chunk-2GRJ4B5K-DKbJpHGI.mjs";
import { t as C } from "./chunk-XXDRQBXY-DYEdPnIN.mjs";
import { t as w } from "./chunk-KBJHAD2P-iCC8cYwM.mjs";
...
var T = "flowchart-", E = class {
	constructor() {
		this.vertexCounter = 0, this.config = v(), this.diagramId = "", this.vertices = /* @__PURE__ */ new Map(), this.edges = [], this.classes = /* @__PURE__ */ new Map(), this.subGraphs = [], this.subGraphLookup = /* @__PURE__ */ new Map(), this.tooltips = /* @__PURE__ */ new Map(), this.subCount = 0, this.firstGraphFlag = !0, this.secCount = -1, this.posCrossRef = [], this.funs = [], this.setAccTitle = a, this.setAccDescription = e, this.setDiagramTitle = s, this.getAccTitle = y, this.getAccDescription = ne, this.getDiagramTitle = re, this.funs.push(this.setupToolTips.bind(this)), this.addVertex = this.addVertex.bind(this), this.firstGraph = this.firstGraph.bind(this), this.setDirection = this.setDirection.bind(this), this.addSubGraph = this.addSubGraph.bind(this), this.addLink = this.addLink.bind(this), this.setLink = this.setLink.bind(this), this.updateLink = this.updateLink.bind(this), this.addClass = this.addClass.bind(this), this.setClass = this.setClass.bind(this), this.destructLink = this.destructLink.bind(this), this.setClickEvent = this.setClickEvent.bind(this), this.setTooltip = this.setTooltip.bind(this), this.updateLinkInterpolate = this.updateLinkInterpolate.bind(this), this.setClickFun = this.setClickFun.bind(this), this.bindFunctions = this.bindFunctions.bind(this), this.lex = { firstGraph: this.firstGraph.bind(this) }, this.clear(), this.setGen("gen-2");
	}
	static {
		d(this, "FlowDB");
	}
	sanitizeText(e) {
		return u.sanitizeText(e, this.config);
	}
	...
	addVertex(e, n, i, a, o, s, c = {}, u) {
		...
		let f = this.edges.find((t) => t.id === e);
		if (f) {
			let e = d;
			e?.animate !== void 0 && (f.animate = e.animate), e?.animation !== void 0 && (f.animation = e.animation), e?.curve !== void 0 && (f.interpolate = e.curve);
			return;
		}
		let p, m = this.vertices.get(e);
		if (m === void 0 && (n === void 0 && i === void 0 && a != null && l.warn(`Style applied to unknown node "${e}". This may indicate a typo. The node will be created automatically.`), m = {
			id: e,
			labelType: "text",
			domId: T + e + "-" + this.vertexCounter,
			styles: [],
			classes: []
		}, this.vertices.set(e, m)), this.vertexCounter++, n === void 0 ? m.text === void 0 && (m.text = e) : (this.config = v(), p = this.sanitizeText(n.text.trim()), m.labelType = n.type, p.startsWith("\"") && p.endsWith("\"") && (p = p.substring(1, p.length - 1)), m.text = p), i !== void 0 && (m.type = i), a?.forEach((e) => {
			m.styles.push(e);
		}), o?.forEach((e) => {
			m.classes.push(e);
		}), s !== void 0 && (m.dir = s), m.props === void 0 ? m.props = c : c !== void 0 && Object.assign(m.props, c), d !== void 0) {
			if (d.shape) {
				if (d.shape !== d.shape.toLowerCase() || d.shape.includes("_")) throw Error(`No such shape: ${d.shape}. Shape names should be lowercase.`);
				if (!te(d.shape)) throw Error(`No such shape: ${d.shape}.`);
				m.type = d?.shape;
			}
			d?.label && (m.text = d?.label, m.labelType = this.sanitizeNodeLabelType(d?.labelType)), d?.icon && (m.icon = d?.icon, !d.label?.trim() && m.text === e && (m.text = "")), d?.form && (m.form = d?.form), d?.pos && (m.pos = d?.pos), d?.img && (m.img = d?.img, !d.label?.trim() && m.text === e && (m.text = "")), d?.constraint && (m.constraint = d.constraint), d.w && (m.assetWidth = Number(d.w)), d.h && (m.assetHeight = Number(d.h));
		}
	}
	addSingleLink(e, t, r, i) {
		...
		if (o !== void 0 && (a.text = this.sanitizeText(o.text.trim()), a.text.startsWith("\"") && a.text.endsWith("\"") && (a.text = a.text.substring(1, a.text.length - 1)), a.labelType = this.sanitizeNodeLabelType(o.type)), r !== void 0 && (a.type = r.type, a.stroke = r.stroke, a.length = r.length > 10 ? 10 : r.length), i && !this.edges.some((e) => e.id === i)) a.id = i, a.isUserDefinedId = !0;
			...
			e.length === 0 ? a.id = n(a.start, a.end, {
				counter: 0,
				prefix: "L"
			}) : a.id = n(a.start, a.end, {
				counter: e.length + 1,
				prefix: "L"
			});
		}
		if (this.edges.length < (this.config.maxEdges ?? 500)) l.info("Pushing edge..."), this.edges.push(a);
...
You have to call mermaid.initialize.`);
	...
	setLink(e, t, n) {
		e.split(",").forEach((e) => {
			...
			r !== void 0 && (r.link = o.formatUrl(t, this.config), r.linkTarget = n);
	...
	setupToolTips(e) {
		let t = S();
		_(e).select("svg").selectAll("g.node").on("mouseover", (e) => {
			let n = _(e.currentTarget), r = n.attr("title");
			if (r === null) return;
			...
			t.transition().duration(500).style("opacity", 0), _(e.currentTarget).classed("hover", !1);
		});
	}
	clear(e = "gen-2") {
		this.vertices = /* @__PURE__ */ new Map(), this.classes = /* @__PURE__ */ new Map(), this.edges = [], this.funs = [this.setupToolTips.bind(this)], this.diagramId = "", this.subGraphs = [], this.subGraphLookup = /* @__PURE__ */ new Map(), this.subCount = 0, this.tooltips = /* @__PURE__ */ new Map(), this.firstGraphFlag = !0, this.version = e, this.config = v(), h();
	}
	setGen(e) {
	...
	addSubGraph(e, t, n) {
		...
		}, "uniq"))(t.flat()), o = a.nodeList, s = a.dir, c = s !== void 0, u = v().flowchart ?? {}, f = s ?? (u.inheritDir ? this.getDirection() ?? v().direction ?? void 0 : void 0);
		if (this.version === "gen-1") for (let e = 0; e < o.length; e++) o[e] = this.lookUpDomId(o[e]);
		...
		return l.info("Adding", p.id, p.nodes, p.dir), p.nodes = this.makeUniq(p, this.subGraphs).nodes, this.subGraphs.push(p), this.subGraphLookup.set(r, p), r;
	}
	getPosForId(e) {
	...
	getData() {
		let e = v(), t = [], r = [], i = this.getSubGraphs(), a = /* @__PURE__ */ new Map(), o = /* @__PURE__ */ new Map();
		...
		for (let n = i.length - 1; n >= 0; n--) {
			...
			t.push({
				...
				shape: "rect",
				dir: r.dir === "TD" ? "TB" : r.dir,
				explicitDir: r.hasExplicitDir,
				isGroup: !0,
				look: e.look
			});
		}
	...
	getClasses: /* @__PURE__ */ d(function(e, t) {
		return t.db.getClasses();
	}, "getClasses"),
	draw: /* @__PURE__ */ d(async function(e, t, n, r, i) {
		l.info("REF0:"), l.info("Drawing state diagram (v2)", t);
		let { securityLevel: a, flowchart: s, layout: c } = v();
		r.db.setDiagramId(t), l.debug("Before getData: ");
		let u = r.db.getData();
		l.debug("Data: ", u);
		let d = C(t, a), f = r.db.getDirection();
		u.type = r.type, u.layoutAlgorithm = ee(c), u.layoutAlgorithm === "dagre" && c === "elk" && l.warn("flowchart-elk was moved to an external package in Mermaid v11. Please refer [release notes](https://github.com/mermaid-js/mermaid/releases/tag/v11.0.0) for more details. This diagram will be rendered using `dagre` layout as a fallback."), u.direction = f, u.nodeSpacing = s?.nodeSpacing || 50, u.rankSpacing = s?.rankSpacing || 50, u.markers = [
			"point",
			"circle",
			"cross"
		], u.diagramId = t, l.debug("REF1:", u), await g(u, d, i);
		let p = u.config.flowchart?.diagramPadding ?? 8;
		o.insertTitle(d, "flowchartTitleText", s?.titleTopMargin || 0, r.db.getDiagramTitle()), w(d, p, "flowchart", s?.useMaxWidth || !1);
	}, "draw")
}, O = (function() {
	var e = /* @__PURE__ */ d(function(e, t, n, r) {
		...
		124,
		125
	], a = [2, 2], o = [1, 13], s = [1, 14], c = [1, 15], l = [1, 16], u = [1, 23], f = [1, 25], p = [1, 26], m = [1, 27], h = [1, 50], g = [1, 49], ee = [1, 29], _ = [1, 30], te = [1, 31], ne = [1, 32], re = [1, 33], v = [1, 45], y = [1, 47], b = [1, 43], x = [1, 48], S = [1, 44], C = [1, 51], w = [1, 46], T = [1, 52], E = [1, 53], D = [1, 34], O = [1, 35], ie = [1, 36], ae = [1, 37], oe = [1, 38], k = [1, 58], A = [
		1,
		8,
		9,
		10,
		...
		trace: /* @__PURE__ */ d(function() {}, "trace"),
		yy: {},
		symbols_: {
			error: 2,
			start: 3,
		...
		performAction: /* @__PURE__ */ d(function(e, t, n, r, i, a, o) {
			var s = a.length - 1;
			switch (i) {
				case 2:
					this.$ = [];
		...
		defaultActions: {},
		parseError: /* @__PURE__ */ d(function(e, t) {
		...
		parse: /* @__PURE__ */ d(function(e) {
			var t = this, n = [0], r = [], i = [null], a = [], o = this.table, s = "", c = 0, l = 0, u = 0, f = 2, p = 1, m = a.slice.call(arguments, 1), h = Object.create(this.lexer), g = { yy: {} };
			for (var ee in this.yy) Object.prototype.hasOwnProperty.call(this.yy, ee) && (g.yy[ee] = this.yy[ee]);
			h.setInput(e, g.yy), g.yy.lexer = h, g.yy.parser = this, h.yylloc === void 0 && (h.yylloc = {});
			var _ = h.yylloc;
			a.push(_);
			var te = h.options && h.options.ranges;
			...
			for (var v, y, b, x, S, C = {}, w, T, E, D;;) {
				if (b = n[n.length - 1], this.defaultActions[b] ? x = this.defaultActions[b] : (v ??= re(), x = o[b] && o[b][v]), x === void 0 || !x.length || !x[0]) {
					var O = "";
					for (w in D = [], o[b]) this.terminals_[w] && w > f && D.push("'" + this.terminals_[w] + "'");
					O = h.showPosition ? "Parse error on line " + (c + 1) + ":\n" + h.showPosition() + "\nExpecting " + D.join(", ") + ", got '" + (this.terminals_[v] || v) + "'" : "Parse error on line " + (c + 1) + ": Unexpected " + (v == p ? "end of input" : "'" + (this.terminals_[v] || v) + "'"), this.parseError(O, {
						text: h.match,
				...
				switch (x[0]) {
					case 1:
						n.push(v), i.push(h.yytext), a.push(h.yylloc), n.push(x[1]), v = null, y ? (v = y, y = null) : (l = h.yyleng, s = h.yytext, c = h.yylineno, _ = h.yylloc, u > 0 && u--);
						break;
					case 2:
						if (T = this.productions_[x[1]][1], C.$ = i[i.length - T], C._$ = {
							first_line: a[a.length - (T || 1)].first_line,
							last_line: a[a.length - 1].last_line,
							first_column: a[a.length - (T || 1)].first_column,
							last_column: a[a.length - 1].last_column
						}, te && (C._$.range = [a[a.length - (T || 1)].range[0], a[a.length - 1].range[1]]), S = this.performAction.apply(C, [
							s,
							l,
							c,
							g.yy,
							...
							i,
							a
						].concat(m)), S !== void 0) return S;
						T && (n = n.slice(0, -1 * T * 2), i = i.slice(0, -1 * T), a = a.slice(0, -1 * T)), n.push(this.productions_[x[1]][0]), i.push(C.$), a.push(C._$), E = o[n[n.length - 2]][n[n.length - 1]], n.push(E);
						break;
					case 3: return !0;
				}
			}
	...
	rt.lexer = /* @__PURE__ */ (function() {
		return {
			...
			setInput: /* @__PURE__ */ d(function(e, t) {
			...
			test_match: /* @__PURE__ */ d(function(e, t) {
				var n, r, i;
			...
			topState: /* @__PURE__ */ d(function(e) {
				return e = this.conditionStack.length - 1 - Math.abs(e || 0), e >= 0 ? this.conditionStack[e] : "INITIAL";
			}, "topState"),
			pushState: /* @__PURE__ */ d(function(e) {
				this.begin(e);
			}, "pushState"),
			...
			options: {},
			performAction: /* @__PURE__ */ d(function(e, t, n, r) {
				switch (n) {
	...
	return d(it, "Parser"), it.prototype = rt, rt.Parser = it, new it();
})();
O.parser = O;
...
var oe = ae, k = /* @__PURE__ */ d((e, t) => {
	let n = b;
	return m(n(e, "r"), n(e, "g"), n(e, "b"), t);
}, "fade"), A = /* @__PURE__ */ d((e) => `.label {
  ...
  ${x()}
`, "getStyles"), j = /* @__PURE__ */ d(({ defaultLayout: e, styles: t = A } = {}) => ({
	parser: oe,
	get db() {
		return new E();
	},
