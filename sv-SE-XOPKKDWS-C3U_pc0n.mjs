...
//#region ../../node_modules/.pnpm/@excalidraw+excalidraw@0.18.0-3a5ef40_@types+react-dom@19.2.3_@types+react@19.2.17__@ty_b5c0bb913e6bf58bb5b24f479fd5a57a/node_modules/@excalidraw/excalidraw/dist/prod/locales/sv-SE-XOPKKDWS.js
var e = {
	paste: "Klistra in",
	...
	stroke: "Linje",
	changeStroke: "Ändra streckfärg",
	background: "Bakgrund",
	changeBackground: "Ändra bakgrundsfärg",
	fill: "Fyllnad",
	...
	showFonts: "Visa typsnittsväljare",
	toggleTheme: "Växla ljus/mörkt tema",
	theme: "Tema",
	...
	link: {
		edit: "Redigera länk",
		editEmbed: "Redigera inbäddningsbar länk",
		create: "Lägg till länk",
		label: "Länk",
		labelEmbed: "Länka & bädda in",
		empty: "Ingen länk är angiven",
		hint: "Skriv eller klistra in din länk här",
		goToElement: "Gå till målelementet"
	},
	lineEditor: {
		edit: "Redigera linje",
	...
	imageCropping: "Bildbeskärning",
	unCroppedDimension: "Obeskuren dimension",
	copyElementLink: "Kopiera länk till objektet",
	...
	desc: "Klicka på en figur på canvas eller klistra in en länk.",
	notFound: "Länkat objekt hittades inte på canvas."
}, n = {
	...
	placeholder: "Hitta text på canvas...",
	frames: "",
	texts: ""
}, i = {
	...
	saveLibraryError: "Det gick inte att spara biblioteket till lagring. Spara biblioteket till en fil lokalt för att se till att du inte förlorar ändringar.",
	...
	desc_intro: "Bjud in personer att samarbeta på din ritning.",
	desc_privacy: "Oroa dig inte, sessionen är krypterad och helt privat. Inte ens vår server kan se vad du ritar.",
	...
	createFlowchart: "Skapa ett flödesschema från ett generiskt element",
	navigateFlowchart: "Navigera ett flödesschema",
	...
	cropStart: "Beskär bild",
	cropFinish: "Slutför bildbeskärningen"
}, v = { title: "Rensa canvas" }, y = {
	...
	selected: "Valda",
	storage: "Lagring",
	fullTitle: "Egenskaper för Canvas & Form",
	title: "Egenskaper",
	generalStats: "Allmän",
	...
	elementLinkCopied: "Länk har kopierats till urklipp"
}, E = {
	...
	upsellBtnLabel: ""
}, N = { placeholder: "Snabbsök" }, P = {
	badge: { old: "gammal" },
	sceneFonts: "I den här scenen",
	availableFonts: "Tillgängliga typsnitt",
	empty: "Inga typsnitt hittades"
}, F = {
	empty: "Inga användare hittades",
	hint: {
		text: "Klicka på användaren för att följa",
		followStatus: "Du följer den här användaren",
		inCall: "Användaren är i ett röstsamtal",
		micMuted: "Användarens mikrofon är avstängd",
		isSpeaking: "Användaren pratar"
	}
}, I = {
