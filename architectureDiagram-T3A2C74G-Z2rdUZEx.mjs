...
import { Bn as n, D as r, E as i, Kn as a, O as o, P as s, R as c, Rn as l, Vn as u, Wn as d, ar as f, bn as p, cr as m, on as h, pn as g, tn as _, vn as v, w as y, wn as b, wt as x, xn as S, yn as C } from "./chunk-J7OUQ5F2-BUGcDHyW.mjs";
import { n as w } from "./mermaid-parser.core-DgJi7O7s.mjs";
import { t as T } from "./chunk-JWPE2WC7-DWYJ5PBQ.mjs";
import { t as E } from "./cytoscape.esm-C7IvyoKo.mjs";
...
var D = /* @__PURE__ */ t(((e, t) => {
	...
	L: /* @__PURE__ */ m((e) => `${e},${e / 2} 0,${e} 0,0`, "L"),
	R: /* @__PURE__ */ m((e) => `0,${e / 2} ${e},0 ${e},${e}`, "R"),
	T: /* @__PURE__ */ m((e) => `0,0 ${e},0 ${e / 2},${e}`, "T"),
	B: /* @__PURE__ */ m((e) => `${e / 2},0 ${e},${e} 0,${e}`, "B")
}, M = {
	L: /* @__PURE__ */ m((e, t) => e - t + 2, "L"),
	R: /* @__PURE__ */ m((e, t) => e - 2, "R"),
	T: /* @__PURE__ */ m((e, t) => e - t + 2, "T"),
	B: /* @__PURE__ */ m((e, t) => e - 2, "B")
}, N = /* @__PURE__ */ m(function(e) {
	return F(e) ? e === "L" ? "R" : "L" : e === "T" ? "B" : "T";
}, "getOppositeArchitectureDirection"), P = /* @__PURE__ */ m(function(e) {
	let t = e;
	return t === "L" || t === "R" || t === "T" || t === "B";
}, "isArchitectureDirection"), F = /* @__PURE__ */ m(function(e) {
	let t = e;
	return t === "L" || t === "R";
}, "isArchitectureDirectionX"), I = /* @__PURE__ */ m(function(e) {
	let t = e;
	return t === "T" || t === "B";
}, "isArchitectureDirectionY"), L = /* @__PURE__ */ m(function(e, t) {
	let n = F(e) && I(t), r = I(e) && F(t);
	return n || r;
}, "isArchitectureDirectionXY"), R = /* @__PURE__ */ m(function(e) {
	let t = e[0], n = e[1], r = F(t) && I(n), i = I(t) && F(n);
	return r || i;
}, "isArchitecturePairXY"), z = /* @__PURE__ */ m(function(e) {
	return e !== "LL" && e !== "RR" && e !== "TT" && e !== "BB";
}, "isValidArchitectureDirectionPair"), B = /* @__PURE__ */ m(function(e, t) {
	let n = `${e}${t}`;
	return z(n) ? n : void 0;
}, "getArchitectureDirectionPair"), V = /* @__PURE__ */ m(function([e, t], n) {
	let r = n[0], i = n[1];
	return F(r) ? I(i) ? [e + (r === "L" ? -1 : 1), t + (i === "T" ? 1 : -1)] : [e + (r === "L" ? -1 : 1), t] : F(i) ? [e + (i === "L" ? 1 : -1), t + (r === "T" ? 1 : -1)] : [e, t + (r === "T" ? 1 : -1)];
}, "shiftPositionByArchitectureDirectionPair"), ee = /* @__PURE__ */ m(function(e) {
	return e === "LT" || e === "TL" ? [1, 1] : e === "BL" || e === "LB" ? [1, -1] : e === "BR" || e === "RB" ? [-1, -1] : [-1, 1];
}, "getArchitectureDirectionXYFactors"), te = /* @__PURE__ */ m(function(e, t) {
	return L(e, t) ? "bend" : F(e) ? "horizontal" : "vertical";
}, "getArchitectureDirectionAlignment"), H = /* @__PURE__ */ m(function(e) {
	return e.type === "service";
}, "isArchitectureService"), ne = /* @__PURE__ */ m(function(e) {
	return e.type === "junction";
}, "isArchitectureJunction"), re = /* @__PURE__ */ m((e, t) => {
	let [n, r] = [e, t].sort();
	return `${JSON.stringify(n)}-${JSON.stringify(r)}`;
}, "architectureGroupAlignmentKey"), U = /* @__PURE__ */ m((e) => e.data(), "edgeData"), W = /* @__PURE__ */ m((e) => e.data(), "nodeData"), G = g.architecture, ie = class {
	constructor() {
		this.nodes = /* @__PURE__ */ new Map(), this.groups = /* @__PURE__ */ new Map(), this.edges = [], this.layoutHints = [], this.registeredIds = /* @__PURE__ */ new Map(), this.elements = /* @__PURE__ */ new Map(), this.diagramId = "", this.setAccTitle = u, this.getAccTitle = C, this.setDiagramTitle = d, this.getDiagramTitle = b, this.getAccDescription = v, this.setAccDescription = n, this.clear();
	}
	static {
	...
	clear() {
		this.nodes = /* @__PURE__ */ new Map(), this.groups = /* @__PURE__ */ new Map(), this.edges = [], this.layoutHints = [], this.registeredIds = /* @__PURE__ */ new Map(), this.dataStructures = void 0, this.elements = /* @__PURE__ */ new Map(), this.diagramId = "", h();
	}
	...
	getDataStructures() {
		if (this.dataStructures === void 0) {
			...
			let n = /* @__PURE__ */ new Set(), r = new Set(t.keys()), i = /* @__PURE__ */ m((e) => {
				let i = /* @__PURE__ */ new Map([[e, [0, 0]]]), a = [e];
				for (; a.length > 0;) {
					let e = a.shift();
					if (e) {
						n.add(e), r.delete(e);
						...
						let [c, l] = s;
						o.forEach((e, t) => {
							n.has(e) || (i.set(e, V([c, l], t)), a.push(e));
						});
					}
				}
				return i;
	...
	parse: /* @__PURE__ */ m(async (e) => {
		...
		f.debug(t);
		let n = q.parser?.yy;
		if (!(n instanceof ie)) throw Error("parser.parser?.yy was not a ArchitectureDB. This is due to a bug within Mermaid, please report this issue at https://github.com/mermaid-js/mermaid/issues.");
		K(t, n);
	}, "parse")
}, ae = /* @__PURE__ */ m((e) => `
  .edge {
...
m(J, "withSeededRandom");
var Y = /* @__PURE__ */ m((e) => `<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/>${e}</g>`, "wrapIcon"), X = {
...
}, oe = /* @__PURE__ */ m(async function(e, t, n, r) {
	let i = n.getConfigField("padding"), a = n.getConfigField("iconSize"), o = a / 2, s = a / 6, l = s / 2;
	await Promise.all(t.edges().map(async (t) => {
		let { source: a, sourceDir: u, sourceArrow: d, sourceGroup: f, target: p, targetDir: m, targetArrow: h, targetGroup: g, label: _ } = U(t), { x: v, y: b } = t[0].sourceEndpoint(), { x, y: C } = t[0].midpoint(), { x: w, y: T } = t[0].targetEndpoint(), E = i + 4;
		if (f && (F(u) ? v += u === "L" ? -E : E : b += u === "T" ? -E : E + 18), g && (F(m) ? w += m === "L" ? -E : E : T += m === "T" ? -E : E + 18), !f && n.getNode(a)?.type === "junction" && (F(u) ? v += u === "L" ? o : -o : b += u === "T" ? o : -o), !g && n.getNode(p)?.type === "junction" && (F(m) ? w += m === "L" ? o : -o : T += m === "T" ? o : -o), t[0]._private.rscratch) {
			let t = e.insert("g");
			if (t.insert("path").attr("d", `M ${v},${b} L ${x},${C} L${w},${T} `).attr("class", "edge").attr("id", `${r}-${c(a, p, { prefix: "L" })}`), d) {
				let e = F(u) ? M[u](v, s) : v - l, n = I(u) ? M[u](b, s) : b - l;
				t.insert("polygon").attr("points", j[u](s)).attr("transform", `translate(${e},${n})`).attr("class", "arrow");
			}
			if (h) {
				let e = F(m) ? M[m](w, s) : w - l, n = I(m) ? M[m](T, s) : T - l;
				t.insert("polygon").attr("points", j[m](s)).attr("transform", `translate(${e},${n})`).attr("class", "arrow");
			}
			if (_) {
				let e = L(u, m) ? "XY" : F(u) ? "X" : "Y", n = 0;
				n = e === "X" ? Math.abs(v - w) : e === "Y" ? Math.abs(b - T) / 1.5 : Math.abs(v - w) / 2;
				let r = t.append("g");
				if (await y(r, _, {
					useHtmlLabels: !1,
					width: n,
					classes: "architecture-service-label"
				}, S()), r.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle"), e === "X") r.attr("transform", "translate(" + x + ", " + C + ")");
...
}, "drawEdges"), Z = /* @__PURE__ */ m(async function(e, t, n, r) {
	let a = n.getConfigField("padding") * .75, o = n.getConfigField("fontSize"), s = n.getConfigField("iconSize") / 2;
	await Promise.all(t.nodes().map(async (t) => {
		let c = W(t);
		if (c.type === "group") {
			let { h: l, w: u, x1: d, y1: f } = t.boundingBox(), p = e.append("rect");
			p.attr("id", `${r}-group-${c.id}`).attr("x", d + s).attr("y", f + s).attr("width", u).attr("height", l).attr("class", "node-bkg");
			let m = e.append("g"), h = d, g = f;
			if (c.icon) {
				let e = m.append("g");
				e.html(`<g>${await i(c.icon, {
					height: a,
					width: a,
					fallbackPrefix: X.prefix
				})}</g>`), e.attr("transform", "translate(" + (h + s + 1) + ", " + (g + s + 1) + ")"), h += a, g += o / 2 - 1 - 2;
			}
			if (c.label) {
				let e = m.append("g");
				await y(e, c.label, {
					...
					width: u,
					classes: "architecture-service-label"
				}, S()), e.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "start").attr("text-anchor", "start"), e.attr("transform", "translate(" + (h + s + 4) + ", " + (g + s + 2) + ")");
			}
			n.setElementForId(c.id, p);
		}
	}));
}, "drawGroups"), se = /* @__PURE__ */ m(async function(e, t, n, r) {
	let a = S();
	for (let o of n) {
		...
		if (o.title) {
			...
			await y(e, o.title, {
				...
				width: s * 1.5,
				classes: "architecture-service-label"
			}, a), e.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle"), e.attr("transform", "translate(" + s / 2 + ", " + s + ")");
		}
		let c = n.append("g");
		if (o.icon) c.html(`<g>${await i(o.icon, {
			height: s,
			width: s,
			fallbackPrefix: X.prefix
		})}</g>`);
		else if (o.iconText) {
			c.html(`<g>${await i("blank", {
				height: s,
				width: s,
				fallbackPrefix: X.prefix
			})}</g>`);
			let e = c.append("g").append("foreignObject").attr("width", s).attr("height", s).append("div").attr("class", "node-icon-text").attr("style", `height: ${s}px;`).append("div").html(l(o.iconText, a)), t = parseInt(window.getComputedStyle(e.node(), null).getPropertyValue("font-size").replace(/\D/g, "")) ?? 16;
		...
		let { width: u, height: d } = n.node().getBBox();
		o.width = u, o.height = d, e.setElementForId(o.id, n);
	}
	return 0;
}, "drawServices"), ce = /* @__PURE__ */ m(function(e, t, n, r) {
	n.forEach((n) => {
...
function me(e, t, n, r = []) {
	let i = /* @__PURE__ */ m((e, t) => {
		...
		return t.forEach(([t, i], a) => {
			...
			horiz: [...i(n, "horizontal").values()].filter((e) => e.length > 1),
			vert: [...i(r, "vertical").values()].filter((e) => e.length > 1)
		};
	}).reduce(([e, t], { horiz: n, vert: r }) => [[...e, ...n], [...t, ...r]], [[], []]), s = /* @__PURE__ */ new Set();
	r.forEach((e) => e.members.forEach((e) => s.add(e)));
	let c = /* @__PURE__ */ m((e) => e.filter((e) => !e.some((e) => s.has(e))), "dropOverlapping"), l = c(a), u = c(o);
	return r.forEach((e) => {
		e.members.length < 2 || (e.direction === "row" ? l.push([...e.members]) : u.push([...e.members]));
	}), {
		horizontal: l,
		vertical: u
	};
...
m(me, "getAlignments");
function he(e, t, n = []) {
	let r = [], i = t.getConfigField("iconSize"), a = t.getConfigField("idealEdgeLengthMultiplier"), o = a * i, s = /* @__PURE__ */ new Set();
	n.forEach((e) => {
		for (let t = 0; t < e.members.length - 1; t++) {
			let n = e.members[t], i = e.members[t + 1];
			s.add(`${n}|${i}`), s.add(`${i}|${n}`), e.direction === "row" ? r.push({
				left: n,
				right: i,
				gap: o
			}) : r.push({
	...
	let c = /* @__PURE__ */ m((e) => `${e[0]},${e[1]}`, "posToStr"), l = /* @__PURE__ */ m((e) => e.split(",").map((e) => parseInt(e)), "strToPos");
	return e.forEach((e) => {
		let t = new Map([...e.entries()].map(([e, t]) => [c(t), e])), n = [c([0, 0])], o = {}, u = {
			L: [-1, 0],
			R: [1, 0],
			T: [0, 1],
			B: [0, -1]
		...
		for (; n.length > 0;) {
			...
			if (e) {
				...
				if (d) {
					let f = l(e);
					Object.entries(u).forEach(([e, l]) => {
						let u = c([f[0] + l[0], f[1] + l[1]]), p = t.get(u);
						if (p && !o[u]) {
							if (n.push(u), s.has(`${d}|${p}`)) return;
							r.push({
								[A[e]]: p,
								[A[N(e)]]: d,
								gap: a * i
...
m(he, "getRelativeConstraints");
function ge(e, t, n, r, i, { spatialMaps: a, groupAlignments: o }) {
	return new Promise((s) => {
		let c = _("body").append("div").attr("id", "cy").attr("style", "display:none"), l = E({
		...
		c.remove(), fe(n, l), le(e, l, i), ue(t, l, i), pe(r, l);
		let u = i.getLayoutHints(), d = me(i, a, o, u), p = he(a, i, u), h = i.getConfigField("iconSize"), g = i.getConfigField("idealEdgeLengthMultiplier") * h, v = .5 * h, y = i.getConfigField("edgeElasticity"), b = i.getConfigField("seed"), x = l.layout({
			name: "fcose",
			quality: "proof",
		...
		x.one("layoutstop", () => {
			...
			m(e, "getSegmentWeights"), l.startBatch();
...
m(ge, "layoutArchitecture");
var _e = {
	parser: q,
	get db() {
		return new ie();
	},
	renderer: { draw: /* @__PURE__ */ m(async (e, t, n, r) => {
		let i = r.db;
		i.setDiagramId(t);
		let o = i.getServices(), s = i.getJunctions(), c = i.getGroups(), l = i.getEdges(), u = i.getDataStructures(), d = x(t), f = d.append("g");
		f.attr("class", "architecture-edges");
		let p = d.append("g");
		p.attr("class", "architecture-services");
		let m = d.append("g");
		m.attr("class", "architecture-groups"), await se(i, p, o, t), ce(i, p, s, t);
		let h = await ge(o, s, c, l, i, u);
		await oe(f, h, i, t), await Z(m, h, i, t), de(i, h), a(void 0, d, i.getConfigField("padding"), i.getConfigField("useMaxWidth"));
	}, "draw") },
	styles: ae
};
//#endregion
