...
import { Bn as t, G as n, M as r, N as i, Rn as a, Vn as o, ar as s, cn as l, cr as u, in as d, ln as f, tn as p, vn as m, xn as h, yn as g } from "./chunk-J7OUQ5F2-BUGcDHyW.mjs";
import { a as _, s as v } from "./chunk-2GRJ4B5K-DKbJpHGI.mjs";
...
var y = e(), b = (function() {
	var e = /* @__PURE__ */ u(function(e, t, n, r) {
		...
		parse: /* @__PURE__ */ u(function(e) {
			var t = this, n = [0], r = [], i = [null], a = [], o = this.table, s = "", l = 0, d = 0, f = 0, p = 2, m = 1, h = a.slice.call(arguments, 1), g = Object.create(this.lexer), _ = { yy: {} };
			...
			for (var C, w, T, E, D, O = {}, k, A, j, M;;) {
				if (T = n[n.length - 1], this.defaultActions[T] ? E = this.defaultActions[T] : (C ??= S(), E = o[T] && o[T][C]), E === void 0 || !E.length || !E[0]) {
					var N = "";
					for (k in M = [], o[T]) this.terminals_[k] && k > p && M.push("'" + this.terminals_[k] + "'");
					N = g.showPosition ? "Parse error on line " + (l + 1) + ":\n" + g.showPosition() + "\nExpecting " + M.join(", ") + ", got '" + (this.terminals_[C] || C) + "'" : "Parse error on line " + (l + 1) + ": Unexpected " + (C == m ? "end of input" : "'" + (this.terminals_[C] || C) + "'"), this.parseError(N, {
						text: g.match,
				...
				switch (E[0]) {
					case 1:
						n.push(C), i.push(g.yytext), a.push(g.yylloc), n.push(E[1]), C = null, w ? (C = w, w = null) : (d = g.yyleng, s = g.yytext, l = g.yylineno, y = g.yylloc, f > 0 && f--);
						break;
					case 2:
						...
						}, b && (O._$.range = [a[a.length - (A || 1)].range[0], a[a.length - 1].range[1]]), D = this.performAction.apply(O, [
							s,
							d,
							l,
							_.yy,
						...
						A && (n = n.slice(0, -1 * A * 2), i = i.slice(0, -1 * A), a = a.slice(0, -1 * A)), n.push(this.productions_[E[1]][0]), i.push(O.$), a.push(O._$), j = o[n[n.length - 2]][n[n.length - 1]], n.push(j);
						break;
					case 3: return !0;
				}
			}
	...
	return u(ue, "Parser"), ue.prototype = J, J.Parser = ue, new ue();
})();
b.parser = b;
var x = b, S = [], C = [""], w = "global", T = "", E = [{
	...
	link: null,
	parentBoundary: ""
}], D = [], O = "", k = !1, A = 4, j = 2, M, N = /* @__PURE__ */ u(function() {
	return M;
}, "getC4Type"), P = /* @__PURE__ */ u(function(e) {
	M = a(e, h());
}, "setC4Type"), F = /* @__PURE__ */ u(function(e, t, n, r, i, a, o, s, l) {
	...
	u.wrap = J();
}, "addRel"), I = /* @__PURE__ */ u(function(e, t, n, r, i, a, o) {
...
}, "addPersonOrSystem"), L = /* @__PURE__ */ u(function(e, t, n, r, i, a, o, s) {
	if (t === null || n === null) return;
...
}, "addContainer"), R = /* @__PURE__ */ u(function(e, t, n, r, i, a, o, s) {
	if (t === null || n === null) return;
	let l = {}, u = S.find((e) => e.alias === t);
	if (u && t === u.alias ? l = u : (l.alias = t, S.push(l)), n == null ? l.label = { text: "" } : l.label = { text: n }, r == null) l.techn = { text: "" };
	else if (typeof r == "object") {
	...
	l.wrap = J(), l.typeC4Shape = { text: e }, l.parentBoundary = w;
}, "addComponent"), ee = /* @__PURE__ */ u(function(e, t, n, r, i) {
...
}, "addPersonOrSystemBoundary"), te = /* @__PURE__ */ u(function(e, t, n, r, i) {
	if (e === null || t === null) return;
	let a = {}, o = E.find((t) => t.alias === e);
	...
	a.parentBoundary = w, a.wrap = J(), T = w, w = e, C.push(T);
}, "addContainerBoundary"), ne = /* @__PURE__ */ u(function(e, t, n, r, i, a, o, s) {
	if (t === null || n === null) return;
...
}, "addDeploymentNode"), z = /* @__PURE__ */ u(function() {
	w = T, C.pop(), T = C.pop(), C.push(T);
}, "popBoundaryParseStack"), B = /* @__PURE__ */ u(function(e, t, n, r, i, a, o, s, l, u, d) {
...
}, "updateElStyle"), V = /* @__PURE__ */ u(function(e, t, n, r, i, a, o) {
...
}, "updateRelStyle"), H = /* @__PURE__ */ u(function(e, t, n) {
	let r = A, i = j;
	if (typeof t == "object") {
	...
	r >= 1 && (A = r), i >= 1 && (j = i);
}, "updateLayoutConfig"), re = /* @__PURE__ */ u(function() {
	return A;
}, "getC4ShapeInRow"), ie = /* @__PURE__ */ u(function() {
	return j;
}, "getC4BoundaryInRow"), ae = /* @__PURE__ */ u(function() {
	return w;
}, "getCurrentBoundaryParse"), U = /* @__PURE__ */ u(function() {
	return T;
}, "getParentBoundaryParse"), W = /* @__PURE__ */ u(function(e) {
	return e == null ? S : S.filter((t) => t.parentBoundary === e);
}, "getC4ShapeArray"), G = /* @__PURE__ */ u(function(e) {
	return S.find((t) => t.alias === e);
}, "getC4Shape"), K = /* @__PURE__ */ u(function(e) {
	return Object.keys(W(e));
}, "getC4ShapeKeys"), q = /* @__PURE__ */ u(function(e) {
	return e == null ? E : E.filter((t) => t.parentBoundary === e);
}, "getBoundaries"), oe = q, se = /* @__PURE__ */ u(function() {
	return D;
}, "getRels"), ce = /* @__PURE__ */ u(function() {
	return O;
}, "getTitle"), le = /* @__PURE__ */ u(function(e) {
	k = e;
}, "setWrap"), J = /* @__PURE__ */ u(function() {
	return k;
}, "autoWrap"), ue = {
	addPersonOrSystem: I,
	...
	getAccDescription: m,
	setAccDescription: t,
	getConfig: /* @__PURE__ */ u(() => h().c4, "getConfig"),
	...
	setTitle: /* @__PURE__ */ u(function(e) {
		O = a(e, h());
	}, "setTitle"),
	setC4Type: P
}, de = /* @__PURE__ */ u(function(e, t) {
	return _(e, t);
}, "drawRect"), fe = /* @__PURE__ */ u(function(e, t, n, r, i, a) {
	...
	o.attr("xlink:href", s);
}, "drawImage"), pe = /* @__PURE__ */ u((e, t, n, r) => {
...
}, "drawRels"), me = /* @__PURE__ */ u(function(e, t, n) {
...
}, "drawBoundary"), he = /* @__PURE__ */ u(function(e, t, n) {
...
}, "drawC4Shape"), ge = /* @__PURE__ */ u(function(e, t) {
...
}, "insertDatabaseIcon"), _e = /* @__PURE__ */ u(function(e, t) {
...
}, "insertComputerIcon"), ve = /* @__PURE__ */ u(function(e, t) {
...
}, "insertClockIcon"), ye = /* @__PURE__ */ u(function(e, t) {
...
}, "insertArrowHead"), be = /* @__PURE__ */ u(function(e, t) {
...
}, "insertArrowEnd"), xe = /* @__PURE__ */ u(function(e, t) {
...
}, "insertArrowFilledHead"), Se = /* @__PURE__ */ u(function(e, t) {
...
}, "insertArrowCrossHead"), Ce = /* @__PURE__ */ u((e, t) => ({
	...
	u(e, "byText");
	function t(e, t, n, i, a, o, s, u) {
		let { fontSize: d, fontFamily: f, fontWeight: p } = u, m = e.split(l.lineBreakRegex);
		for (let e = 0; e < m.length; e++) {
			let o = e * d - d * (m.length - 1) / 2, l = t.append("text").attr("x", n + a / 2).attr("y", i).style("text-anchor", "middle").attr("dominant-baseline", "middle").style("font-size", d).style("font-weight", p).style("font-family", f);
	...
	return u(r, "_setTextAttrs"), function(r) {
...
var Z = {}, Oe = class {
	...
	d(Z, e), e.fontFamily && (Z.personFontFamily = Z.systemFontFamily = Z.messageFontFamily = e.fontFamily), e.fontSize && (Z.personFontSize = Z.systemFontSize = Z.messageFontSize = e.fontSize), e.fontWeight && (Z.personFontWeight = Z.systemFontWeight = Z.messageFontWeight = e.fontWeight);
}, "setConf"), Ae = /* @__PURE__ */ u((e, t) => ({
	fontFamily: e[t + "FontFamily"],
	fontSize: e[t + "FontSize"],
	fontWeight: e[t + "FontWeight"]
}), "c4ShapeFont"), je = /* @__PURE__ */ u((e) => ({
	fontFamily: e.boundaryFontFamily,
	fontSize: e.boundaryFontSize,
	fontWeight: e.boundaryFontWeight
}), "boundaryFont"), Me = /* @__PURE__ */ u((e) => ({
	fontFamily: e.messageFontFamily,
	fontSize: e.messageFontSize,
	fontWeight: e.messageFontWeight
}), "messageFont");
function Q(e, t, a, o, s) {
	if (!t[e].width) if (a) t[e].text = n(t[e].text, s, o), t[e].textLines = t[e].text.split(l.lineBreakRegex).length, t[e].width = s, t[e].height = r(t[e].text, o);
	else {
		let n = t[e].text.split(l.lineBreakRegex);
		t[e].textLines = n.length;
		let a = 0;
		t[e].height = 0, t[e].width = 0;
		for (let s of n) t[e].width = Math.max(i(s, o), t[e].width), a = r(s, o), t[e].height = t[e].height + a;
	}
}
u(Q, "calcC4ShapeTextWH");
var Ne = /* @__PURE__ */ u(function(e, t, n) {
	...
	let r = t.wrap && Z.wrap, a = je(Z);
	a.fontSize += 2, a.fontWeight = "bold", Q("label", t, r, a, i(t.label.text, a)), X.drawBoundary(e, t, Z);
}, "drawBoundary"), Pe = /* @__PURE__ */ u(function(e, t, n, r) {
	let a = 0;
	for (let o of r) {
		a = 0;
		let r = n[o], s = Ae(Z, r.typeC4Shape.text);
		switch (s.fontSize -= 2, r.typeC4Shape.width = i("«" + r.typeC4Shape.text + "»", s), r.typeC4Shape.height = s.fontSize + 2, r.typeC4Shape.Y = Z.c4ShapePadding, a = r.typeC4Shape.Y + r.typeC4Shape.height - 4, r.image = {
			width: 0,
			height: 0,
			Y: 0
		}, r.typeC4Shape.text) {
			case "person":
			case "external_person":
				r.image.width = 48, r.image.height = 48, r.image.Y = a, a = r.image.Y + r.image.height;
				break;
		}
		r.sprite && (r.image.width = 48, r.image.height = 48, r.image.Y = a, a = r.image.Y + r.image.height);
		let l = r.wrap && Z.wrap, u = Z.width - Z.c4ShapePadding * 2, d = Ae(Z, r.typeC4Shape.text);
		d.fontSize += 2, d.fontWeight = "bold", Q("label", r, l, d, u), r.label.Y = a + 8, a = r.label.Y + r.label.height, r.type && r.type.text !== "" ? (r.type.text = "[" + r.type.text + "]", Q("type", r, l, Ae(Z, r.typeC4Shape.text), u), r.type.Y = a + 5, a = r.type.Y + r.type.height) : r.techn && r.techn.text !== "" && (r.techn.text = "[" + r.techn.text + "]", Q("techn", r, l, Ae(Z, r.techn.text), u), r.techn.Y = a + 5, a = r.techn.Y + r.techn.height);
		let f = a, p = r.label.width;
		r.descr && r.descr.text !== "" && (Q("descr", r, l, Ae(Z, r.typeC4Shape.text), u), r.descr.Y = a + 20, a = r.descr.Y + r.descr.height, p = Math.max(r.label.width, r.descr.width), f = a - r.descr.textLines * 5), p += Z.c4ShapePadding, r.width = Math.max(r.width || Z.width, p, Z.width), r.height = Math.max(r.height || Z.height, f, Z.height), r.margin = r.margin || Z.c4ShapeMargin, e.insert(r), X.drawC4Shape(t, r, Z);
	}
...
}, "getIntersectPoint"), Ie = /* @__PURE__ */ u(function(e, t) {
	let n = {
		x: 0,
		y: 0
	};
...
}, "getIntersectPoints"), Le = /* @__PURE__ */ u(function(e, t, n, r, a) {
	let o = 0;
	for (let e of t) {
		o += 1;
		let t = e.wrap && Z.wrap, a = Me(Z);
		r.db.getC4Type() === "C4Dynamic" && (e.label.text = o + ": " + e.label.text);
		let s = i(e.label.text, a);
		Q("label", e, t, a, s), e.techn && e.techn.text !== "" && (s = i(e.techn.text, a), Q("techn", e, t, a, s)), e.descr && e.descr.text !== "" && (s = i(e.descr.text, a), Q("descr", e, t, a, s));
...
u(Re, "drawInsideBoundary");
var ze = {
	drawPersonOrSystemArray: Pe,
	drawBoundary: Ne,
	setConf: ke,
	draw: /* @__PURE__ */ u(function(e, t, n, r) {
		Z = h().c4;
		let i = h().securityLevel, a;
		i === "sandbox" && (a = p("#i" + t));
		let o = p(i === "sandbox" ? a.nodes()[0].contentDocument.body : "body"), l = r.db;
		r.db.setWrap(Z.wrap), Ee = l.getC4ShapeInRow(), De = l.getC4BoundaryInRow(), s.debug(`C:${JSON.stringify(Z, null, 2)}`);
		let u = i === "sandbox" ? o.select(`[id="${t}"]`) : p(`[id="${t}"]`);
		X.insertComputerIcon(u, t), X.insertDatabaseIcon(u, t), X.insertClockIcon(u, t);
		let d = new Oe(r);
		d.setData(Z.diagramMarginX, Z.diagramMarginX, Z.diagramMarginY, Z.diagramMarginY), d.data.widthLimit = screen.availWidth, we = Z.diagramMarginX, Te = Z.diagramMarginY;
		let m = r.db.getTitle();
		Re(u, "", d, r.db.getBoundaries(""), r), X.insertArrowHead(u, t), X.insertArrowEnd(u, t), X.insertArrowCrossHead(u, t), X.insertArrowFilledHead(u, t), Le(u, r.db.getRels(), r.db.getC4Shape, r, t), d.data.stopx = we, d.data.stopy = Te;
		let g = d.data, _ = g.stopy - g.starty + 2 * Z.diagramMarginY, v = g.stopx - g.startx + 2 * Z.diagramMarginX;
		m && u.append("text").text(m).attr("x", (g.stopx - g.startx) / 2 - 4 * Z.diagramMarginX).attr("y", g.starty + Z.diagramMarginY), f(u, _, v, Z.useMaxWidth);
		let y = m ? 60 : 0;
		u.attr("viewBox", g.startx - Z.diagramMarginX + " -" + (Z.diagramMarginY + y) + " " + v + " " + (_ + y)), s.debug("models:", g);
	}, "draw")
}, Be = {
	parser: x,
	db: ue,
	renderer: ze,
	styles: /* @__PURE__ */ u((e) => `.person {
