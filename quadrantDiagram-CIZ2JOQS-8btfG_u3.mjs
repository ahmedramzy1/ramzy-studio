import { Bn as e, Dn as t, Rn as n, Vn as r, Wn as i, ar as a, cr as o, ln as s, on as c, pn as l, tn as u, vn as d, wn as f, xn as p, yn as m } from "./chunk-J7OUQ5F2-BUGcDHyW.mjs";
import { t as h } from "./linear-D4tQfDWZ.mjs";
...
var g = (function() {
	var e = /* @__PURE__ */ o(function(e, t, n, r) {
		...
		return n;
	}, "o"), t = [1, 3], n = [1, 4], r = [1, 5], i = [1, 6], a = [1, 7], s = [
		1,
		4,
		5,
		10,
	...
	return o($, "Parser"), $.prototype = me, me.Parser = $, new $();
})();
g.parser = g;
var _ = g, v = t(), y = class {
	constructor() {
	...
	clear() {
		this.config = this.getDefaultConfig(), this.themeConfig = this.getDefaultThemeConfig(), this.data = this.getDefaultData(), this.classes = /* @__PURE__ */ new Map(), a.info("clear called");
	}
	setData(e) {
		this.data = {
			...this.data,
	...
	setConfig(e) {
		a.trace("setConfig called with: ", e), this.config = {
			...this.config,
			...e
		};
	}
	setThemeConfig(e) {
		a.trace("setThemeConfig called with: ", e), this.themeConfig = {
			...this.themeConfig,
			...e
		};
	}
...
var B = {
	...
	renderer: { draw: /* @__PURE__ */ o((e, t, n, r) => {
		function i(e) {
			return e === "top" ? "hanging" : "middle";
		}
		o(i, "getDominantBaseLine");
		function c(e) {
		...
		o(l, "getTransformation");
		let d = p();
		a.debug("Rendering quadrant chart\n" + e);
		let f = d.securityLevel, m;
		f === "sandbox" && (m = u("#i" + t));
		let h = u(f === "sandbox" ? m.nodes()[0].contentDocument.body : "body").select(`[id="${t}"]`), g = h.append("g").attr("class", "main"), _ = d.quadrantChart?.chartWidth ?? 500, v = d.quadrantChart?.chartHeight ?? 500;
		s(h, v, _, d.quadrantChart?.useMaxWidth ?? !0), h.attr("viewBox", "0 0 " + _ + " " + v), r.db.setHeight(v), r.db.setWidth(_);
		...
		y.title && w.append("text").attr("x", 0).attr("y", 0).attr("fill", y.title.fill).attr("font-size", y.title.fontSize).attr("dominant-baseline", i(y.title.horizontalPos)).attr("text-anchor", c(y.title.verticalPos)).attr("transform", l(y.title)).text(y.title.text), y.borderLines && x.selectAll("line").data(y.borderLines).enter().append("line").attr("x1", (e) => e.x1).attr("y1", (e) => e.y1).attr("x2", (e) => e.x2).attr("y2", (e) => e.y2).style("stroke", (e) => e.strokeFill).style("stroke-width", (e) => e.strokeWidth);
		let T = b.selectAll("g.quadrant").data(y.quadrants).enter().append("g").attr("class", "quadrant");
		T.append("rect").attr("x", (e) => e.x).attr("y", (e) => e.y).attr("width", (e) => e.width).attr("height", (e) => e.height).attr("fill", (e) => e.fill), T.append("text").attr("x", 0).attr("y", 0).attr("fill", (e) => e.text.fill).attr("font-size", (e) => e.text.fontSize).attr("dominant-baseline", (e) => i(e.text.horizontalPos)).attr("text-anchor", (e) => c(e.text.verticalPos)).attr("transform", (e) => l(e.text)).text((e) => e.text.text), C.selectAll("g.label").data(y.axisLabels).enter().append("g").attr("class", "label").append("text").attr("x", 0).attr("y", 0).text((e) => e.text).attr("fill", (e) => e.fill).attr("font-size", (e) => e.fontSize).attr("dominant-baseline", (e) => i(e.horizontalPos)).attr("text-anchor", (e) => c(e.verticalPos)).attr("transform", (e) => l(e));
		let E = S.selectAll("g.data-point").data(y.points).enter().append("g").attr("class", "data-point");
		E.append("circle").attr("cx", (e) => e.x).attr("cy", (e) => e.y).attr("r", (e) => e.radius).attr("fill", (e) => e.fill).attr("stroke", (e) => e.strokeColor).attr("stroke-width", (e) => e.strokeWidth), E.append("text").attr("x", 0).attr("y", 0).text((e) => e.text.text).attr("fill", (e) => e.text.fill).attr("font-size", (e) => e.text.fontSize).attr("dominant-baseline", (e) => i(e.text.horizontalPos)).attr("text-anchor", (e) => c(e.text.verticalPos)).attr("transform", (e) => l(e.text));
	}, "draw") },
