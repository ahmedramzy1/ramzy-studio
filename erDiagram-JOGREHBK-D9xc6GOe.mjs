import { Bn as e, R as t, Vn as n, W as r, Wn as i, ar as a, cr as o, nr as s, on as c, r as l, sr as u, t as d, tn as f, vn as p, wn as m, xn as h, yn as g } from "./chunk-J7OUQ5F2-BUGcDHyW.mjs";
import { t as _ } from "./channel-CLnV92vg.mjs";
import { t as v } from "./chunk-XXDRQBXY-DYEdPnIN.mjs";
import { t as y } from "./chunk-KBJHAD2P-iCC8cYwM.mjs";
...
var b = (function() {
	var e = /* @__PURE__ */ o(function(e, t, n, r) {
		...
		51,
		52
	], n = [1, 10], r = [1, 11], i = [1, 12], a = [1, 13], s = [1, 23], c = [1, 24], l = [1, 25], u = [1, 26], d = [1, 27], f = [1, 19], p = [1, 28], m = [1, 29], h = [1, 20], g = [1, 18], _ = [1, 21], v = [1, 22], y = [1, 36], b = [1, 37], x = [1, 38], S = [1, 39], C = [1, 40], w = [
		6,
		8,
		10,
		13,
	...
	return o(X, "Parser"), X.prototype = Y, Y.Parser = X, new X();
})();
b.parser = b;
var x = b, S = class {
	constructor() {
		...
		}, this.setAccTitle = n, this.getAccTitle = g, this.setAccDescription = e, this.getAccDescription = p, this.setDiagramTitle = i, this.getDiagramTitle = m, this.getConfig = /* @__PURE__ */ o(() => h().er, "getConfig"), this.clear(), this.addEntity = this.addEntity.bind(this), this.addAttributes = this.addAttributes.bind(this), this.addRelationship = this.addRelationship.bind(this), this.setDirection = this.setDirection.bind(this), this.addCssStyles = this.addCssStyles.bind(this), this.addClass = this.addClass.bind(this), this.setClass = this.setClass.bind(this), this.setAccTitle = this.setAccTitle.bind(this), this.setAccDescription = this.setAccDescription.bind(this);
	}
	static {
		o(this, "ErDB");
	}
	addEntity(e, t = "") {
		return this.entities.has(e) ? !this.entities.get(e)?.alias && t && (this.entities.get(e).alias = t, a.info(`Add alias '${t}' to entity '${e}'`)) : (this.entities.set(e, {
			...
			cssStyles: [],
			labelType: "markdown"
		}), a.info("Added new entity :", e)), this.entities.get(e);
	}
	getEntity(e) {
	...
	addAttributes(e, t) {
		let n = this.addEntity(e), r;
		for (r = t.length - 1; r >= 0; r--) t[r].keys || (t[r].keys = []), t[r].comment || (t[r].comment = ""), n.attributes.push(t[r]), a.debug("Added attribute ", t[r].name);
	}
	addRelationship(e, t, n, r) {
		let i = this.entities.get(e), o = this.entities.get(n);
		if (!i || !o) return;
		let s = {
			entityA: i.id,
			roleA: t,
		...
		this.relationships.push(s), a.debug("Added new relationship :", s);
	}
	getRelationships() {
	...
	getData() {
		...
		for (let t of this.entities.keys()) {
			...
			n && (n.cssCompiledStyles = this.getCompiledStyles(n.cssClasses.split(" ")), n.colorIndex = i++, e.push(n));
		}
		let a = 0;
		for (let e of this.relationships) {
			let i = {
				id: t(e.entityA, e.entityB, {
					prefix: "id",
					counter: a++
				}),
				type: "normal",
...
u(C, { draw: () => w });
var w = /* @__PURE__ */ o(async function(e, t, n, i) {
	a.info("REF0:"), a.info("Drawing er diagram (unified)", t);
	let { securityLevel: o, er: s, layout: c } = h(), u = i.db.getData(), p = v(t, o);
	u.type = i.type, u.layoutAlgorithm = d(c), u.config.flowchart.nodeSpacing = s?.nodeSpacing || 140, u.config.flowchart.rankSpacing = s?.rankSpacing || 80, u.direction = i.db.getDirection();
	let { config: m } = u, { look: g } = m;
	g === "neo" ? u.markers = [
		"only_one_neo",
		"zero_or_one_neo",
		"one_or_more_neo",
		...
		"one_or_more",
		"zero_or_more"
	], u.diagramId = t, await l(u, p), u.layoutAlgorithm === "elk" && p.select(".edges").lower();
	let _ = p.selectAll("[id*=\"-background\"]");
	Array.from(_).length > 0 && _.each(function() {
		let e = f(this), t = e.attr("id").replace("-background", ""), n = p.select(`#${CSS.escape(t)}`);
		if (!n.empty()) {
			let t = n.attr("transform");
			e.attr("transform", t);
		}
	}), r.insertTitle(p, "erDiagramTitleText", s?.titleTopMargin ?? 25, i.db.getDiagramTitle()), y(p, 8, "erDiagram", s?.useMaxWidth ?? !0);
}, "draw"), T = /* @__PURE__ */ o((e, t) => {
	let n = _;
	return s(n(e, "r"), n(e, "g"), n(e, "b"), t);
}, "fade"), E = /* @__PURE__ */ new Set(["redux-color", "redux-dark-color"]), D = /* @__PURE__ */ o((e) => {
