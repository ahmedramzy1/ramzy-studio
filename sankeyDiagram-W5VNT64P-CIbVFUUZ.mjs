import { Bn as e, Kn as t, Vn as n, Wn as r, cn as i, cr as a, fn as o, on as s, tn as c, vn as l, wn as u, xn as d, yn as f } from "./chunk-J7OUQ5F2-BUGcDHyW.mjs";
import { t as p } from "./ordinal-BTZmV7vg.mjs";
			...
			for (var S, C, w, T, E, D = {}, O, k, A, j;;) {
				...
				switch (T[0]) {
					...
					case 2:
						...
						k && (n = n.slice(0, -1 * k * 2), i = i.slice(0, -1 * k), o = o.slice(0, -1 * k)), n.push(this.productions_[T[1]][0]), i.push(D.$), o.push(D._$), A = s[n[n.length - 2]][n[n.length - 1]], n.push(A);
						break;
					case 3: return !0;
				}
			}
...
q.parser = q;
var J = q, Y = [], X = [], Z = /* @__PURE__ */ new Map(), oe = /* @__PURE__ */ a(() => {
	Y = [], X = [], Z = /* @__PURE__ */ new Map(), s();
}, "clear"), se = class {
	constructor(e, t, n = 0) {
	...
	nodesMap: Z,
	getConfig: /* @__PURE__ */ a(() => d().sankey, "getConfig"),
	getNodes: /* @__PURE__ */ a(() => X, "getNodes"),
	getLinks: /* @__PURE__ */ a(() => Y, "getLinks"),
	getGraph: /* @__PURE__ */ a(() => ({
	...
	addLink: ce,
	findOrCreateNode: /* @__PURE__ */ a((e) => {
		e = i.sanitizeText(e, d());
		let t = Z.get(e);
	...
	return n;
}, "findCentralNodeLayer"), fe = { draw: /* @__PURE__ */ a(function(e, n, r, i) {
	let { securityLevel: s, sankey: l } = d(), u = o.sankey, f;
	s === "sandbox" && (f = c("#i" + n));
	let m = c(s === "sandbox" ? f.nodes()[0].contentDocument.body : "body"), g = s === "sandbox" ? m.select(`[id="${n}"]`) : c(`[id="${n}"]`), _ = l?.width ?? u.width, v = l?.height ?? u.width, y = l?.useMaxWidth ?? u.useMaxWidth, b = l?.nodeAlignment ?? u.nodeAlignment, x = l?.prefix ?? u.prefix, S = l?.suffix ?? u.suffix, C = l?.showValues ?? u.showValues, w = l?.nodeWidth ?? u.nodeWidth ?? 10, T = l?.nodePadding ?? u.nodePadding ?? 12, E = l?.labelStyle ?? u.labelStyle ?? "legacy", D = l?.nodeColors ?? {}, O = i.db.getGraph(), k = $[b];
	P().nodeId((e) => e.id).nodeWidth(w).nodePadding(T + (C ? 15 : 0)).nodeAlign(k).extent([[0, 0], [_, v]])(O);
	let A = de(O.nodes), j = p(h), M = /* @__PURE__ */ a((e) => D[e] ?? j(e), "getNodeColor");
	...
	let N = /* @__PURE__ */ a(({ id: e, value: t }) => C ? `${e}
${x}${Math.round(t * 100) / 100}${S}` : e, "getText"), F = /* @__PURE__ */ a((e) => E === "outlined" ? (e.layer ?? 0) < A ? {
		x: e.x0 - 6,
		anchor: "end"
	} : {
		x: e.x1 + 6,
		...
		x: e.x0 - 6,
		anchor: "end"
	}, "getLabelPosition"), I = g.append("g").attr("class", "node-labels").attr("font-size", 14), L = /* @__PURE__ */ a((e) => I.selectAll(e ? `.${e}` : "text").data(O.nodes).join("text").attr("class", e ?? null).attr("x", (e) => F(e).x).attr("y", (e) => (e.y1 + e.y0) / 2).attr("dy", `${C ? "0" : "0.35"}em`).attr("text-anchor", (e) => F(e).anchor).text(N), "appendLabel");
	...
	switch (z) {
		case "gradient":
			B = /* @__PURE__ */ a((e) => e.uid, "coloring");
			break;
		case "source":
			B = /* @__PURE__ */ a((e) => M(e.source.id), "coloring");
			break;
		case "target":
			B = /* @__PURE__ */ a((e) => M(e.target.id), "coloring");
			break;
		default: B = z;
	}
	R.append("path").attr("d", K()).attr("stroke", B).attr("stroke-width", (e) => Math.max(1, e.width)), t(void 0, g, 0, y);
}, "draw") }, pe = /* @__PURE__ */ a((e) => e.replaceAll(/^[^\S\n\r]+|[^\S\n\r]+$/g, "").replaceAll(/([\n\r])+/g, "\n").trim(), "prepareTextForParsing"), me = /* @__PURE__ */ a((e) => `.label {
